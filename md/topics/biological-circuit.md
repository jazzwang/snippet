...
1. **Synthetic Oscillators:  合成振盪器**：
    ...
    > **細菌可調諧合成振盪器**：可調整此電路以根據環境條件改變振盪頻率，從而顯示對刺激反應的靈活性 [3]。
...
[2] [Synthetic biology: Understanding biological design from synthetic circuits](https://pmc.ncbi.nlm.nih.gov/articles/PMC3138802/).
