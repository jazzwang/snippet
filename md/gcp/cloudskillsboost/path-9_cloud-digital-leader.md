...
> 商業數據並非新名詞，因為組織長期以來都運用有關績效和營運的資訊來做決策。然而，傳統方法的數據分析可能需要數天或數月，而且往往不完整。此外，通常需要專業團隊才能製作複雜的報告。有了雲端技術，情況就大不相同了。數據現在可以以前所未有的速度和規模進行使用、分析和應用。事實上，組織現在可以利用雲端技術即時提取數據，來訓練機器學習模型，並採取有利於其業務的方式行動。您不再需要成為數據科學家或技術專家就能執行數據分析。有鑑於此，「探索 Google Cloud 的數據轉換」這門課程旨在幫助您理解數據的價值及其如何影響客戶體驗，學習可用的不同 Google Cloud 數據管理解決方案，並探索 Google Cloud 產品如何使數據對員工更有用、更容易取得。在整個課程中，您將會遇到分級的知識評估。您必須通過這些評估才能獲得課程學分。好的，讓我們開始吧！
...
* 降低數據分析門檻，無需專業技術背景。
* 課程目標：理解數據價值、Google Cloud 數據管理方案及數據應用。
* 課程包含分級評估，需通過以獲得學分。
...
> 人工智慧具有解決諸多艱鉅問題的巨大潛力，包括推進醫學發展、理解語言和促進科學發現。要實現這一潛力，負責任地使用人工智慧至關重要。為此，Google 制定了指導 Google 人工智慧應用的原則、與 Google 外部社群分享我們工作的最佳實務，以及使我們的努力合理化的計畫。這些原則指出，人工智慧應具有社會效益、避免造成或強化不公平的偏見、以安全為重並進行測試、對人們負責、納入隱私設計原則、堅持高水平的科學卓越，並僅用於符合這些原則的用途。此外，Google 不會在以下應用領域設計或部署人工智慧：可能造成整體傷害的技術；武器或其他其主要目的或實施方式為造成或直接促成人員傷害的技術；收集或使用資訊進行監控、違反國際公認規範的技術；以及其目的違反廣泛接受的國際法和人權原則的技術。儘管這些是 Google 自身的 AI 指導原則，但我們也敦促其他組織制定自身的一套原則，以鼓勵負責任的 AI 開發。讓組織除錯和改進機器學習模型的效能，並幫助他人理解其模型的行為也很重要。建立機器學習模型的組織也需要協助偵測和解決其數據和模型中的偏差、漂移和其他差距。此外，提供人類可理解的機器學習模型說明將有助於提升最終用戶的信任度和透明度。可解釋人工智慧是 Google Cloud 的一套工具和框架，可幫助您理解和解釋機器學習模型做出的預測。這些工具與多種 Google 產品和服務原生整合，以確保人工智慧開發的透明度。
