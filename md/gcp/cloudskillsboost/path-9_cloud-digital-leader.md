...
> 有些人認為，僅僅掌握雲端運用的技術能力就能夠轉型企業，我認為這是一個很大的錯誤。大家好，我叫溫特·瑟夫，我是 Google 的副總裁兼首席互聯網傳道者。我的主要工作是確保更多人可以使用互聯網。但我最感興趣的是確保雲端也能發揮作用。如果您擔心是否準備好迎接雲端，您需要了解它的功能和所能提供的服務。您不一定需要非常詳細地了解它的運作方式，但您必須了解它的功能以及它在新型產品和服務方面，或轉變所有企業的運作方式方面所能提供的靈活性。沒有這種洞察力，沒有這種理解，就很难在雲端世界中佔據有利地位。如果您稍微考慮一下雲端的規模，您就會明白，大多數公司，當然也包括大多數個人，都不可能投資和維護當今雲端的計算能力和數據存儲能力。這種轉變意味着公司可以獲得他們原本無法獲得的設施。至少不關注新技術可能是致命的風險。這就是為什麼我們認為每個人都應該至少了解新技術是什麼，以及它們是否適合公司結構。讓我們談談領導力。我認為大多數領導者不需要詳細了解互聯網的運作方式，但他們必須對通過互聯網訪問基於雲端的技術的意義有基本的了解。將互聯網和雲端視為一種可以無限用途的基礎設施。因此，領導者至少要對這些技術能為他們的公司、產品和服務帶來什麼樣的幫助有一個概念性的理解非常重要。這不僅僅是關於技術，而是關於如何使用技術，這需要真正的遠見。


##### 摘要

* 企業轉型不僅僅依賴於雲端技術能力，更需要對其應用和潛力有深入的理解。
* 了解雲端的功能和靈活性，而非其底層技術細節，對企業至關重要。
...
> 雲端科技與數位轉型備受關注，但您可能仍有許多未解之謎，例如：什麼是雲端科技？數位轉型是什麼意思？雲端科技如何幫助您或您的組織？從哪裡開始？如果您曾問過自己這些問題，那麼您來對地方了。在 Google Cloud，我們希望在您開始雲端之旅和數位轉型的過程中，為您提供必要的資訊和工具。本課程「透過 Google Cloud 進行數位轉型」旨在幫助您：了解雲端如何徹底改變企業的原因和方式；解釋一般的雲端概念；以及確定使用 IaaS（基礎架構即服務）、PaaS（平台即服務）和 SaaS（軟體即服務）的優點和權衡。您將首先定義一些在本課程中會聽到的重要術語，並說明採用雲端科技以進行數位轉型企業的優點。接下來，您將探討一些基本的雲端概念。您將學習遷移到雲端如何影響組織的彈性、敏捷性、可靠性和總體擁有成本。您還將探討不同類型的基礎架構，並探討其各種用例。然後，您將學習雲端運算模型，以及組織及其雲端供應商在硬體、軟體和安全性方面的共同責任。在整個課程中，您將參加分級的知識評估。您必須通過這些評估才能獲得課程學分。好的，讓我們開始吧！
...
> 了解雲端如何改變企業，學習雲端和雲端技術的基礎知識至關重要。在本課程單元中，您將探討：與雲端和數位轉型相關的重要術語、關於組織數位轉型的雲端技術優勢、內部部署基礎架構、公有雲、私有雲、混合雲和多雲之間的差異，以及促使組織進行數位轉型的驅動因素和挑戰。讓我們開始吧！
...
> 創新並非線性發展，而是波浪式前進，而每一次浪潮都由突破性技術驅動。從印刷術時代、蒸汽機時代、電力時代、交通運輸時代、電腦時代，到如今的數據與雲端基礎設施時代，每一次發明都引發了數千項創新，改變了生活和工作的可能性。例如印刷術的發明，它革命性地讓每個人都能接觸到書籍、百科全書，甚至撲克牌，也促成了更廣泛的知識產權認可（透過廣泛分佈的專利），為第一次工業革命鋪路。蒸汽機帶來了汽車和火車，徹底改變了運輸業，讓企業得以大規模生產和運輸商品。電力則帶來了電燈泡、家用電器，最終促成了電腦的誕生。印刷術、蒸汽機和電力之所以共通，在於它們都代表了典範轉移：人類工作和與世界互動方式的根本且不可逆轉的改變。雲端技術也正處於另一場典範轉移之中：數位轉型。雲端技術正在改變組織創造價值的方式、人們的工作方式，以及人們的生活方式。它是數千項創新的催化劑，改變了我們探索世界、與媒體互動、診斷疾病或應對環境問題的方式。數位轉型已成為近年來備受關注的詞彙，但其關鍵組成部分是什麼？它們與雲端技術的關係為何？為何這麼多組織追求數位轉型？在 Google Cloud，我們將數位轉型定義為：組織利用新的數位技術（例如公有雲、私有雲和混合雲平台）來創造或修改業務流程、文化和客戶體驗，以滿足不斷變化的業務和市場動態。組織選擇數位轉型框架來促進創新、產生新的收入來源，並快速適應市場變化和客戶需求。數位轉型幫助組織改變運作方式，並透過現代化應用程式、創造新服務和交付價值來重新定義與客戶、員工和合作夥伴的關係。因此，數位技術的快速發展正在重新定義各個行業。許多汽車現在都是軟體驅動的，並且像筆記型電腦或手機一樣定期更新。在化學領域，大數據和人工智慧 (AI) 促進了藥物發現。金融服務機構利用雲端強大的運算能力，提供前所未有的洞察力。隨著智慧分析日益嵌入到所有事物中，以及裝置產生指數級增長的數據，傳統的本地運算解決方案已無法滿足需求。隨著業務創新越來越由軟體驅動，IDC FutureScape 報告預測，到 2024 年，超過 50% 的所有 IT 支出將用於數位轉型和創新。事實上，IDC 還預測，到 2025 年，超過 90% 的新型企業應用程式將嵌入 AI。領先的組織將更依賴 AI 來推出新的業務模式、創造更個性化的體驗以及優化營運以降低成本。了解雲端的規模和功能比以往任何時候都更為重要。
...
> 雲端及其技術究竟是什麼？它如何支援數位轉型？雲端是資料中心網路的隱喻，這些資料中心透過網際網路儲存和計算資訊。基本上，它將複雜的軟體、伺服器、電腦、網路和安全系統整合為單一詞彙：「雲端」。為了更好地理解雲端，探索組織實施資訊科技 (IT) 基礎架構的不同方法可能有所幫助。這包括內部部署、私有雲、公有雲、混合雲和多雲部署。內部部署 IT 基礎架構 (通常縮寫為「內部部署」) 指的是託管在組織資料中心內部的硬體和軟體應用程式，以滿足其獨特需求。此部署是管理 IT 基礎架構的傳統方式。內部部署的好處是不需要第三方存取，讓擁有者可以對伺服器硬體和軟體進行實體控制，而且不需要支付持續存取費用。然而，為了擁有運行所需工作負載的計算能力，組織必須透過可能需要數個月的採購流程購買實體伺服器和其他基礎架構。這些系統需要實體空間，通常是配備足夠電力和冷卻系統的專用房間。設定和部署系統後，企業需要專業人員來管理它們。當需求激增或業務擴展時，此漫長的流程很難擴展。組織通常會取得比實際需要的更多計算資源，導致利用率低和管理費用高。雲端運算透過提供可擴展的按需服務來解決這些問題。私有雲是一種雲端運算類型，其基礎架構專供單一組織使用，而不是公眾使用。此類型也稱為單租戶或企業雲。通常，組織必須對私有雲執行與傳統內部部署基礎架構相同的持續維護和管理。私有雲託管在組織自己的私有伺服器中，無論是在組織自己的資料中心、第三方託管設施，還是使用私有雲供應商。私有雲運算為企業提供了許多公有雲的好處，包括自助服務、可擴展性和彈性，以及來自專用內部部署基礎架構的更多自訂選項。如果組織已對其自身基礎架構進行大量投資，或者由於法規原因必須將資料保留在內部部署或以特定方式託管，則可能使用私有雲。公有雲是指由第三方供應商（例如 Google Cloud）管理的按需運算服務和基礎架構，並透過公用網際網路與多個組織或「租戶」共享。由於這種共享，公有雲稱為多租戶雲基礎架構，但每個租戶在雲端執行的資料和應用程式都對其他租戶隱藏。您可以將其想像成由物業管理公司維護的公寓大樓。大樓內有許多單元和租戶。每個單元可能佈局略有不同，但仍然具備租戶居住所需的所有設施。每個單元都已鎖定，僅供支付該空間費用的租戶使用。在本課程中，除非另有說明，否則我們指的是公有雲。因為公有雲提供運算和基礎架構資源的按需可用性，組織無需自行取得、設定或管理這些資源，並且只需支付使用的費用。公有雲中通常提供三種類型的雲端運算服務模式：第一種是基礎架構即服務 (IaaS)，提供運算和儲存服務；第二種是平台即服務 (PaaS)，提供開發和部署環境以建置雲端應用程式；第三種是軟體即服務 (SaaS)，以服務的形式提供應用程式，使用者可以按訂閱方式取得軟體。我們稍後將詳細探討這三種模式。組織實施 IT 基礎架構的最後兩種方法是混合雲或多雲。雖然它們並不相同，但這兩個術語經常互換使用，因此讓我們花點時間來定義它們。在混合雲中，應用程式在不同環境的組合中運行。最常見的混合雲範例是結合公有雲和私有雲環境，例如內部部署資料中心和公有雲運算環境（例如 Google Cloud）。多雲描述結合至少兩個公有雲供應商的架構。組織可能同時操作內部部署和多個公有雲環境，因此同時實施混合雲和多雲。因此，雖然混合雲和多雲相關，但它們並非可互換的術語。如今，大多數組織都採用多雲策略。根據《Flexera 2022 年雲端現狀報告》，89% 的受訪者表示擁有多雲策略，其中 80% 的受訪者透過結合公有雲和私有雲來採用混合方法。


##### 摘要

*   雲端是透過網路存取的資料中心網路，簡化複雜的IT系統。
*   雲端部署模式包含：內部部署、私有雲、公有雲、混合雲和多雲。
*   內部部署：傳統方式，組織自行管理硬體和軟體，控制力強但擴展性差。
*   私有雲：單一組織專用，兼具公有雲的優點和客製化能力。
*   公有雲：由第三方提供商管理，資源按需使用，具備IaaS、PaaS和SaaS三種服務模式。
*   混合雲：結合公有雲和私有雲（例如內部部署）的環境。
*   多雲：結合至少兩個公有雲供應商的架構。
...
> 雲端運算相較於傳統本地基礎架構的優勢有哪些呢？它具有可擴展性。雲端運算讓組織可以按需取得可擴展的資源和最新的技術，無需擔心資本支出或有限的固定基礎架構。這可以大幅加快基礎架構部署時間。它很靈活。組織及其使用者可以從任何地方存取雲端服務，並根據需要擴展或縮減服務以滿足業務需求。它很敏捷。組織可以開發新的應用程式並快速投入生產，無需擔心底層基礎架構。它具有戰略價值。因為雲端供應商始終更新最新的創新技術並將其作為服務提供給客戶，所以組織可以獲得更多競爭優勢和更高的投資回報，勝過投資即將淘汰的技術。這讓組織可以更快地創新和嘗試新想法。它很安全。由於雲端供應商所實施的安全機制深度和廣度以及專職團隊，雲端運算的安全性能被認為優於企業數據中心。最後，它具有成本效益。無論組織實施哪種雲端運算服務模式，他們只需支付使用的運算資源費用。他們無需超量建置數據中心容量以應付需求或業務增長的突然飆升，並且可以部署 IT 人員來處理更具策略性的計劃。


##### 摘要

* **可擴展性:** 按需取得可擴展資源及最新技術，加快基礎架構部署，無需擔心資本支出及固定基礎架構限制。
* **靈活性:**  隨時隨地存取雲端服務，按需擴展或縮減服務以滿足業務需求。
* **敏捷性:**  快速開發和部署新應用程式，無需顧慮底層基礎架構。
...
> 企業若墨守成規，不願擁抱科技轉型，將冒極大風險。任天堂的成功案例，與傳統百科全書公司的失敗，正好說明了這點。任天堂自1889年起持續創新，從傳統花札牌到遊戲主機、手機遊戲，再到《Pokémon Go》及雲端遊戲主機Nintendo Switch，始終以「為何存在」為核心，而非執著於「如何運作」。他們善用新科技達成目標，而非將特定技術視為唯一手段。反觀百科全書公司，過於專注於印刷、銷售實體書籍的「如何運作」，忽略了傳播知識的初衷，錯失了CD-ROM及線上百科全書的機會。


##### 摘要

*   任天堂：持續創新，從傳統花札牌到遊戲主機、手機遊戲，善用新科技達成目標，而非將特定技術視為唯一手段，始終維持市場佔有率。
*   百科全書公司：專注於印刷、銷售實體書籍的「如何運作」，忽略了傳播知識的初衷，錯失了CD-ROM及線上百科全書的機會，最終被時代淘汰。
...
> 為了了解當今的雲端運算環境以及真正的數位轉型是什麼樣子，我們首先應該了解我們是如何走到今天的。這始於虛擬機器 (VM) 雲端時代。VM 代表虛擬機器。許多新組織，大多是新創公司，意識到他們可以放棄購買或操作硬體，而直接從雲端開始。這成為了許多我們今天都依賴的優秀雲原生公司（例如 Twitter、Spotify 和 PayPal）的主要催化劑。在第一個 VM 雲端時代結束時，很少有新創公司自行運營數據中心。接下來是基礎設施雲端時代，當時組織將其 IT 基礎設施遷移到雲端。這種遷移節省了成本，因為基礎設施可以更快、更輕鬆地擴展和縮減。由於公司不需要長期基礎設施規劃，因此可以更快地開發；安全性也更好。此外，減少 IT 工作人員的管理負擔，讓組織可以將更多人員和資源用於構建新功能。在過去十年基礎設施雲端時代中，忽視這種遷移的公司則落後了。儘管這些早期雲端遷移的投資回報很重要，但它並沒有帶來令人信服的變革性或顛覆性成果，也沒有從根本上改變 IT 部門以外人們的工作方式。這是因為數位轉型不僅僅是為了節省成本和方便而將系統遷移到雲端。展望未來，重塑未來意味著不僅要改變業務的進行地點，還要改變其進行方式。這需要最大限度地發揮雲端的優勢，並建立一個讓每個人、每個流程和每項技術都能為業務帶來最高水平創新的環境。這就是我們進入轉型雲端時代的原因，在這個時代，組織不僅僅是在做基礎設施方面的決策，而是在真正地專注於轉型。數位化現在已成為根本，而這個時代是關於在組織的所有團隊中推廣轉型。為了促進這種持續創新和進步，當今最具雄心的組織正在構建轉型雲。轉型雲是一種新的數位轉型方法。它提供了一個用於應用程式和基礎設施現代化、數據民主化、人員聯繫和可信交易的環境。它建立在易於使用的平台上，具有定制的行業解決方案，讓組織相信他們正在節省資金，並為每個人創造更可持續的未來。其結果是一個受益於雲端運算以推動創新、產生新的收入來源以及快速適應市場變化和客戶需求的組織。
...
> 加速創新的組織，其思維方式的一個主要指標在於它們如何看待轉型。它們不再詢問應用程式和服務應在哪裡執行的基礎架構問題，而是詢問如何建立一個能幫助每個人、每個流程和每項技術適應不斷變化業務需求的環境問題。那麼，究竟是什麼類型問題促使組織進行數位轉型？在 Google，當我們與客戶討論他們最大的業務挑戰以及他們需要加速數位轉型的因素時，我們始終聽到五個主題。首先，他們希望成為理解和使用數據的佼佼者。如今，組織必須整合來自數據流、數據湖、數據倉庫和數據庫的數據，以便他們能夠快速輕鬆地打破數據孤島，生成即時洞察，並做出更好的業務決策；從而降低成本和提高效率。其次，他們希望擁有最佳的技術基礎架構。組織正在尋找一個雲平台作為其發展的基礎，並且該平台具有靈活性和安全性，能夠根據市場需求快速適應創新。第三，他們希望創造最佳的混合工作場所。工作方式和地點的根本性轉變需要新的、更強大的聯繫和協作，許多以前當面進行的互動已經數位化。這種變化需要更刻意地建立聯繫和協作。第四，對於組織而言，至關重要的是要知道他們的數據、系統和用戶是安全的。數位世界正在面臨更嚴重的安全問題，因此現在公司正在重新考慮其安全態勢。他們必須找到方法來識別和保護從人員客戶到數據和交易的一切，以應對瞬息萬變的環境。最後，組織將永續性作為一個關鍵的、董事會級別的話題來優先考慮。他們希望通過最大限度地減少環境影響的產品和服務來創造更永續的未來。這些就是我們看到的數位轉型的主要驅動因素，以及許多組織在數位轉型過程中面臨的挑戰。
...
> 轉型雲端建基於五大核心能力：資料、開放式基礎架構、協作、信任與永續科技及方案。讓我們從資料雲端開始探討。資料是釋放 AI 價值的關鍵，對創新和差異化至關重要。但如果資料集分散在營運和分析資料儲存庫中，則要成為資料驅動型公司將會很困難。根據 NewVantage Partners 的 2022 年資料和 AI 高階主管調查，只有 26.5% 的公司成功建立了資料驅動型組織，從其資料中實現有形且可衡量的價值。資料雲端是一種統一的解決方案，可用於管理整個資料生命週期中的資料，無論這些資料位於 Google Cloud 還是其他雲端。它讓組織能夠以極高的規模、速度、安全性及可靠性來識別和處理資料。福特、Spotify、Wayfair 和 UPS 等領先公司使用資料雲端來快速、安全且大規模地促進資料驅動型轉型，所有這些都內建 AI。接下來是開放式基礎架構。組織選擇在 Google 的開放式基礎架構雲端上現代化其 IT 系統，因為它讓他們能夠在簡單、變革性和開放的平台上安全地創新和擴展，從內部部署到邊緣，再到雲端。開放式基礎架構雲端將 Google Cloud 服務帶到不同的物理位置，同時將服務的營運、治理和發展留給 Google Cloud。大多數組織現在不希望依賴單一服務供應商或封閉式技術堆疊，而是希望能夠在最合適的地方執行應用程式，使用基於開放原始碼軟體的混合和多雲方法。開放式基礎架構雲端透過賦予組織選擇和靈活性來建置、遷移和管理其跨內部部署和多個雲端的應用程式，從而促進更快的創新並減少對單一雲端供應商的依賴。讓我們花一點時間來定義兩個經常被混淆的術語：開放標準和開放原始碼。開放標準是指遵循特定規格的軟體，任何人都可以公開存取和使用這些規格。它們具有軟體功能的指南，有助於避免供應商鎖定並確保使用這些標準的產品以可互操作的方式執行。開放標準的例子包括用於在網路上請求內容的 HTTP 或用於儲存結構化資料的 XML。開放原始碼是指其原始碼公開可用且任何人都可以免費使用、修改和分享的軟體。分散式社群通常會基於透明度和開放式理念交換的理念，將開放原始碼軟體開發為公共協作。開放原始碼在開放式雲端中發揮著關鍵作用，為客戶提供他們期望的可攜性。Google 長期以來一直透過開放原始碼分享技術：從 Kubernetes（現在是雲端中容器互操作性的行業標準）等專案到 TensorFlow（一個幫助每個人開發和訓練機器學習模型的平台）。我們提供靈活性的另一種方式是透過由 Anthos 等產品管理的混合和多雲環境，Anthos 建立在 Kubernetes、Istio 和 Knative 等開放技術之上。最後，開放式基礎架構採用合作夥伴生態系統（及其所能為客戶提供的廣泛解決方案），而不是與其競爭。協作有助於轉變人們如何連線、創作和協作。轉型雲端不僅僅是關於技術。人和文化同樣重要。自 COVID-19 大流行開始以來，組織的業務安排在位置和時間靈活性方面均有所提高，混合工作模式將持續存在。隨著工作場所定義的永久改變，跨地區和行業的資訊和前線員工安全地從任何地方、任何設備連線、創作和協作至關重要。這種新的混合工作環境需要支援實體和遠端互動的混合，包括沉浸式數位和行動體驗。例如，Google 通過 Google Workspace 提供協作雲端。Workspace 將通訊和協作應用程式（包括 Gmail、Chat、行事曆、雲端硬碟、文件、試算表和 Meet）整合到以 Google AI 為動力的以人为本的體驗中。值得信賴的雲端有助於組織使用進階安全工具來保護重要資訊。根據 Cybersecurity Ventures 的資料，網路犯罪的年度成本預計到 2025 年將達到每年 10.5 兆美元。由於網路安全威脅的增加，每家公司都在重新考慮其安全姿態。這意味著要找到方法來識別和保護所有事物，從人員和客戶到資料和交易，所有這些都在快速變化的環境中。組織認為雲端比內部部署更安全，他們希望讓員工、客戶和承包商能夠安全地存取其服務變得簡單。他們希望創造更好的可見性，以便在全球範圍內查找、分析、抵抗和修復威脅，並在保持其數位資產控制權的同時，從雲端創新中受益。最後，轉型雲端建立在永續的基礎之上，使用有助於組織更永續地建置和工作的技術和解決方案。如今，鼓勵組織協助創造一個更清潔、更永續的世界，他們需要新的技術來幫助他們持續進步。根據 IDC 的資料，估計到 2024 年，雲端運算將節省 10 億公噸的二氧化碳排放量。最大的公司有機會帶領世界減少排放量，並始終使用無碳能源運作。因此，公司正在遷移到雲端，他們希望有一個永續的基礎架構來為其業務提供動力。例如，在 Google Cloud，我們與客戶合作，透過我們的永續科技和解決方案，讓他們的數位應用程式和基礎架構脫碳。我們自豪地營運業界最潔淨的雲端，擁有最聰明的資料中心，其能源效率是典型企業資料中心的兩倍。遷移到 Google Cloud 可以大幅降低客戶與 IT 相關的碳足跡。


##### 摘要

*   **資料雲端:** 提供統一解決方案，管理整個資料生命週期資料，提升AI價值，實現數據驅動轉型。
*   **開放式基礎架構:**  提供靈活性和選擇，可在內部部署、邊緣和多雲環境中運行應用程式，加速創新並減少供應商鎖定。
...
> 組織如何才能有效推動雲端轉型？遷移至雲端為企業轉型帶來巨大益處，但也存在風險。這項挑戰多面向，對將在雲端運行的解決方案以及支援這些方案的技術都有深遠影響，更包含執行這些方案的人員和管理流程。以「人員、流程和技術」為基礎架構的 Google 雲端導入架構，旨在支援客戶的雲端轉型歷程。Google 雲端導入架構的價值在於，它能作為地圖，透過建立全面的行動計畫來加速雲端導入，協助組織快速有效地採用雲端。它透過建構和協調短期策略性、中期策略性、長期轉型業務目標來達成此目的。它能評估組織在雲端轉型歷程中的現狀，並提供可行的方案，引導組織達成目標。雲端成熟度評估有助於確定組織在 Google 雲端所識別的雲端導入主題方面的現狀。它可以快速揭示組織可能較弱或投資不足的領域，尤其當組織先前未察覺到這種成熟度不足時，此評估更具價值。Google 雲端導入架構不只是一種模型，它也是組織採用雲端所需實際任務的指南。在評估雲端成熟度並提出建議行動後，即可使用此架構輕鬆規劃和架構雲端導入方案。
...
* 了解遷移至雲端基礎架構的優點，並透過客戶業務案例說明。
* 解釋如何將組織的支出從資本支出轉移到營運支出，以及這如何影響其總體擁有成本。
...
> 企業在考慮遷移到雲端時，通常會執行雲端總擁有成本 (TCO) 分析。此分析旨在權衡雲端採用的成本與運行其目前本地系統的成本。對於本地系統，TCO 與評估其整個生命週期中靜態資源的成本相關。但是，由於雲端的動態特性，預測未來成本可能具有挑戰性。組織在嘗試計算雲端 TCO 時常犯的一個錯誤是直接比較雲端的執行成本與其本地系統。這些成本並不相等。本地基礎設施的成本主要取決於硬體和軟體的初始購買，但雲端運算成本則基於每月訂閱或按使用付費模式。還必須考慮運行自身數據中心的全部營運成本，例如電力、冷卻、維護和其他支援服務。數據中心是指在一處容納大量 IT 基礎設施、運算和儲存資源的建築物或設施。最後，還應考慮無形成本，例如未遷移到雲端造成的機會成本和錯失的益處。
...
> 雲端與傳統IT在成本管理方面存在顯著差異。企業從本地基礎設施轉移到按需雲服務，支出模式也從資本支出轉變為營運支出。資本支出（CapEx）是投入固定資產的一次性前期業務支出，例如購買伺服器、印表機或冷卻系統等硬體，以及維護這些資產以延長其使用壽命。小型企業可能難以應付CapEx支出，因為一次性的大額採購成本很高，也會減少企業的自由現金流。營運支出（OpEx）則是為獲得更直接效益而產生的經常性成本，例如網站託管、域名註冊或雲服務訂閱費用等，屬於按需付費項目，而非像CapEx那樣的主要長期投資。

##### 摘要

* **資本支出 (CapEx):**  一次性投入固定資產的費用，例如購買伺服器、硬體設備及維護。特點是前期投入大，長期使用，成本預測基於歷史增長。
* **營運支出 (OpEx):**  經常性費用，例如雲服務訂閱費、網站託管等。特點是按需付費，靈活調整，成本隨使用量變化。
* **本地部署 (On-premises):** 採用CapEx模式，成本管理為年度一次性流程，前期投資巨大，需自行管理和維護基礎設施。
* **雲端部署 (Cloud):** 採用OpEx模式，成本需持續監控，按使用量計費，彈性擴展，節省電力、冷卻、空間及管理成本，雲供應商負責設備折舊。
...
> 組織並非總是需要或能夠單純依靠雲端運作。例如，需求可能需要內部部署基礎架構與 Google Cloud 等公司提供的公有雲服務協同運作。鑑於不同的雲端選項和組態，了解每種選項的含義至關重要。讓我們探討私有雲、混合雲和多雲的定義，以及組織何時可能會選擇每種方法。首先是私有雲，即組織在其自身的資料中心或私有雲提供商的資料中心擁有虛擬伺服器，以建立其自身的私有專用環境。內部部署伺服器也常被稱為私有雲，但一般而言，內部部署軟體在本地環境中運行，而私有雲則透過網路存取。私有雲運算為組織提供了許多公有雲的好處，包括自助服務、可擴展性和彈性，並提供比專用內部部署基礎架構更多的自訂選項。當組織已經進行了大量的基礎架構投資，或者出於法規原因必須將資料保留在內部部署時，通常會採用這種方法。相反，混合雲是指應用程式在多種不同環境中運行的雲端環境。最常見的例子是將私有雲和公有雲環境相結合，例如內部部署資料中心和 Google Cloud 等公有雲運算環境。最後是多雲，它描述的是至少結合兩個公有雲提供商（例如 Google Cloud、Amazon Web Services、Microsoft Azure 等）的架構。如果組織想要利用不同公有雲提供商的主要優勢，則可能會選擇多雲。組織也可能同時運行內部部署和多個公有雲環境，有效地同時成為混合雲和多雲。混合雲方法是當今最常見的基礎架構設定之一，因為組織可以繼續使用其內部部署伺服器，同時也可以利用公有雲。根據 Gartner 的數據，81% 的組織正在使用兩個或更多公有雲提供商。此外，Flexera 的雲端現狀報告顯示，93% 的企業擁有多雲策略。那麼，混合雲或多雲策略是用於什麼的呢？讓我們探討一些不同的業務需求、驅動因素和用例，這些都導致組織選擇這種方法。存取最新的技術；在多個雲端中運行工作負載使組織能夠利用每個雲端提供商的最新創新和功能，從而採取最佳雲端功能方法，並獲得規模、安全性以及敏捷性以快速創新。雲端可以幫助組織建立一些功能，例如高級分析服務，這些服務可能難以或無法在其現有環境中實現。以正確的速度進行現代化；透過混合雲，組織可以按照對其業務有意義的速度將應用程式遷移到雲端，並隨著時間推移轉換其技術基礎架構。改進投資回報率；透過向其現有的內部部署基礎架構添加公有雲提供商，組織可以擴展其雲端運算能力，而無需增加其資料中心支出。這有助於降低資本支出或一般的 IT 支出，並提高成本和資源消耗的透明度。透過工具選擇實現靈活性；混合雲和多雲策略對整個組織都有優勢，但特別有利於從事不同專案並應對不同業務領域獨特挑戰的開發團隊。更廣泛的工具和開發人員人才選擇可以應用於特定的業務問題，這意味著可以更好地響應不斷變化的市場需求。它還可以避免供應商鎖定的問題。提高可靠性和彈性；組織可以將核心工作負載分散到多個雲端和內部部署基礎架構中，以減少停機時間以及對單一故障來源過度依賴的擔憂。這種方法可以提高服務的品質和可用性。維持法規遵從性；許多行業都有來自政府或監管機構關於其應用程式可在何處運行的規定。採用混合解決方案是組織確保遵守區域數據治理、駐留或數位主權要求的有效方法。在內部部署運行應用程式；組織可能擁有必須保留在內部部署或難以遷移到雲端的中央處理器系統的受規範應用程式。混合方法提供了在滿足法規要求的同時創新的自由。最後，在遠端邊緣位置運行應用程式；在遠端位置運行分散式應用程式的行業（例如零售中的資訊亭或電信中的網路）中的組織可以從混合雲中受益。這些應用程式通常需要改進效能和低延遲，而混合方法允許它們在網路邊緣運行選定的應用程式。


##### 摘要

* 私有雲：組織在其自身或私有雲提供商的資料中心擁有虛擬伺服器，提供自訂且符合法規的環境。
* 混合雲：結合私有雲（例如內部部署）和公有雲（例如 Google Cloud），兼顧既有投資和雲端彈性。
* 多雲：結合至少兩個公有雲提供商（例如 Google Cloud、AWS、Azure），利用各家優勢。
* 混合雲和多雲策略優勢：
    * 採用最新技術
    * 循序漸進的現代化
    * 提升投資回報率
...
> 數位轉型提升了網路的重要性。連接客戶、員工、雲端應用程式和裝置的能力，使現代組織能夠取得成功。每一次創新，底層的應用程式和服務都依賴網路進行通訊和連接。但可靠的網路架構如何支援數位轉型策略？快速、可靠且低延遲的全球網路確保了卓越的使用者體驗和高性能。它還使全球數據的通訊和管理更加容易。隨著越來越多的分散式工作團隊和線上業務，擁有可以輕鬆擴展而無需新增硬體的虛擬網路服務，確保組織能夠適應。那麼，網路是如何運作的呢？讓我們從現代互聯網的基礎開始：光纖網路。光纖電纜包含一根或多根光纖，它們是由玻璃或塑膠製成的細絲。這些光纖用於以光脈衝的形式傳輸數據，距離很遠。海底光纖電纜承載了99%的國際網路流量，但我們幾乎沒有注意到它們的存在。第一條海底電纜部署於1858年，用於歐洲和北美洲之間的電報訊息傳輸。一條訊息的傳輸時間超過17小時，每封電報的傳輸時間為2分5秒。今天，一條電纜可以傳輸高達340太位元/秒的數據。這比平均家庭網路連接快2500多萬倍！每個共享的影片、發送的電子郵件和下載的應用程式都依賴於通過國際網路基礎設施傳輸的數據流量。但是，這個內容如何在幾毫秒內提供給人們呢？一個豐富的公司和本地供應商生態系統構建了一個全球基礎設施，為世界各地的企業和個人提供最佳的網路體驗。這些包括互聯網服務供應商（或ISP）。ISP為個人和商業客戶提供互聯網訪問，處理客戶與整個互聯網之間的流量。一些ISP的例子包括Verizon、Vodafone和Softbank。使Google全球影響力成為可能的基礎設施是我們在陸地和海上運行的光纖電纜網路。這個網路連接我們的數據中心和存在點，就像高速公路連接主要城市一樣。Google在世界各地擁有和運營數據中心。在這些Google數據中心中，搜尋、Gmail、YouTube和Google Cloud等產品每天24小時，每周7天為世界各地的人們和組織運行。在这个龐大的全球網路中，不同的部分如何識別和相互通訊？有一些協議讓它工作。讓我們從IP地址開始。IP代表互聯網協議，這個地址是一系列數字，可以識別網路或特定裝置在網路上的位置。域名是一個易於記憶的名稱，它直接映射到互聯網上的IP地址或一組IP地址。它是電子郵件地址中@符號後面和網頁地址中www.後面出現的唯一名稱。例如，域名example.com可能翻譯成IP地址198.102.434.8。其他域名示例包括google.com和youtube.com。然後是域名系統，或DNS。DNS伺服器存儲一個域名映射到IP地址的數據庫，計算機可以使用它來相互通訊。這個系統就像網路的電話簿。每次訪問網站時，計算機都會執行DNS查找。電話簿將「Acme Pizza」這樣的名稱翻譯成正確的電話號碼；同樣，DNS將「www.google.com」這樣的網址翻譯成託管該站點的計算機的IP地址。在本例中，它是Google的主頁。
...
* 光纖網路是現代網路基礎，傳輸速度極快。
* 網路仰賴ISP提供網路連線服務。
* Google等公司擁有全球光纖網路和數據中心。
* IP地址、域名和DNS協同運作，確保網路通訊順暢。
...
> 網絡基礎知識介紹後，讓我們探討網絡效能及其測量方法。網絡中兩個重要的術語是頻寬和延遲。讓我們分別定義它們。頻寬衡量網絡在給定時間內可以傳輸多少數據。這種數據傳輸速率通常以「每秒兆位元」(Mbps) 或「每秒吉位元」(Gbps) 為單位測量。一般來說，較高的頻寬允許電腦更快地從互聯網下載信息。想像一下水流經管道，頻寬就是管道每秒能處理的水量。管道越寬，能處理的水量就越大。互聯網服務供應商提供的家用網絡連接速度可能從每秒 100 兆位元到每秒 1 吉位元以上不等；數據中心可能擁有從每秒 10 吉位元到 100 吉位元的頻寬！當每秒發送大量數據（例如串流高清視頻）時，擁有高頻寬非常有用，但它並不是網絡效能的唯一重要指標。例如，對於玩線上即時多人遊戲的用戶來說，延遲會更重要。網絡延遲是指數據從一點傳輸到另一點所需的時間。延遲通常以毫秒為單位測量，有時也稱為延遲，它描述了網絡通信中的延遲。回到我們的水流比喻，延遲就是從打開水管到水開始流動之間的延遲。理想情況下，延遲應盡可能接近零。然而，由於數據必須通過電線、光纖、路由器等物理距離才能到達目的地，因此沿途的每個「跳躍」都會在通信中增加少量延遲。無論您可以一次發送和接收多少數據，它的傳輸速度都只能達到網絡延遲允許的速度。想像一下，一個圖片文件使用高頻寬連接只需 10 毫秒即可下載，但用戶必須等待 100 毫秒才能收到第一個數據位元組。在這種情況下，延遲（即數據包在網絡中從一點到另一點傳輸所需的時間）佔用了大部分時間。雲計算和移動技術使開發人員更容易接觸到全球用戶，但高延遲會降低應用程序的性能。網站對某些用戶的運行速度較慢，取決於他們的物理位置，即使用戶和服務器都具有出色的頻寬也是如此。因此，用戶離服務器越遠，網絡越分散，延遲就越大。減少延遲對於更快地接觸用戶至關重要。
...
> 歷年來，Google 投資數十億美元打造其網絡，使其成為全球最大的網絡之一。該網絡旨在為客戶應用程式提供最高的吞吐量和最低的延遲。Google Cloud 的基礎架構遍佈五大主要地理位置：北美洲、南美洲、歐洲、亞洲和澳洲。擁有眾多服務據點至關重要，因為應用程式的部署位置會影響可用性、持久性和延遲等品質，其中延遲是指資訊封包從源頭傳輸到目的地的時間。每個地理位置都劃分為數個不同的區域和區域。區域代表獨立的地理區域，並由區域組成。例如，倫敦 (europe-west2) 是一個目前包含三個不同區域的區域。區域是部署 Google Cloud 資源的地區。例如，如果您使用 Compute Engine 啟動虛擬機器，它將在您指定的區域中執行，以確保資源冗餘。您可以在不同的區域中運行資源。這對於將應用程式更靠近全球各地的用戶，以及在整個區域出現問題（例如自然災害）時提供保護非常有用。部分 Google Cloud 服務支援將資源放置在我們稱為多區域的位置。例如，Cloud Storage 允許您將數據放置在歐洲多區域中。這表示數據至少冗餘儲存在兩個地理位置，在歐洲境內相隔至少 160 公里，例如倫敦和比利時。您可以在 cloud.google.com/about/locations 找到 Google Cloud 區域和區域的最新數據。


##### 摘要

* Google 斥資巨額建設全球大型網路，以提供高吞吐量和低延遲。
* Google Cloud 基礎架構涵蓋北美、南美、歐洲、亞洲和澳洲五大洲。
* 多個服務據點可提升應用程式的可用性、持久性和降低延遲。
* 架構分為區域和區域，區域為獨立地理區域，包含多個區域。
* 資源可在不同區域部署，以提升用戶體驗和災難恢復能力。
* 部分服務支援多區域部署，例如 Cloud Storage 可在歐洲多個地點冗餘儲存數據。
* Google Cloud 區域和區域的最新資訊，請參考 cloud.google.com/about/locations。
...
> 企業最佳實務建議：盡可能在其大部分旅程中將流量保留在 Google 的私有網絡上。與 Gmail、Google 搜尋和 YouTube 等產品使用的網絡相同，讓企業能善用全球基礎設施提供的效能。使用者開啟 Google 應用程式或網頁時，Google 會從邊緣網絡位置回應請求，以提供最低延遲。了解 Google 的邊緣網絡及其如何維護儲存熱門內容的快取，有助於企業選擇何時將流量移交給 Google。網絡邊緣定義為設備或組織網絡連接到互聯網的位置，稱為「邊緣」，因為它是網絡的入口點。Google 的邊緣網絡是我們與 ISP 連接以獲取使用者流量的方式。它由網絡基礎設施組成，企業可以根據使用者的需求、效能和成本將流量移交給它。Google 的目標是為使用者提供高性能、高可靠性和低延遲的服務。我們已投資符合此目標的網絡基礎設施，這也使我們能夠高效且經濟地與網絡營運商交換流量。這就是網絡基礎設施如何支援數位轉型的模式。


##### 摘要

*   建議企業將大部分流量保留在 Google 私有網絡上，以提升效能。
*   Google 邊緣網絡透過全球基礎設施，提供低延遲的服務。
*   Google 邊緣網絡儲存熱門內容快取，優化內容傳輸。
*   企業可根據需求、效能和成本，選擇將流量移交給 Google 邊緣網絡。
*   Google 致力於提供高性能、高可靠性和低延遲的服務。
*   Google 的網絡基礎設施支援高效且經濟的流量交換，促進數位轉型。
...
> 本課程第二單元：Google Cloud數位轉型到此結束。讓我們快速回顧一些雲端基本概念。我們探討了不同產業客戶如何透過遷移至雲端，創造新的工作方式，從而轉型其業務的案例。雲端的總擁有成本計算與傳統的靜態長期採購模式大相逕庭，雲端更具動態性和按需使用特性。遷移至雲端意味著將支出從資本支出轉變為營運支出模式，使組織只需為其使用的資源和使用的時間付費。我們定義了私有雲、混合雲和多雲，並描述了促使組織選擇這些方法的不同業務驅動因素。最後，您學習了快速、可靠且低延遲的全球網路作為轉型和卓越用戶體驗的基礎的重要性。


##### 摘要

* 	雲端總擁有成本計算與傳統模式差異大，採動態按需使用。
* 	雲端支出模式從資本支出轉為營運支出，按使用付費。
* 	定義並說明私有雲、混合雲和多雲及其商業驅動因素。
* 	強調快速、可靠、低延遲的全球網路對數位轉型和用戶體驗的重要性。
* 	探討不同產業客戶透過雲端轉型業務的案例。


#### Quiz

- https://www.cloudskillsboost.google/paths/9/course_templates/266/quizzes/509992
...
遷移到雲端時，需要決定如何管理和操作不同的雲端服務。其中一個決定是關於要使用的雲端運算服務模式類型。組織通常會根據其特定的業務需求選擇服務模式類型。在本課程的這一部分，您將探討三種主要的雲端運算服務模式：IaaS（基礎設施即服務）、PaaS（平台即服務）和 SaaS（軟體即服務）。由於組織和其雲端服務提供者之間的責任等級會因應使用的模式而有所不同，您還將檢查 Google Cloud 與我們的客戶之間的共享責任模式。在本節結束時，您將能夠：定義 IaaS、PaaS 和 SaaS；比較和對比 IaaS、PaaS 和 SaaS 的優點和權衡；確定哪些運算模型適用於各種業務情境和用例；描述雲端共享責任模式；以及識別哪些責任屬於雲端提供者或客戶的，適用於本地和雲端運算模式。


##### 摘要

* 定義 IaaS、PaaS 和 SaaS 三種雲端服務模式。
* 比較和對比 IaaS、PaaS 和 SaaS 的優缺點。
* 根據不同業務情境和用例，判斷適用之雲端運算模型。
* 描述雲端共享責任模式。
* 辨識本地和雲端運算模式下，雲端供應商與客戶各自的責任。
...
雲端運算的世界提供了多樣化的運算服務模式，以滿足不同的客戶需求。您可能聽說過IaaS、PaaS和SaaS等術語。這些術語代表著雲端供應商提供的不同「服務型態」的雲端運算模式。「服務型態」指的是在這些模式中IT資源的消耗方式，也是雲端運算與傳統IT之間的關鍵區別。在傳統IT中，組織透過購買、安裝、管理和維護自有資源（例如硬體、軟體和開發工具），在其本地或自行管理的資料中心使用這些資源。組織需全權負責其所有本地IT基礎架構。在雲端運算中，雲端服務供應商擁有、管理和維護這些資源。客戶則以訂閱或按次付費的方式使用這些資源。您只需要網路連線即可。雲端運算允許第三方負責基礎架構的一部分，這意味著組織可以有更多時間專注於核心業務。接下來，我們將探討三種不同的雲端運算服務模式：基礎設施即服務（IaaS），提供計算和儲存等基礎設施資源；平台即服務（PaaS），提供開發和部署環境以構建雲端應用程式；以及軟體即服務（SaaS），提供完整的應用程式作為服務。每種模式都提供不同的功能，了解它們之間的差異有助於組織選擇最符合其業務需求的模式。重要的是，大多數使用雲端的組織通常會結合多種雲端運算模式來滿足不同的需求。您可以將這些雲端運算模式視為層次結構。從一個模式到另一個模式向上移動時，每個模式都需要更少的基礎架構知識和管理。這個概念稱為抽象化。在雲端架構中，隨著抽象化程度的提高，對底層實現的了解就越少。「抽象化」基礎架構的目標是通過移除不必要的信息和簡化操作來降低複雜性。想想您駕駛汽車的方式。當您打開點火裝置、踩剎車、換擋和加速時，您不會考慮引擎在引擎蓋下是如何運作的，對吧？這種複雜性被抽象化了，因此您可以專注於安全地駕駛到目的地。抽象化是雲端運算的核心特徵之一。在選擇雲端運算服務模式時，組織必須決定所需的控制和管理程度，或者他們希望隱藏多少技術細節並專注於業務需求。讓我們使用交通工具的類比來比較本地部署、IaaS、PaaS和SaaS。本地IT基礎架構就像擁有一輛汽車。當您購買汽車時，您需要負責其使用和維護。升級意味著購買新車，這需要時間且可能成本高昂。IaaS就像租賃一輛汽車。當您租賃汽車時，您可以選擇一輛汽車並隨意駕駛，但這輛車不是您的。但是，升級更容易，因為您可以租賃新車。PaaS就像乘坐計程車。您提供具體的指示（例如代碼），但司機負責實際駕駛。SaaS就像搭乘公車。您仍然可以使用交通工具，但可定制性較低。公車有指定的路線，您還需要與其他乘客共享空間。


##### 摘要

*   雲端運算提供IaaS、PaaS和SaaS等服務模式。
*   傳統IT由組織自行管理，雲端運算則由供應商管理資源。
*   IaaS提供基礎設施資源（計算、儲存）。
*   PaaS提供開發和部署環境。
*   SaaS提供完整的應用程式服務。
*   大多數組織使用多種雲端模式。
*   抽象化降低雲端運算的複雜性。
*   本地部署如擁車，IaaS如租車，PaaS如搭計程車，SaaS如搭公車。
...
> 現在讓我們更詳細地檢視這些運算模型。我們將從基礎設施即服務 (IaaS) 開始。IaaS 是一種運算模型，提供幾乎無限可擴展的基礎設施資源 (例如運算、網路、儲存和資料庫) 的隨選可用性，這些資源透過網際網路以服務形式提供。IaaS 允許組織租用所需的資源，而不必一次性購買硬體，而且他們只需支付使用的費用。它提供與傳統資料中心相同的技術和功能，而無需實際維護或管理所有這些。企業選擇 IaaS 的主要原因之一是減少資本支出並將其轉換為營運支出。IaaS 很吸引人，因為以傳統方式獲取運算資源來執行應用程式或儲存資料需要時間和資本。組織必須透過可能需要數個月的採購流程來購買設備。他們還必須投資於物理空間，這些空間通常是配備電力和冷卻系統的專用房間。部署系統後，他們需要 IT 專業人員來管理它們。這種傳統方式在需求激增或業務增長時很難擴展。組織冒著容量不足或過度建設並最終導致基礎設施利用不足的風險。相比之下，IaaS 資源作為個別服務提供，因此組織可以選擇其所需資源。雲端供應商管理基礎設施，企業可以專注於安裝、配置和管理軟體以及確保其資料安全。運算引擎和雲端儲存是 Google Cloud IaaS 產品的示例。您可以使用運算引擎建立和執行虛擬機器，並可以使用雲端儲存儲存任何類型的資料。那麼，IaaS 的好處是什麼？它經濟實惠。因為 IaaS 資源是按需使用的，而且您只需支付使用的費用，所以 IaaS 成本相當可預測且易於預算。它效率高。IaaS 資源在您需要時隨時可用。因此，擴展基礎設施時延遲較少，也不會因過度建設容量而浪費資源。這種效率導致開發週期更快，最終縮短上市時間。它能提高生產力。因為雲端供應商負責建立和維護物理基礎設施，所以 IT 部門可以節省時間和金錢。然後，他們可以將資源重新導向到更具策略性的活動。它可靠。IaaS 沒有單點故障。即使硬體資源的一個組件發生故障，服務通常仍可用。而且它可擴展。IaaS 在雲端運算中的最大優勢之一是能夠根據業務需求快速擴展和縮減資源。那麼，IaaS 適用於哪些情況？IaaS 的靈活性和可擴展性對於以下組織非常有用：工作負載量不可預測或需要快速響應業務波動的組織；需要比傳統資料中心所能提供的更高基礎設施可擴展性和敏捷性的組織；業務增長速度超過基礎設施能力的組織；經歷基礎設施服務需求不可預測的峰值的組織；以及現有基礎設施資源利用率低的組織。


##### 摘要

*   提供隨選、幾乎無限可擴展的運算、網路、儲存和資料庫等基礎設施資源。
*   按需付費，減少資本支出，轉變為營運支出。
*   由雲端供應商管理基礎設施，企業專注於軟體和資料安全。
*   經濟實惠、高效、提高生產力、可靠且可擴展。
*   適用於工作負載量不可預測、需快速回應業務波動、高增長、需求峰值或基礎設施利用率低的組織。
...
> 平台即服務 (PaaS) 是一種計算模型，提供基於雲端的平台來開發、運行和管理應用程式。PaaS 為開發人員提供了一個框架，他們可以利用這個框架來建立和使用自訂應用程式。PaaS之所以吸引人，是因為它為開發人員提供了一個平台，讓他們可以開發、運行和管理自己的應用程式，而無需建立和維護相關的基礎架構。他們還可以利用內建的軟體組件來構建應用程式，從而減少需要編寫的程式碼量。Google Cloud 的 Cloud Run 和 BigQuery 就是 PaaS 產品的例子。Cloud Run 是一個完全託管的無伺服器平台，用於大規模開發和託管應用程式，它負責根據需求配置伺服器和調整應用程式執行個體的規模。BigQuery 是一個完全託管的企業級數據倉庫，用於管理和分析數據，並且可以通過查詢來回答大數據問題，而無需任何基礎架構管理。那麼，PaaS 的好處有哪些呢？它可以減少開發時間。開發人員可以直接進行編碼，而不必花費時間設置和維護開發環境，從而縮短上市時間。它具有可擴展性。借助 PaaS，組織可以根據需要購買額外的容量來構建、測試、階段和運行應用程式。它還允許應用程式設計師利用雲基礎架構固有的可擴展性。它可以減少管理工作。通過進一步抽象底層資源的管理（比 IaaS 更進一步），PaaS 將基礎架構管理、修補程式、更新和其他管理任務分擔給雲服務提供商。這提供了一種經濟有效的方法來專注於新功能。而且它很靈活。通過支援不同的程式語言和方便分佈式團隊的協作，PaaS 為開發人員提供了靈活性，使他們能夠在同一個平台上交付各種項目，從原型到企業解決方案。那麼，PaaS 適用於哪些場景呢？PaaS 適用於以下組織：想要創建獨特且自訂的應用程式，而無需大量投資於擁有和管理基礎架構；想要快速測試和部署應用程式；擁有許多遺留應用程式，並想要降低營運成本；有一個新的應用程式項目，他們希望通過盡可能快地擴展和更新應用程式來快速部署；只想在使用資源時才支付費用；想要將耗時的任務（例如設置和維護應用程式伺服器以及開發和測試環境）外包。
...
*   減少管理負擔，將基礎設施管理外包。
*   靈活支援多種程式語言及團隊協作。
*   適用於需要快速開發、部署及彈性擴展的應用程式。
*   適合希望降低基礎設施投資和營運成本的組織。
*   適用於擁有大量遺留應用程式並希望降低維護成本的組織。
...
> 軟體即服務 (SaaS) 是一種運算模式，透過網路瀏覽器提供由雲端供應商管理的完整應用程式。雲端供應商在雲端託管應用程式軟體，並透過瀏覽器傳送。使用此模式，您無需下載或安裝任何軟體。SaaS 引人注目之處在於它完全將技術從消費者身上抽象化；終端使用者無需關心底層基礎架構，這是雲端供應商的責任。組織只需支付訂閱費用即可使用現成的軟體產品。Google Workspace（包含 Gmail、Google Drive、Google Docs 和 Google Meet 等工具）就是 Google Cloud 的 SaaS 產品。那麼，SaaS 的好處有哪些呢？它維護成本低。SaaS 消除了 IT 工作人員在每台電腦上下載和安裝應用的需要。使用 SaaS，供應商管理所有潛在的技術問題，例如雲端中的數據、伺服器、儲存和更新。這有助於簡化組織的維護和支援。它具有成本效益。SaaS 基於訂閱模式，每月或每年的帳戶費用固定且包含所有費用。可預測的成本和按使用者計費允許清晰的財務管理。它很靈活。使用者線上登入其個人帳戶後，即可隨時隨地透過網路存取所有內容。他們可以從任何地方、任何裝置隨時存取軟體。那麼，SaaS 適用於哪些情況呢？SaaS 適用於：想要使用需要最小自訂的標準軟體解決方案的組織；不希望投資時間或內部專業知識來維護應用程式或基礎架構的組織；需要更多時間讓 IT 團隊專注於策略性項目的組織；以及需要從各種裝置和位置存取應用的組織。


##### 摘要

*   **定義**: SaaS 是一種透過網路瀏覽器提供完整應用程式的雲端運算模式，使用者無需下載或安裝。
*   **優點**:
    *   維護成本低：雲端供應商負責所有技術問題。
    *   成本效益高：基於固定費用的訂閱模式，成本可預測。
    *   靈活性高：使用者可隨時隨地從任何裝置存取應用程式。
*   **適用對象**:
    *   需要標準軟體解決方案且自訂需求低的組織。
    *   不願投入資源維護應用程式或基礎架構的組織。
    *   希望 IT 團隊專注於策略性項目的組織。
    *   需要跨裝置和地點存取應用的組織。
...
> 組織如何決定哪種雲端運算模式最適合自身？答案取決於其業務需求、所需功能和可用專業知識。如果他們正在尋找高度靈活、可擴展的服務，同時又能控制其基礎架構，那麼 IaaS 是正確的選擇。此模型提供最大的控制和自定義選項，但也需要最多的管理責任和技術專業知識。如果他們需要一個設計用於構建軟體產品的平台，那麼 PaaS 將立即幫助他們的業務。這提供了一種經濟高效的構建應用程式的方法，但仍然需要一些技術專業知識和較少的管理工作。如果他們想要即用型功能，而無需安裝的麻煩，那麼 SaaS 可能是最佳選擇。這代表最少的管理責任和技術專業知識，但也提供最少的控制和自定義選項。然而，這些運算模式並非相互排斥的。根據用例的不同，大多數組織將結合使用所有三種模式來滿足不同的業務需求。他們需要根據管理級別、控制、責任、靈活性以及所需的專業知識等變量來比較他們的選項。例如，想像一下，一個大型組織需要實施一個新的庫存管理系統。如果他們擁有內部開發專業知識並願意管理基礎架構，他們可以使用 IaaS 資源來構建它。組織的 IT 團隊將完全控制伺服器配置，但也需要承擔管理和維護的負擔。他們可以選擇 PaaS 解決方案並構建自定義 CRM 應用程式，同時將基礎架構的管理負擔轉嫁給雲服務提供商；保留對應用程式功能的完全控制，但減少管理負擔。最後，他們可以選擇購買現成的 SaaS 解決方案；無需每日管理基礎架構，但也放棄對軟體中所有功能和功能的控制。這些選項都是可行的解決方案，因此組織必須比較每個用例的優缺點。這些雲端運算服務模式為組織提供了本地託管無法提供的選擇、靈活性和選項。


##### 摘要

*   選擇雲端運算模式取決於組織的業務需求、功能和專業知識。
*   IaaS 提供高度靈活性和自定義，但需要較高管理責任和技術專業知識。
*   PaaS 提供成本效益高的應用程式開發平台，但仍需一定技術專業知識。
*   SaaS 提供即用型功能，管理責任和技術要求最低，但控制和自定義選項也最少。
*   大多數組織會結合使用 IaaS、PaaS 和 SaaS 來滿足不同需求。
*   組織需根據管理級別、控制、責任、靈活性及所需專業知識比較不同模式的優缺點。
*   雲端運算模式相較於本地託管，提供更多選擇、靈活性和選項。
...
> 雲端運算模型在安全責任方面有所不同。當組織自行管理數據中心時，需負責所有安全層面。然而，隨著基礎設施遷移至雲端，部分責任會轉移給雲端供應商，此概念稱為共享責任模型。雲端安全是雲端供應商和客戶共同的責任。儘管直接責任會根據雲端運算服務模型而有所不同，但組織始終控制其數據安全，而雲端供應商始終負責基礎設施安全。在 Google Cloud，我們使用與自身營運相同的基礎設施和安全服務來保護組織的數據免受威脅和欺詐活動。然而，雲端安全與雲端內的安全是兩碼事。簡而言之，雲端供應商負責雲端安全，客戶負責雲端內的安全。組織務必了解特定客戶責任如何根據所使用的雲端運算模型類型而有所不同。這一點尤其重要，因為根據 Gartner 的報告，到 2025 年，99% 的雲端安全故障將是由使用者錯誤造成。組織必須了解其在雲端安全中的角色和責任才能確保安全。
...
*   雲端供應商負責雲端基礎設施安全。
*   客戶負責其在雲端中的數據安全。
*   責任分配依據雲端運算服務模型（例如IaaS, PaaS, SaaS）而有所不同。
*   使用者錯誤是雲端安全失敗的主要原因 (Gartner預測至2025年將佔99%)。
*   組織必須了解自身在雲端安全中的角色與責任。
...
> 雲端運算模型中，雲端供應商的責任範圍與客戶的責任範圍劃分明確。一般原則是：「如果您設定或儲存它，您就負責保護它。」這意味著雲端供應商負責保護其直接控制的雲端部分，例如硬體、網路和實體安全；同時，客戶負責保護其在雲端中建立的任何內容，例如配置、存取策略和使用者數據。無論您使用哪家雲端供應商，責任都是共負的。讓我們檢視 Google Cloud 作為服務供應商與客戶之間的責任比例。藍色方塊代表客戶負責的基礎架構安全部分，黃色方塊代表 Google Cloud 負責的元素。首先是本地部署。當組織運行自己的本地數據中心時，基礎架構的安全完全由組織的內部團隊負責，包括伺服器及其上儲存的數據安全。接下來是基礎設施即服務 (IaaS)。當組織轉向 IaaS 運算模型時，部分 IT 安全責任將委託給 Google Cloud，包括實體資源的責任，以及與客戶共同負責基礎架構和網路安全。其餘部分，例如作業系統、運行其應用程式所需的軟體堆疊以及其數據的安全，則由客戶負責。這讓客戶擁有最大的自由度和控制權，但也將大部分責任交給他們。當組織使用平台即服務 (PaaS) 模型時，更多責任將轉移給 Google Cloud，包括實體基礎架構、存取和驗證、網路安全以及來賓作業系統的全部責任。客戶仍然負責平台上產生的任何內容（例如程式碼或數據）的安全。最後，對於軟體即服務 (SaaS) 模型，Google Cloud 負責幾乎所有方面的安全，從底層基礎架構到實際應用程式。客戶仍然負擔一些安全責任，例如應用程式使用情況、存取策略（例如防止釣魚攻擊的驗證設定）以及使用者內容。共享責任模型的一個重要方面是，客戶始終負責其數據的安全，無論他們是否有本地數據中心，還是僅支付單一使用者許可證的月費。客戶控制誰或什麼可以存取其數據。Google Cloud 致力於保護客戶數據的安全，但安全是共享責任，需要合作。


##### 摘要

* **本地部署：** 組織全權負責所有基礎架構及數據安全。
* **基礎設施即服務 (IaaS)：** Google Cloud 負責實體資源，客戶負責作業系統、軟體堆疊及數據安全。
* **平台即服務 (PaaS)：** Google Cloud 負責實體基礎架構、存取驗證、網路安全及作業系統，客戶負責內容安全。
* **軟體即服務 (SaaS)：** Google Cloud 負責幾乎所有安全層面，客戶負責應用程式使用、存取策略及使用者內容。
* **數據安全：** 無論採用何種模型，客戶始終對其數據安全負責。
...
> 本課程已完成 Google Cloud 數位轉型課程的第三單元。讓我們快速回顧一下雲端運算模型和共享責任。您學習了三種主要的雲端運算服務模型：IaaS（基礎設施即服務）、PaaS（平台即服務）和 SaaS（軟體即服務）。每個模型都提供不同層級的服務和產品組合，以滿足組織的需求。您還學習了每種雲端運算模型的主要優點和權衡取捨，如何幫助組織選擇最符合其業務需求的模型。透過了解每種運算模型的內容，組織將能更好地做出正確的資源和預算決策。最後，您學習了雲端供應商及其客戶之間的共享責任。雖然雲端供應商將確保雲端基礎設施的安全，但保護其資料的安全則是客戶的責任。


##### 摘要

* 完成 Google Cloud 數位轉型課程第三單元。
* 回顧雲端運算模型 (IaaS、PaaS、SaaS) 及其優缺點。
* 學習不同模型的資源配置與預算決策。
* 釐清雲端供應商與客戶在資安上的共享責任。

#### Quiz

- https://www.cloudskillsboost.google/paths/9/course_templates/266/quizzes/510002
...
> 本課程「以 Google Cloud 實現數位轉型」到此結束，您已學習雲端科技的基礎知識，以及此科技如何改變數位時代的商業模式。課程的第一部分「為何雲端科技正在改變商業模式」，您學習到：與雲端和數位轉型相關的重要術語；關於組織數位轉型的雲端科技優勢；內部部署基礎架構、公有雲、私有雲、混合雲和多雲之間的差異；以及促使組織進行數位轉型的驅動因素和挑戰。在課程的第二部分「雲端基本概念」中，您學習到：透過客戶業務案例了解遷移到雲端基礎架構的優勢；Google Cloud 中解決方案和產品之間的差異；遷移到雲端如何將組織的支出從資本支出轉變為營運支出，以及這如何影響其總體擁有成本；私有雲、混合雲或多雲基礎架構最適用於哪些不同的業務案例；基本的網路基礎架構術語；以及 Google Cloud 如何透過快速可靠的網路連接的全球基礎架構和資料中心支援數位轉型。在課程的第三部分「雲端運算模型和共享責任」中，您學習到：IaaS、PaaS 和 SaaS 的定義、優勢和權衡；哪種運算模型適用於各種業務情境和案例；雲端共享責任模型是什麼；以及對於內部部署和雲端運算模型，哪些責任屬於雲端供應商或客戶。現在您已全面了解數位轉型，請繼續修習系列中的下一門課程「探索以 Google Cloud 實現資料轉型」，您將學習到：資料的價值；雲端資料轉型歷程；Google Cloud 資料管理解決方案；以及 Google Cloud 智能分析和商業智慧解決方案。
...
* **第二部分：雲端基本概念**
    * 遷移至雲端基礎架構之優勢 (客戶業務案例)
    * Google Cloud 中解決方案與產品之差異
    * 雲端支出模式轉變 (資本支出轉營運支出) 及其對總擁有成本之影響
    * 私有雲、混合雲及多雲於不同業務案例之應用
    * 基本網路架構術語
    * Google Cloud 全球基礎架構及資料中心支援數位轉型

* **第三部分：雲端運算模型和共享責任**
    * IaaS、PaaS 及 SaaS 之定義、優勢與權衡
    * 各運算模型於不同業務情境與案例之應用
    * 雲端共享責任模型
    * 雲端供應商與客戶之責任區分 (內部部署與雲端運算模型)

* **下一課程：探索以 Google Cloud 實現資料轉型**
    * 資料價值
    * 雲端資料轉型歷程
    * Google Cloud 資料管理方案
    * Google Cloud 智能分析與商業智慧方案
...
> 商業數據並非新名詞，因為組織長期以來都運用有關績效和營運的資訊來做決策。然而，傳統方法的數據分析可能需要數天或數月，而且往往不完整。此外，通常需要專業團隊才能製作複雜的報告。有了雲端技術，情況就大不相同了。數據現在可以以前所未有的速度和規模進行使用、分析和應用。事實上，組織現在可以利用雲端技術即時提取數據，來訓練機器學習模型，並採取有利於其業務的方式行動。您不再需要成為數據科學家或技術專家就能執行數據分析。有鑑於此，「探索 Google Cloud 的數據轉換」這門課程旨在幫助您了解數據的價值及其如何影響客戶體驗，學習可用的不同 Google Cloud 數據管理解決方案，並探索 Google Cloud 產品如何使數據對員工更有用、更容易取得。在整個課程中，您將會遇到分級的知識評估。您必須通過這些評估才能獲得課程學分。好的，讓我們開始吧！


##### 摘要

* 商業數據應用歷史悠久，但傳統分析耗時且不完整。
* 雲端技術實現高速大規模數據分析，即時數據處理及機器學習模型訓練。
* 降低數據分析門檻，無需專業技術背景。
* 課程目標：了解數據價值、Google Cloud 數據管理方案及數據應用。
* 課程包含分級評估，需通過以獲得學分。
...
> 現今商業界大量使用「數據」一詞，箇中原因是擷取、管理和運用數據，是幾乎所有產業重新定義客戶體驗和創造新價值的核心。本課程單元將探討數據如何產生商業洞察並推動決策、基本的數據管理概念（例如資料庫、數據倉庫和數據湖）、組織如何透過使用現有數據、收集新數據和外部數據來源來創造價值、雲端如何釋放所有類型數據（包括結構化數據和先前未開發的非結構化數據）的商業價值、數據價值鏈（從數據的初始創建到數據激活），以及數據治理在成功數據旅程中扮演的重要角色。


##### 摘要

* 數據是現代商業的核心，驅動客戶體驗再造及價值創造。
* 數據產生商業洞察，引導決策。
* 涵蓋資料庫、數據倉庫、數據湖等數據管理概念。
* 探討組織如何運用內外部數據創造價值。
* 雲端技術有助於釋放結構化與非結構化數據的價值。
* 闡述數據價值鏈，從數據產生到數據應用。
* 強調數據治理在數據應用成功中的重要性。
...
> 數據是推動創新和差異化的重要因素，也是釋放人工智慧價值的關鍵。數據為 AI 驅動的商業洞察力提供動力，幫助公司做出更好的即時決策，也是公司構建和運行其應用的基礎。我們每天都在產生越來越多的數據，數據的複雜性和到達速度正在改變商業環境。然而，最有價值的見解不再僅僅來自銷售、庫存和人事數據。它們通常隱藏在來自眾多來源和系統的非結構化數據點中。提取這些見解需要恰當的工具、技能和策略組合。一些數據很容易捕獲，例如財務數據，因為它可以在數據庫和電子表格中找到。但其他數據可能沒那麼容易，例如，您的客戶如何通過社交媒體平台與您互動。收集數據後，如何存儲數據以便从中獲得見解？借助機器學習 (ML) 和人工智慧 (AI)，組織可以從過去和現在的數據中生成見解，還可以以新的方式感知、預測、推薦和分類數據。例如，ML 允許線上零售商使用智能分析工具來獲取實時的客戶行為數據，同時為特定用戶提供最佳建議。因此，用戶每一次點擊都會使他們的網站體驗越來越個性化。然而，一些組織難以消除阻礙他們與數據之間的障礙。根據埃森哲的報告“彌合數據價值差距”，68% 的組織表示他們仍然無法從數據中實現有形且可衡量的價值。想要適應的組織必須確定如何彌合差距並支持價值創造。智能數據雲是釋放更多商業價值的關鍵。


##### 摘要

* 數據是驅動創新、差異化及釋放 AI 價值的關鍵。
* 數據支持 AI 商業洞察、即時決策和應用程式開發。
* 數據量與複雜度日增，改變商業環境。
* 有價值的見解不僅來自結構化數據，更來自大量非結構化數據。
* 需要整合工具、技能和策略以提取數據洞察。
* 機器學習和人工智慧能從數據中生成見解，並以創新方式處理數據。
* 部分組織難以從數據中獲取價值。
* 智能數據雲是釋放更多商業價值的關鍵。
...
> 解鎖數據的價值是數位轉型的核心。要產生洞見，您可能需要結合不同類型的數據。然而，並非所有數據的建立和組織方式都相同。數據可分為三大類：結構化數據、半結構化數據和非結構化數據。結構化數據組織良好且定義明確。它通常儲存在表格中，不同行和列之間存在關聯，例如電子表格或數據庫。由於結構化數據以這種方式組織，因此易於分析。例如，組織通常在客戶關係管理工具 (CRM) 中使用結構化數據，因為它們遵循客戶行為模式和趨勢。半結構化數據介於結構化數據和非結構化數據之間。它被組織成一個層次結構，但沒有完全的區分或任何特定的順序。示例包括電子郵件、HTML、JSON 和 XML 文件。儘管此數據類型沒有正式結構，但它包含標籤或其他標記，使其比非結構化數據更容易分析。非結構化數據是指沒有預定義數據模型或未以預定義方式組織的信息。類別包括：文本，這是最常見的，通常從文檔、演示文稿甚至社交媒體帖子等來源生成和收集。數據文件，例如圖像、音頻文件和視頻。以及基礎設施活動和性能數據，例如來自服務器、網絡和應用程序的日誌文件或物聯網 (IoT) 傳感器的輸出數據。組織可以使用非結構化數據來實現許多用途。例如，營銷團隊可能會分析社交媒體帖子以識別對品牌的觀點。或者客戶服務團隊可能會通過分析客戶溝通中的語言並提供互動式響應來訓練自動聊天機器人以增強支持人員。但總體而言，非結構化數據歷來難以分析。根據哈佛商業評論，平均而言，組織中不到 1% 的非結構化數據得到分析或使用。直到最近，利用非結構化數據潛力的工具還不可用，或者價格過高且複雜。根據 Gartner 的研究，非結構化數據佔所有新企業數據的 80% 到 90%，這使得這一統計數據更加令人擔憂。這揭示了數據生成與其提供的價值之間驚人的差距。但是，雲技術改變了這種狀況。通過適當的雲工具，企業可以使用機器學習從非結構化數據中提取價值，甚至可以使用應用程序編程接口 (API) 從數據中提取結構。API 的一個示例是 Google Cloud 的 Vision API，它使用機器學習來檢測圖片中的產品，甚至可以標記圖片以描述其內容。了解可用的不同類型數據可以幫助組織定義其數據解決方案的可能性。雲技術的變革力量之一是它如何能夠解鎖結構化數據和以前未開發的非結構化數據的價值。


##### 摘要

*   數據可分為結構化、半結構化和非結構化三種類型。
*   結構化數據組織良好，易於分析。
*   半結構化數據具有一定層次結構，但缺乏完全區分。
*   非結構化數據缺乏預定義數據模型或組織方式，例如文本、圖片、音頻和日誌文件等。
*   非結構化數據佔企業數據的 80-90%，但過往分析利用率低。
*   雲技術和機器學習可有效分析非結構化數據，例如利用 Google Cloud 的 Vision API 提取圖片資訊。
*   了解不同數據類型有助於組織發掘數據潛力。
...
企業需要現代化的企業數據方法來管理產生的海量數據。選項清單通常包括數據庫、數據倉庫和數據湖。讓我們從數據庫開始探討這些選項。數據庫是有組織的數據集合，存儲在表格中，並通過計算機系統以電子方式訪問。讓我們檢視兩種數據庫類型：關係型和非關係型。關係型數據庫存儲並提供對彼此相關的數據點的訪問。這意味著將信息存儲在具有明確定義的模式的表格、行和列中，該模式表示數據庫的結構或邏輯配置。關係型數據庫可以通過連接表來建立信息之間的鏈接——或關係——可以使用結構化查詢語言（SQL）來查詢和操作數據。關係型數據庫高度一致、可靠，最適合處理大量結構化數據。它們設計用於業務數據處理和存儲支持公司日常運營所需的線上交易數據。非關係型數據庫，有時稱為 NoSQL 數據庫，格式結構較鬆散，不像關係型數據庫那樣使用行和列的表格格式。相反，非關係型數據庫遵循靈活的數據模型，這使得它們非常適合存儲經常更改其組織的數據，或處理各種數據類型的應用程序。這包括需要組織大量複雜和多樣化數據的情況，或者數據定期演變以滿足新的業務需求的情況。選擇正確的數據庫取決於用例。Google Cloud 關係型數據庫產品包括 Cloud SQL 和 Spanner，而 Bigtable 是一款非關係型數據庫產品。我們稍後將詳細介紹這些產品。讓我們探討另一個數據管理概念：數據倉庫。與數據庫一樣，數據倉庫也是存儲數據的地方。但是，數據庫旨在捕獲數據以進行存儲、檢索和使用，而數據倉庫旨在分析數據。數據倉庫是一個企業系統，用於分析和報告來自多個來源的結構化和半結構化數據。可以將數據倉庫視為所有業務數據的中心樞紐。業務數據可能包括銷售點交易、營銷自動化甚至客戶關係管理數據。數據倉庫適用於即席分析和自定義報告，可以幫助分析銷售並識別趨勢，因為它可以將當前數據和歷史數據存儲在一個地方。此功能可以提供一段時間內數據的長期視圖，這使得數據倉庫成為商業智能的主要組成部分。BigQuery 是 Google Cloud 的數據倉庫產品。我們稍後將詳細介紹 BigQuery。儘管數據倉庫處理結構化和半結構化數據，但它們通常不是處理大量可用非結構化數據（如圖像、視頻和文檔）的方法。非結構化數據不符合定義良好的模式，在傳統分析中通常被忽略。數據湖是一個存儲庫，設計用於攝取、存儲、探索、處理和分析任何類型或任何數量的原始數據，而不管其來源如何，例如操作系統、網絡來源、社交媒體或物聯網 (IoT)。它可以以原始格式存儲不同類型的數據；忽略大小限制，並且幾乎不需要預處理或添加結構。擁有可供分析的未經處理的原始數據可以防止無意中污染數據或增加偏差。這也意味著可以通過同時將原始數據與其他數據合併來豐富原始數據。這與包含已清理和處理的結構化數據的數據倉庫不同，數據倉庫已準備好根據預定義的業務需求進行戰略分析。數據湖通常包含許多不同的產品，具體取決於所攝取數據的性質。例如，用於存儲結構化數據的最佳 Google Cloud 產品是 Cloud SQL、Spanner 或 BigQuery。對於半結構化數據，選項包括 Datastore 和 Bigtable。對於存儲非結構化數據，Cloud Storage 是一個選項。數據倉庫和數據湖應被視為互補的工具，而不是競爭工具。儘管兩者都以某種方式存儲數據，但每個都針對不同的用途進行了優化。傳統的數據倉庫用戶是更接近業務並專注於從數據中獲取洞察力的商業智能分析師。這些用戶傳統上使用數據來回答問題。數據湖用戶和分析師包括數據工程師和數據科學家。他們更接近原始數據，擁有探索、挖掘和實驗數據的工具和能力。這些用戶在數據中找到答案，但也找到問題。隨著企業越來越關注數據驅動的決策，數據倉庫和數據湖在組織的數字轉型之旅中發揮著關鍵作用。數據民主化使用戶可以更深入地了解業務狀況，因為他們擁有的上下文比以往任何時候都多。如今，組織需要對其業務進行 360 度的實時查看，以獲得競爭優勢。


##### 摘要

*   企業需現代化方法管理海量數據。
*   數據庫：關係型數據庫處理結構化數據，非關係型數據庫處理非結構化數據。
*   數據倉庫：分析來自多個來源的結構化和半結構化數據，支援商業智能。
*   數據湖：儲存和分析任何類型和規模的原始數據，包含結構化、半結構化和非結構化數據。
*   數據倉庫和數據湖互補，滿足不同分析需求。
*   數據民主化提升數據驅動決策。
...
> 企業比以往任何時候都更容易取得數據。這包括內部資訊（稱為第一方數據）和外部資訊（通常是關於客戶和行業的數據，通常稱為第二方或第三方數據）。隨著企業數位化營運，許多類型的業務數據都已可用，其中包括關於其客戶的資訊。第一方數據是企業從客戶或受眾交易和互動中收集的專有客戶數據集。這些數據集可能包括關於數位互動的資訊，例如使用者在網頁上停留的時間長度。第二方數據通常描述來自另一家組織（例如合作夥伴或其供應鏈中的其他企業）的第一方數據，可以輕鬆部署以增強公司的內部數據集。該組織並不直接擁有這些數據，但這些數據與其業務相關。最後，還有第三方數據，這些數據集是由不直接與組織的客戶或業務互動的組織收集和管理的。這些數據集可能來自政府、非營利組織或學術機構，例如天氣或公共人口統計數據，或來自特定行業的來源，例如分析師報告或行業基準測試。第三方數據通常在數據市場或交易所（例如 Google Cloud Marketplace）上共享或購買。使用外部數據可以通過提供新的背景和見解來大大提高數據的價值。讓我們探討一個航空公司如何通過數據轉型其業務的例子。廉價航空公司不提供食物作為其服務的一部分。相反，如果他們想要，他們會向客戶收取餐費。這個解決方案似乎具有成本效益，但很難估計機上所需的餐食數量。如果航空公司高估了所需的餐食數量，他們可能會浪費食物並損失收入。但如果他們低估了，他們可能會賣完食物；提供糟糕的客戶服務並損失潛在收入。一家亞洲廉價航空公司重新構想了他們如何利用數據解決這個問題。他們首先確定了有助於估計庫存的因素，例如飛機的大小和乘客的數量。但他們很快發現，基於這些因素的估計是不準確的。這意味著必須以不同的方式思考他們的數據，方法是分析諸如目的地、飛行時間以及每次旅程之前和之後的航班連接等資訊。利用這些資訊，他們發現了可行的見解。例如，他們了解到往返印度的航班需要多 73% 的素食餐點。憑藉這些新的見解，該航空公司能夠更準確地預測所需的餐食數量，這反過來又提供了更積極的客戶體驗並提高了其食品服務的盈利能力。這只是一個雲技術如何通過重新構想數據來釋放新價值的例子。無論您在公司中擔任什麼職位，您都可以利用數據來解決挑戰。


##### 摘要

*   企業取得內外部數據日益容易，包括第一方數據（內部資訊）及第二、第三方數據（客戶及產業資訊）。
*   第一方數據為企業從客戶互動收集之專有數據，例如網頁停留時間。
*   第二方數據為其他組織（如合作夥伴）的第一方數據，可增強企業內部數據。
*   第三方數據由非直接互動客戶的組織收集，例如政府或學術數據，常於數據市場購買。
*   善用外部數據能提供新的見解，提升數據價值。
*   廉價航空公司案例：透過分析目的地、飛行時間等數據，更準確預測餐點需求，提升客戶滿意度及獲利。
...
> 資料處理必須置於更廣泛的資料價值鏈脈絡中思考。想像一下資料像工廠裡的汽車一樣，沿著組裝線移動。組裝線逐步為沿線移動的物件添加零件和價值。起初的原始資料最終將轉化為人類或機器採取的行動。讓我們檢視這個資料價值鏈中的步驟。資料產生是資料單元的初始建立；這可能是網站上的點擊、刷卡、物聯網裝置的感測器記錄，或無數其他例子。這是最終將轉化為可供行動的洞察力的原材料。資料收集透過擷取將初始資料單元帶到組裝線上。擷取的基本功能是從其託管的系統中提取資料並將其帶到新的系統。根據給定分析所需的原始資料的數量、速度和種類，以及需要多快分析資料，它可能會有截然不同的需求。資料處理是將收集到的原始資料轉換成可以从中得出洞察力的形式。資料可能需要調整，例如，將不同的資料集合併在一起。它可以是一個單階段的操作，也可以是一個複雜的級聯程序樹。在我們的製造流程類比中，此階段是原材料形成製造產品預組裝零件的階段。資料儲存是資料存放、可以找到且準備好進行分析和採取行動的地方。與現實世界的製造一樣，儲存選項會根據處理的產品類型而有所不同，不同類型的資料可以用不同的方式儲存。例如，NoSQL 可用於快速讀寫，資料倉儲可用於快速存取分析，而物件儲存可用於非結構化資料。這些標準儲存庫也有自訂選項。資料分析為商業導向的行動提供方向。繼續我們的製造線類比，在此階段，資料處理階段的輸入被組裝成最終產品。最後，資料價值鏈的最後一步是資料啟動。當產生分析時，需要將其推送到相關的業務程序和決策者，以便採取行動並完成價值鏈。最常見的啟動點是做出自動化決定的應用程式和引導人類做出更好、更明智決定的商業智慧儀表板。在我們的製造線範例中，這是將完全生產的產品投入預期用途的步驟。組裝資料價值鏈並非只有一種方法，就像建立現實世界的製造線並非只有一種方法一樣。同樣地，隨著技術的進步、新的輸入變得可用、您的員工隊伍發展或所需的輸出發生變化，最佳價值鏈也會發生變化。然而，其核心價值鏈原則仍然有效。我們希望使用原始資料來執行有益於業務的行動。


##### 摘要

* 資料產生：資料單元初始建立 (例如：網站點擊、刷卡、感測器記錄)。
* 資料收集：透過擷取將資料帶入系統。
* 資料處理：將原始資料轉換為可分析的形式 (例如：資料合併)。
* 資料儲存：資料存放、可搜尋及準備分析的地點 (例如：NoSQL, 資料倉儲, 物件儲存)。
* 資料分析：提供商業決策方向。
* 資料啟動：將分析結果推送到相關業務程序及決策者，促成行動。
...
> 近十年來，數據產量呈指數級增長，雲端技術降低了數據收集、儲存和分析的成本。組織機構如今面臨著在確保數據安全和防止未經授權使用的同時，將數據民主化並嵌入每個決策的挑戰。有效的數據治理計劃可以幫助實施數據指令以實現此目標。但數據治理究竟是什麼？數據治理意味著設定內部標準——數據策略——這些標準適用於數據的收集、儲存、處理和處置方式。它管理著誰可以訪問某些數據以及哪些數據受到治理。它還涉及遵守行業協會、政府機構和其他利益相關者制定的外部標準。數據治理側重於在數據的整個生命週期中，以利益相關者可以輕鬆訪問和使用的形式，以通過洞察力和分析產生所需業務成果的方式，以及如果相關，以符合監管標準和合規需求的方式，向所有利益相關者提供數據。數據治理帶來多項好處。它使數據更有價值。數據治理實施流程以確保數據質量高，並提供一個平台，使與組織內部的利益相關者安全共享數據更容易。它有助於用戶做出更好、更及時的決策。通過數據治理，整個組織的用戶都可以獲得他們所需數據，以接觸和服務客戶、設計和改進產品和服務以及抓住新的收入機會。通過數據民主化，組織可以將數據嵌入所有決策中。它改進了成本控制。數據幫助組織管理資源並更有效地運作。因為他們可以消除由信息孤島造成的數據重複，所以他們不會過度購買——並且必須維護——昂貴的硬件。它增強了監管合規性。日益複雜的監管環境使得組織建立嚴格的數據治理實務變得更加重要。他們避免了與不合規相關的風險，並主動預料新的法規。它有助於贏得客戶和供應商的更大信任。通過符合內部和外部數據策略的審計合規性，組織贏得了客戶和合作夥伴的信任。它有助於管理風險。通過強大的數據治理，組織可以減少對敏感數據洩露給缺乏適當授權的個人或系統、來自惡意外部人士甚至訪問他們無權查看的數據的內部人士的安全漏洞的擔憂。它允許更多人員訪問更多數據。強大的數據治理提供了信心，即正確的人員可以訪問正確的數據，並且這種數據民主化不會對組織產生負面影響。缺乏有效數據治理計劃的組織可能會遭受合規違規。這可能導致罰款、數據質量差——產生較低的質量洞察力，從而影響業務決策、查找數據方面的挑戰——導致分析延遲和錯失業務機會，以及為 AI 訓練不足的數據模型——降低模型準確性和使用 AI 的好處。每個組織都需要數據治理。隨著所有行業的企業在其數字轉型旅程中取得進展，數據已迅速成為他們擁有的最有價值的資產。


##### 摘要

*   數據產量指數級增長，雲端技術降低成本，但數據安全和民主化成挑戰。
*   數據治理設定數據收集、儲存、處理和處置的內部標準，並遵守外部標準。
*   優點：提升數據價值、決策效率、成本控制、合規性，增強客戶信任，降低風險，擴大數據訪問範圍。
*   缺乏數據治理的後果：合規違規、數據質量差、查找數據困難、AI 模型訓練不足。
*   數據已成為企業最有價值資產，所有組織都需要數據治理。

#### Quiz

- https://www.cloudskillsboost.google/paths/9/course_templates/267/quizzes/512691
...
> 數據在組織營運中扮演著不可或缺的角色。因此，有效地儲存和管理數據至關重要。Google Cloud 提供廣泛的數據管理產品和解決方案，每種方案都適用於不同的業務用例。在本課程章節中，您將探討：Google Cloud 數據管理選項及其差異；Cloud Storage 提供的不同儲存類型；如何選擇符合組織需求的正確儲存產品；以及組織如何在雲端遷移和／或現代化其目前的數據庫。


##### 摘要

* Google Cloud 數據管理選項及其差異
* Cloud Storage 各儲存類型的比較
* 選擇符合組織需求之儲存產品的方法
* 雲端數據庫遷移及現代化方案
...
> 每個應用程式都需要儲存數據，例如串流媒體或裝置感測器數據，不同的應用程式和工作負載需要不同的儲存解決方案。Google Cloud 提供多種核心儲存產品，包括 Cloud Storage、Cloud SQL、Spanner、BigQuery、Firestore 和 Bigtable。根據您的用例，您可能會使用其中一項或多項服務來完成工作。讓我們從 Cloud Storage 開始，這項服務為開發人員和 IT 組織提供持久且高可用性的物件儲存。但什麼是物件儲存？物件儲存是一種計算機數據儲存架構，它將數據作為「物件」而不是檔案儲存（檔案和資料夾層次結構）或區塊儲存（磁碟的數據塊）來管理。這些物件以封裝格式儲存，其中包含實際數據的二進制形式以及相關的關聯式中繼數據（例如建立日期、作者、資源類型和權限）以及全局唯一的識別碼。這些唯一的鍵採用 URL 的形式，這意味著物件儲存可以很好地與 Web 技術互動。通常儲存為物件的數據包括視頻、圖片和音頻錄音。此類數據稱為非結構化數據，這意味著它沒有預定義的數據模型，或者沒有以預定義的方式組織，就像您在結構化數據庫格式中找到的那樣。Cloud Storage 允許客戶儲存任何數量的數據並根據需要頻繁地檢索數據。這是一項完全託管的可擴展服務，具有多種用途，例如提供網站內容、儲存用於歸檔和災難恢復的數據以及通過直接下載將大型數據物件分發給最終用戶。Cloud Storage 有四個主要的儲存類別。第一個是標準儲存。標準儲存被認為最適合頻繁訪問或「熱」數據。它也適用於僅儲存短期數據。第二個儲存類別是近線儲存。此選項最適合儲存不經常訪問的數據，例如平均每月或更少讀取或修改數據一次。示例可能包括數據備份、長尾多媒體內容或數據歸檔。第三個儲存類別是冷線儲存。這也是一種低成本選項，用於儲存不經常訪問的數據。但是，與近線儲存相比，冷線儲存最多每 90 天讀取或修改數據一次。第四個儲存類別是歸檔儲存。這是最低成本的選項，理想用於數據歸檔、線上備份和災難恢復。對於您計劃每年訪問少於一次的數據，這是最佳選擇，因為它對數據訪問和操作的成本更高，並且最短儲存期限為 365 天。雖然這四個類別各有不同，但值得注意的是，所有這些儲存類別都有一些共同的特徵，包括：無限制的儲存，沒有最小的物件大小要求；全球可訪問性和位置；低延遲和高耐用性；一致的體驗（延伸到安全性、工具和 API）；如果數據儲存在多個區域或雙區域中，則具有地理冗餘。這意味著將物理伺服器放置在地理位置分散的數據中心，以防止災難性事件和自然災害，並為最佳性能負載平衡流量。Cloud Storage 還提供名為 Autoclass 的功能，該功能可根據每個物件的訪問模式自動將物件轉換到適當的儲存類別。此功能將未訪問的數據移動到較冷的儲存類別以降低儲存成本，並將已訪問的數據移動到標準儲存以優化未來的訪問。Autoclass 簡化並自動化了 Cloud Storage 數據的成本節省。


##### 摘要

*   Google Cloud 提供多種儲存方案以滿足不同應用程式的需求。
*   Cloud Storage 提供持久且高可用的物件儲存服務。
*   物件儲存將數據作為物件管理，而非檔案或區塊。
*   Cloud Storage 提供標準、近線、冷線和歸檔四種儲存類別，各有不同的存取頻率和成本。
*   所有儲存類別均具備無限儲存空間、全球可訪問性、低延遲、高耐用性及地理冗餘等特性。
*   Autoclass 功能可自動根據存取模式調整儲存類別，以降低成本並優化效能。
...
> 上課內容已介紹雲端儲存空間如何儲存非結構化數據，現在讓我們來探討一些適用於儲存結構化數據的 Google Cloud 數據儲存產品。結構化數據由以預定義格式組織的數字和值組成，可在關聯式數據庫中輕鬆搜尋。課程前面提到，關聯式數據庫將資訊儲存在具有明確定義架構的表格、列和欄中，該架構代表數據庫的結構或邏輯配置。Cloud SQL 提供完全託管的關聯式數據庫，包括 MySQL、PostgreSQL 和 SQL Server 作為服務。其設計目的是將單調但必要的且通常耗時的任務轉移給 Google，例如應用程式修補程式和更新、管理備份和配置複製，讓您可以專注於構建出色的應用程式。全球數千家大型企業都信賴 Cloud SQL，使用 Cloud SQL 的組織可以獲得各種好處。它不需要任何軟體安裝或維護。它支援託管備份，因此備份的數據可以安全地儲存，如果需要還原，則可以訪問。它在 Google 的內部網路以及儲存在數據庫表格、臨時檔案和備份中的數據都會進行加密。並且它包含一個網路防火牆，用於控制對每個數據庫實例的網路訪問。Spanner 是一種完全託管的、關鍵任務的關聯式數據庫服務，可以水平擴展以處理意外的業務高峰。Spanner 經 Google 自身的關鍵任務應用程式和服務的考驗，是支援 Google 數十億美元業務的服務。Spanner 特別適用於需要具有聯接和輔助索引的 SQL 關聯式數據庫管理系統、內建高可用性（提供數據冗餘以減少區域或實例不可用時的停機時間，目標是防止單點故障）、強一致性（確保所有儲存數據的位置都能快速更新到最新的數據版本）和高輸入/輸出操作每秒 (每秒數萬次讀寫或更多) 的應用程式。Cloud SQL 和 Spanner 都是完全託管的數據庫服務，但它們有什麼區別呢？Cloud SQL 是一種適用於 MySQL、PostgreSQL 和 SQL Server 的完全託管的關聯式數據庫服務，可用性超過 99.95%。數據庫遷移服務 (DMS) 可讓您輕鬆地將生產數據庫遷移到 Cloud SQL，同時最大限度地減少停機時間。然後是 Spanner，它是一個完全託管的關聯式數據庫，具有無限擴展性、強一致性和高達 99.999% 的可用性，且計劃維護和架構更改均無停機時間。這個全球分佈式、符合 ACID 的雲端數據庫會自動處理複本、分片和交易處理，因此您可以快速擴展以滿足任何使用模式，並確保產品的成功。在考慮哪個選項最適合您的業務時，請考慮以下情況：如果您已超出任何關聯式數據庫的容量、正在為高吞吐量效能而對數據庫進行分片、需要交易一致性、全球數據和強一致性，或者只是想整合數據庫，請考慮使用 Spanner。如果您不需要水平擴展或全球可用的系統，Cloud SQL 是一個經濟高效的解決方案。我們將探討的最後一個結構化數據儲存解決方案是 BigQuery。BigQuery 是一個完全託管的數據倉庫。正如我們已經了解到的，數據倉庫是一個大型儲存庫，其中包含從組織內部各種來源收集的 PB 級數據，用於指導管理決策。由於它是完全託管的，因此 BigQuery 會處理底層基礎架構，因此用戶可以專注於使用 SQL 查詢來解答業務問題，而無需擔心部署、可擴展性和安全性。BigQuery 一體提供兩種服務：儲存和分析。它是一個儲存 PB 級數據的地方。作為參考，1 PB 等於 11,000 部 4k 品質的電影。BigQuery 也是分析數據的地方，具有內建功能，例如機器學習、地理空間分析和商業智慧。BigQuery 中的數據在靜止狀態下默認加密，無需用戶執行任何操作。靜態加密是用於保護儲存在磁碟（包括固態硬碟）或備份媒體上的數據的加密。BigQuery 提供與現有合作夥伴生態系統的無縫整合。企業可以利用我們的系統整合商和數據整合合作夥伴生態系統來幫助增強分析和報告。這些整合意味著 BigQuery 可以讓組織充分利用其在商業智慧、數據導入和數據整合工具方面的既有投資。行業研究表明，90% 的組織都採用多雲策略，這增加了數據整合、協調和治理的複雜性。BigQuery 在多雲環境中工作，允許數據團隊通過使用 BigQuery 安全且經濟高效地在多個雲提供商中分析數據來消除數據孤島。BigQuery 還具有內建的機器學習功能，因此可以使用 SQL 直接在 BigQuery 中編寫 ML 模型。如果使用其他專業工具（例如 Google Cloud 的 Vertex AI）來訓練 ML 模型，則可以將數據集直接從 BigQuery 匯出到 Vertex AI，從而實現數據到 AI 生命週期的無縫整合。


##### 摘要

* **Cloud SQL:** 完全託管的關聯式數據庫服務 (MySQL, PostgreSQL, SQL Server)，可用性高，易於遷移，成本效益高，適合不需要水平擴展或全球可用性的應用。
* **Spanner:** 完全託管的、關鍵任務的關聯式數據庫服務，無限擴展性，強一致性，高可用性 (99.999%)，適合需要高吞吐量、全球數據和強一致性的應用。
* **BigQuery:** 完全託管的數據倉庫，提供 PB 級數據儲存和分析能力，整合機器學習、地理空間分析和商業智慧功能，支援多雲環境。
...
> 半結構化數據兼具結構化和非結構化數據的元素。它具有一些定義或一致的特性，但通常不像關聯式數據庫那樣遵循嚴格的結構。半結構化數據更容易組織，因為它通常包含一些組織屬性，例如標籤或元數據。電子郵件訊息就是半結構化數據的一個例子。雖然電子郵件的實際內容是非結構化的，但它確實包含結構化數據，例如發件人和收件人的姓名和電子郵件地址、發送時間等等。Google Cloud 提供兩種半結構化數據存儲產品，Firestore 和 Bigtable。Firestore 是一個靈活、可水平擴展的 NoSQL 雲數據庫，用於實時存儲和同步數據。Firestore 可以被移動和 Web 應用程序直接訪問。Firestore 以文檔的形式存儲數據，文檔存儲在集合中。文檔支持各種數據類型，例如嵌套對象、數字和字符串。Firestore 的主要功能之一是自動縮放。它被設計為根據用戶需求自動縮放，但無論數據庫大小如何，都能保持相同的性能水平。Firestore 還通過用戶設備上的綜合數據庫提供離線使用。離線數據訪問確保應用程序即使在用戶斷開互聯網連接的情況下也能不間斷運行。然後是 Bigtable，Google 的 NoSQL 大數據數據庫服務。它是支持許多核心 Google 服務（包括搜索、分析、地圖和 Gmail）的同一數據庫。Bigtable 旨在以一致的低延遲處理大型工作負載，這意味著 Bigtable 對請求的響應速度很快，並且吞吐量很高，這意味著它可以發送和接收大量數據。因此，它是運營和分析應用程序（包括物聯網、用戶分析和金融數據分析）的絕佳選擇。在決定存儲選項時，如果您處理的半結構化或結構化數據超過 1 TB、數據快速且吞吐量高、數據變化迅速、您正在處理 NoSQL 數據、數據是時間序列或具有自然順序、您正在處理大數據並對數據運行批處理或實時處理，或者您正在對數據運行機器學習算法，則您可以選擇 Bigtable。


##### 摘要

* 半結構化數據混合結構化與非結構化數據特性，具有一定組織性。
* 例如：電子郵件（內容非結構化，但郵件標頭結構化）。
* Google Cloud 提供 Firestore 和 Bigtable 兩種半結構化數據儲存方案。
* Firestore：NoSQL 雲端數據庫，支援實時數據同步，自動擴展，提供離線存取功能。
* Bigtable：NoSQL 大數據數據庫，適用於高吞吐量、低延遲的大型工作負載，例如物聯網數據分析。
* 選擇 Bigtable 情境：數據量超過 1TB、高吞吐量、快速變動數據、NoSQL 數據、時間序列數據、大數據批次或即時處理、機器學習數據分析。
...
> 因此，您已經了解 Google Cloud 提供的不同儲存選項，但在哪些情況下應該使用每個選項呢？最終，這取決於需要儲存的資料類型和業務需求。如果資料是非結構化的，那麼 Cloud Storage 是最合適的選項。您必須決定儲存類別：標準、近線、冷線或歸檔。或者是否讓自動分類功能為您決定。如果資料是結構化或半結構化的，則選擇儲存產品將取決於工作負載是交易型的還是分析型的。交易型工作負載來自線上交易處理 (OLTP) 系統，當需要快速插入和更新資料以建立基於行的記錄時使用此系統。例如，銷售點交易記錄。然後是分析型工作負載，它來自線上分析處理 (OLAP) 系統，當需要讀取整個資料集時使用此系統。它們通常需要複雜的查詢，例如聚合。此處的示例包括分析銷售歷史記錄以查看趨勢和聚合視圖。確定工作負載是交易型還是分析型之後，您必須確定是否將使用 SQL 訪問資料。因此，如果您的資料是交易型的，並且您需要使用 SQL 訪問它，則 Cloud SQL 和 Spanner 是兩個選項。Cloud SQL 最適合區域性擴展，而 Spanner 最適合在全球範圍內擴展資料庫。如果將使用非 SQL 訪問交易型資料，則 Firestore 可能是最佳選項。Firestore 是一個交易型 NoSQL 文件導向資料庫。如果您有需要 SQL 命令的分析型工作負載，則 BigQuery 可能是最佳選項。BigQuery 是 Google 的資料倉庫解決方案，讓您可以分析 PB 級的資料集。或者，Bigtable 為分析型工作負載提供可擴展的 NoSQL 解決方案。它最適合需要毫秒級延遲的即時高吞吐量應用程式。


##### 摘要

* **非結構化資料：** 使用 Cloud Storage，並選擇標準、近線、冷線或歸檔儲存類別，或使用自動分類功能。
* **結構化或半結構化資料：**
    * **交易型工作負載 (OLTP)：**
        * 使用 SQL：選擇 Cloud SQL (區域性擴展) 或 Spanner (全球擴展)。
        * 不使用 SQL：選擇 Firestore (NoSQL 文件導向資料庫)。
    * **分析型工作負載 (OLAP)：**
        * 使用 SQL：選擇 BigQuery (PB 級資料分析)。
        * 不使用 SQL：選擇 Bigtable (高吞吐量、低延遲)。
...
> 在舊式本地資料庫上運行現代應用程式，需要克服延遲、吞吐量、可用性和擴展性等昂貴且耗時的挑戰。透過資料庫現代化，組織可以相對輕鬆地將資料從傳統資料庫遷移到完全託管的或現代資料庫。組織有多種方法可以在雲端遷移或現代化其目前的資料庫。最直接的方法是「直接遷移」平台遷移。此方法將資料庫從本地和私有雲環境遷移到公共雲供應商（例如 Google Cloud）託管的相同類型資料庫。儘管此解決方案使資料庫更難以現代化，但它確實帶來了最小程度的變革以及由雲端供應商管理資料和基礎架構的好處。或者，託管資料庫遷移允許將資料庫從 SQL Server、MySQL、PostgreSQL 等遷移到完全託管的 Google Cloud 資料庫。儘管此遷移需要仔細規劃，並且可能會造成輕微的變革，但完全託管的解決方案讓您可以專注於真正為您的組織增加價值的更高優先級的工作。Google Cloud 的資料庫遷移服務 (DMS) 可以輕鬆地將您的資料庫遷移到 Google Cloud，或者可以使用 Datastream 來同步跨資料庫、儲存系統和應用的資料。讓我們來看一個真實的案例。線上零售商 Wayfair 擁有 18 個履行中心、38 個配送中心和超過 2200 萬項商品的目錄，需要一種方法可以快速地從其在 SQL Server 上運行的本地資料中心遷移到 Google Cloud。這必須在不影響其 3000 多名工程師團隊、數千萬客戶或 16000 家供應商夥伴的情況下完成。因此，目標是以最少的變更儘快直接遷移其工作負載，然後使用雲端資料庫來現代化這些工作負載。Wayfair 選擇 Google Cloud 是因為它透過使用 Cloud SQL for SQL Server 提供了將工作負載遷移到雲端的清晰路徑。Google Cloud 提供了靈活性，可以仔細考慮未來運行 Wayfair 系統的引擎和產品。他們喜歡如何在虛擬機器 (VM) 上運行 SQL Server，例如，但也可以從 Cloud SQL 和 Spanner 等資料庫產品中受益。遷移完成後，他們還使用 Google Kubernetes Engine (GKE) 和 Compute Engine 虛擬機器來託管 Google Cloud 團隊構建的服務。他們還使用 Pub/Sub 和 Dataflow 將作業資料發送到 BigQuery 中的分析儲存區。


##### 摘要

*   舊式本地資料庫的挑戰：高延遲、低吞吐量、可用性差和擴展性難。
*   資料庫現代化方案：將資料從傳統資料庫遷移到雲端完全託管或現代資料庫。
*   遷移方法：
    *   直接遷移：將資料庫遷移到相同類型的雲端資料庫，變革最小，但現代化較難。
    *   託管資料庫遷移：遷移到完全託管的雲端資料庫，需仔細規劃，但可專注於高價值工作。
*   Google Cloud 工具：Database Migration Service (DMS) 和 Datastream。
*   Wayfair 案例：成功將 SQL Server 工作負載從本地遷移到 Google Cloud，並利用 Cloud SQL、Spanner、GKE、Compute Engine、Pub/Sub 和 Dataflow 等服務。


#### Quiz

- https://www.cloudskillsboost.google/paths/9/course_templates/267/quizzes/512698
...
> 企業並非總能輕易根據收集或產生的數據做出明智的商業決策。而且，阻礙數據分析的因素常常影響部分或全部員工。有了 Google Cloud，情況就不一樣了。在本課程的最後一個模組中，您將探討：Looker 如何讓員工輕鬆獲取所需數據；即時串流分析如何提升數據效用；以及現代化數據管道的兩個 Google Cloud 產品：Pub/Sub 和 Dataflow。
...
* Looker：簡化員工數據訪問。
* 即時串流分析：提升數據效用。
* Google Cloud 產品：Pub/Sub 和 Dataflow 現代化數據管道。
...
> 資料庫中的數據可能仍需要大量的努力和專業知識才能發現其洞見。商業智能解決方案可以實現此目標。然而，組織常常面臨的挑戰是識別正確的商業智能解決方案。有些解決方案過於複雜，數據工程或數據分析團隊以外的人員無法使用。這意味著其他團隊必須提出請求並等待答案，這與獲得即時洞察的目標背道而馳。其他解決方案允許業務中的每個人執行自己的數據分析，但他們只能使用部分可用數據執行分析。這意味著只有少數人，或者可能沒有人，能夠全面了解組織的業務數據。Looker 是一個 Google Cloud 商業智能 (BI) 平台，旨在幫助個人和團隊分析、可視化和共享數據。這包括創建易於理解和共享的互動式儀表板和報告。通過擁有可靠的業務數據權威來源，團隊中的任何人都可以探索數據、提出和回答他們自己的問題，並創建可視化效果。這種方法使組織不僅能夠發現洞察，還能據此採取行動。Looker 支持 BigQuery，以及 60 多個不同的 SQL 數據庫。BigQuery 和 Looker 共同提供豐富的互動式儀表板和報告，而不會影響性能、規模、安全性或數據新鮮度。Looker 也是 100% 基於網絡的，這使得它易於集成到現有工作流程中，並與組織中的多個團隊共享。那麼 Looker 如何使用呢？讓我們探討一個例子。鑽石度假村是全球領先的酒店業公司，提供目的地、活動和體驗，以幫助人們恢復活力、聯繫和享受。他們之前使用複雜的 Excel 工作簿和遺留 BI 工具的混合體來追蹤重要指標。每個業務部門都各自運營和管理自己的數據計劃。結果，出現了以下情況：沒有關於業務的共同觀點或單一權威的共同指標；冗餘的數據工程工作，因為工作從未在組織內共享或使用；以及不一致的項目優先順序，因為決策主要基於直覺而不是實際數據。此外，基礎設施不符合業務需求，具體表現在：執行報告工作需要數月才能完成；數據在多個業務部門之間重複，沒有適當的治理；整個業務中有多個報告工具和數據倉庫；以及基礎設施不支持高級分析願望。鑽石度假村希望創建一個單一的、基於雲的、完全託管的通用架構；建立數據治理並使業務更具數據驅動性，同時為高級分析工作奠定基礎。他們遷移到雲端並開始使用 Looker 來提高業務敏捷性。這一決定使他們在不到 3 個月的時間內獲得了即時洞察。它幫助他們應對 COVID 變革，使用重要的運營指標（例如每日預訂和取消），同時還提供了 360 度的客戶觀點。此外，收益管理團隊的手工報告每天減少了數小時。首席信息官表示：「我們預計未來幾年才能完成的項目，突然可以在幾週內完成。」這只是一個例子，說明有效的商業智能解決方案如何讓企業轉型以更好地服務其客戶。
...
*   商業智能方案能有效提升數據洞察。
*   部分方案複雜度高，限制使用者。
*   部分方案數據選擇有限，難以全面掌握組織數據。
*   Looker提供互動式數據分析及視覺化工具，方便數據共享。
*   Looker支援多種數據庫，確保數據可靠性及即時性。
*   Looker基於網頁，方便整合及團隊協作。
*   鑽石度假村案例顯示Looker有效提升數據分析效率及決策速度。
*   Looker協助鑽石度假村克服疫情挑戰，並大幅減少手動報告時間。
*   Looker成功實現數據治理，提升業務敏捷性。
...
> 傳統上，數據是以批次方式移動。批次處理通常同時處理大量數據，但延遲時間較長。例如，薪資和帳單系統必須每週或每月處理一次。雖然這種方法可以有效處理大量數據，但它不適用於需要即時串流的時效性數據，因為數據在處理完成前可能已過時。串流分析是持續不斷地處理和分析數據記錄，而不是以批次方式處理。一般而言，串流分析適用於以小規模（通常以千位元組為單位）持續不斷地發送數據的數據來源類型，數據會在產生的同時傳送。這使得能夠在事件發生的同時進行分析和報告。串流數據的來源包括設備感測器、點擊串流、社群媒體資訊、股市報價、應用程式活動等等。公司使用串流分析即時分析數據，並深入了解各種活動，例如計量、伺服器活動、設備地理位置或網站點擊。用例包括：電子商務：可以分析用戶點擊串流，以透過即時定價、促銷和庫存管理來優化購物體驗。金融服務：可以分析帳戶活動，以偵測數據串流中的異常行為並產生安全警報。投資服務：可以追蹤市場變化，並根據設定的約束條件（例如，當特定股票價值達到時出售）調整客戶投資組合的設定。新聞媒體：可以從各種新聞來源平台串流用戶點擊記錄，然後可以使用人口統計資訊豐富數據，以更好地提供與目標受眾相關的文章。公用事業：可以監控跨電力網路的吞吐量，并在達到既定閾值時產生警報或啟動工作流程。Google Cloud 提供兩種主要的串流分析產品，可以即時擷取、處理和分析事件串流，從數據產生的那一刻起，使數據更有用且更易於存取。Pub/Sub 每秒可擷取數億個事件，但 Dataflow 則整合了串流和批次數據分析，並建立了具有凝聚力的數據管道。數據管道代表一系列動作或階段，這些動作或階段會從不同的來源擷取原始數據，然後將數據移動到目的地以進行儲存和分析。您將在下一節中更詳細地探討這些產品。


##### 摘要

* 傳統數據處理採批次模式，處理時間長，延遲高，不適用於即時數據。
* 串流分析則持續處理數據，即時分析數據，適用於設備感測器、點擊串流等數據源。
* 串流分析應用案例涵蓋電商、金融、投資、新聞媒體和公用事業等領域。
* Google Cloud 提供 Pub/Sub 和 Dataflow 兩項串流分析產品，分別負責數據擷取和數據管道整合。
* 數據管道包含一系列步驟，負責數據擷取、處理、儲存和分析。
...
> 資料管道早期階段之一是資料導入，在此階段會接收大量串流資料。然而，資料可能並非總是來自單一結構化資料庫。相反地，資料可能來自數千甚至數百萬個完全非同步發生的事件。一個常見的例子是來自物聯網 (IoT) 應用程式的資料。這可能包括每 30 秒發送位置資料的計程車感測器，或資料中心周圍的溫度感測器，以協助優化冷暖氣。Pub/Sub 是一種分散式訊息服務，可以接收來自各種裝置串流的訊息，例如遊戲事件、物聯網裝置和應用程式串流。名稱縮寫為發佈者/訂閱者，或將訊息發佈給訂閱者。在從串流輸入來源擷取訊息後，您需要一種方法將資料導入資料倉庫以進行分析。這就是 Dataflow 的用武之地。Dataflow 建立一個管道來處理串流資料和批次資料。「處理」在此指的是提取、轉換和載入資料的步驟，有時稱為 ETL。Apache Beam 是管道設計的熱門解決方案。它是一個開放原始碼、統一的程式設計模型，用於定義和執行資料處理管道，包括 ETL、批次和串流處理。Dataflow 處理大部分基礎架構設定和維護的複雜性，並建置於 Google 的基礎架構之上。此產品允許可靠的自動擴展以滿足資料管道需求。Dataflow 是無伺服器且完全受管理的。無伺服器運算意味著軟體開發人員可以建置和執行應用程式，而無需佈建或管理後端基礎架構。例如，Google Cloud 代表使用者管理基礎架構任務，例如資源佈建、效能調整和確保管道可靠性。而完全受管理的環境則是指可以在無需營運團隊的情況下部署、監控和管理軟體。您可以使用自動化工具和技術來建立此環境。使用無伺服器且完全受管理的解決方案 (例如 Dataflow) 意味著您可以花更多時間分析資料集中的洞察，而花更少時間佈建資源以確保您的管道能成功完成下一個週期。


##### 摘要

* 資料導入：接收大量來自不同來源的非同步串流資料，例如物聯網裝置。
* Pub/Sub：分散式訊息服務，接收來自各種來源的訊息。
* Dataflow：處理串流和批次資料的管道，執行 ETL (提取、轉換、載入) 流程。
* Apache Beam：開放原始碼管道設計解決方案，定義和執行資料處理管道。
* 無伺服器及完全受管理：Google Cloud 管理基礎架構，例如資源佈建和效能調整，讓開發者專注於資料分析。


#### Quiz

- https://www.cloudskillsboost.google/paths/9/course_templates/267/quizzes/512703
...
> 本課程「探索 Google Cloud 的數據轉換」到此結束。讓我們快速回顧一下。在課程的第一部分「數據的價值」中，您學習了數據如何產生商業洞察並推動決策；基本的數據管理概念，例如數據庫、數據倉庫和數據湖；組織如何利用其現有數據、收集新數據和外部數據來源來創造價值；雲端如何釋放所有類型數據（包括結構化數據和以前未開發的非結構化數據）的商業價值；關於數據價值鏈，從數據的初始創建到數據激活；以及數據治理在成功的數據旅程中所扮演的重要角色。在課程的第二部分「Google Cloud 數據管理解決方案」中，您學習了 Google Cloud 數據管理選項及其區別；關於 Cloud Storage 提供的不同存儲類別；如何選擇合適的存儲產品以滿足組織的需求；以及組織如何在雲端遷移和/或現代化其現有數據庫。最後，在課程的第三部分「使數據有用且易於訪問」中，您學習了 Looker 如何讓員工輕鬆訪問其所需的數據；實時串流分析如何使數據更有用；以及兩個使數據管道現代化的 Google Cloud 產品：Pub/Sub 和 Dataflow。現在您已經全面了解了數據轉換，請繼續學習系列中的下一門課程「利用 Google Cloud 人工智能創新」，您將學習人工智能和機器學習的基礎知識、選擇 Google Cloud AI 解決方案以及構建和使用 Google Cloud AI 解決方案。下次見！


##### 摘要

* **數據的價值:** 數據驅動決策、數據管理概念 (數據庫、數據倉庫、數據湖)、數據價值創造、雲端數據價值解鎖、數據價值鏈、數據治理。
* **Google Cloud 數據管理解決方案:** Google Cloud 數據管理選項、Cloud Storage 存儲類別、存儲產品選擇、數據庫遷移和現代化。
* **使數據有用且易於訪問:** Looker 數據訪問、實時串流分析、Pub/Sub 和 Dataflow 數據管道現代化。
...
> 人工智慧和機器學習代表資訊科技的一次重要演進，正快速改變眾多產業。隨著組織數位轉型，他們可能會發現自己擁有大量的數據。隨著時間推移，他們的數據量只會越來越大。儘管這些數據非常有價值，但收集、處理和分析它們可能非常費力。需要新的工具和方法來管理收集的數據、分析數據以獲得洞察力，然後根據這些洞察力採取行動。這些組織該怎麼辦？這就是人工智慧和機器學習發揮作用的地方。本課程；「運用 Google Cloud 人工智慧創新」，旨在幫助您探索重要的人工智慧和機器學習 (ML) 概念，並了解它們如何為您的業務創造價值，了解 Google Cloud 提供的人工智慧和機器學習解決方案，以及了解 Google Cloud 的預訓練 API、AutoML 和自訂人工智慧和機器學習產品如何幫助您轉型業務。在整個課程中，您將參加分級的知識評估。您必須通過這些評估才能獲得課程學分。讓我們開始吧。


##### 摘要

* 人工智慧與機器學習為資訊科技帶來重大革新，廣泛應用於各行各業。
* 數位轉型後的組織面臨數據量龐大、收集處理分析耗時費力的挑戰。
* 本課程介紹 Google Cloud 人工智慧和機器學習解決方案。
* 學習如何運用 Google Cloud 的預訓練 API、AutoML 及客製化 AI/ML 產品提升業務價值。
* 課程包含評估測驗，需通過方能取得學分。
...
Google擁有九款用戶超過十億的產品：Android、Google Chrome、Gmail、Google Drive、Google Maps、Google 搜尋、Google Play 商店、YouTube 和 Google 相簿。這些產品都整合了人工智慧和機器學習技術，以提升用戶體驗的效率和生產力。這包括照片搜尋、YouTube 影片推薦、Gmail智慧撰寫和 Google Maps 交通預測等功能。Google持續創新，推出搭載新技術（例如生成式AI，可以為您創作內容）的產品。在考慮AI和ML如何為您的業務帶來益處時，了解基礎知識非常重要。在本課程單元中，您將探討人工智慧與機器學習的區別、機器學習與數據分析和商業智慧的差異、AI解決方案適用於解決的不同類型問題、使用高質量數據進行機器學習的重要性，以及負責任和可解釋AI的重要性。


##### 摘要

* Google九大產品（用戶均逾十億）：Android, Chrome, Gmail, Google Drive, Google Maps, Google 搜尋, Google Play, YouTube, Google 相簿。
*  產品整合AI和機器學習，提升效率，例如：照片搜尋、影片推薦、智慧撰寫、交通預測。
* Google持續開發基於生成式AI等新技術的產品。
* 本課程涵蓋：AI與機器學習之區別；機器學習與數據分析/商業智慧之差異；AI解決方案適用問題類型；高質量數據之重要性；負責任和可解釋AI之重要性。
...
人們普遍將人工智慧 (AI)、AI 和機器學習 (ML) 這幾個詞彙互換使用。這樣的混淆是可以理解的，因為人工智慧和機器學習密切相關。然而，這些熱門技術在許多方面有所不同，包括範圍和應用。在我們深入探討之前，讓我們先定義每個術語。人工智慧是一個廣泛的領域，指的是使用技術來建造可以模擬與人類智慧相關的認知功能的機器和電腦。這些功能包括能夠看、理解和回應口語或書面語言、分析數據、提出建議等等。儘管人工智慧通常被認為是一個系統本身，但它是一組實現在系統中的技術，讓它能夠推理、學習和行動以解決複雜的問題。機器學習是 AI 的一個子集，它讓機器可以從數據中學習，而無需明確編程。它依靠各種模型來分析大量數據，從洞察中學習，然後做出預測和明智的決策。機器學習演算法隨著訓練或接觸更多數據而隨著時間推移提高性能。機器學習模型的輸出，或是程式從在訓練數據上運行演算法中學到的東西。當使用更多數據時，模型會得到改善。記住這兩者之間差異的一個好方法是將它們想像成雨傘類別。人工智慧是一個涵蓋各種特定方法和演算法的總稱。機器學習位於該雨傘之下，但其他主要子領域，如深度學習、機器人學、專家系統和自然語言處理也是如此。你可能經常聽到的另一個 AI 領域是生成式 AI。這是一種可以產生新內容的人工智慧，包括文本、圖像、音訊和合成數據。Google 將生成式 AI 應用於 Google Workspace 等產品，以幫助用戶輕鬆自動化不同類型的任務，例如生成長文件的摘要。Google 還向開發人員提供開發工具包，例如生成式 AI API，以幫助他們創建定制產品和服務。生成式 AI 可用於各種應用程序，例如對話機器人、內容生成、文檔合成和產品發現。


##### 摘要

*   人工智慧 (AI) 是一個廣泛的領域，涵蓋各種模擬人類認知功能的技術。
*   機器學習 (ML) 是 AI 的一個子集，讓機器從數據中學習，無需明確編程。
*   AI 包含許多子領域，例如機器學習、深度學習、機器人學、專家系統和自然語言處理。
*   生成式 AI 是一種可以產生新內容 (文字、圖像、音訊等) 的 AI 類型。
*   機器學習模型透過訓練數據提升效能。
...
> 貴公司內部可能存在分析師每天查看的特定儀表板，或管理者每月審閱的特定報告。儀表板和報告都是回顧性數據的例子，它們著眼於過去發生的事情。大多數數據分析和商業智能都基於歷史數據，用於計算指標或識別趨勢。但要為您的業務創造價值，您需要利用這些數據做出關於未來業務的決策。這就是人工智能和機器學習發揮作用的地方。它們是釋放這些能力的關鍵。讓我們考慮一個例子來說明這一點。Maya 領導著一家國際航空公司的業務策略和運營團隊，為了確定客戶購買模式的趨勢，她正在查看歷史年度報告。她可以使用這些數據生成儀表板，呈現諸如近年來客戶人口統計分佈和銷售額等信息。但這個決策過程沒有什麼新穎或變革性的。Maya 只是使用數據分析來闡述過去發生的事情。但如果 Maya 可以預測每次航班的滿意度，或預測客戶投訴並搶先一步呢？為有效做到這一點，她需要訪問更多數據並使用機器學習模型來預測未來業務。她可能需要的數據包括每次航班的乘客數量、每次航班的持續時間、每次航班的客戶滿意度評分以及每次航班的客戶投訴數量。她還需要了解導致客戶投訴的因素，例如天氣報告、季節性指標以及客戶投訴的解決時間數據。通過所有這些不同的數據點，Maya 可以預測單次航班的質量及其客戶投訴。但每天有數百次航班。Maya 的真正價值將來自於能夠對全年所有航班做出預測性見解。更重要的是，如果她可以根據預測動態調整價格或人員安排，甚至餐飲服務，那將更有價值。請記住，機器學習提供了一種方法來教計算機如何通過提供正確答案的示例來解決問題。通過訪問正確的數據，Maya 可以使用機器學習來發現這些類型的預測性見解，從而使航空公司及其客戶受益。


##### 摘要

*   大多數數據分析基於歷史數據，缺乏對未來業務的預測能力。
*   人工智能和機器學習是提升數據分析價值，做出未來業務決策的關鍵。
*   以航空公司案例為例，利用歷史數據僅能呈現過去趨勢，無法預測未來客戶滿意度和投訴。
*   結合更多數據（乘客數量、航班時間、客戶滿意度、投訴數量、天氣、季節等）和機器學習模型，可以預測航班質量和客戶投訴。
*   機器學習的真正價值在於動態調整價格、人員安排和餐飲服務等，以提升客戶滿意度並優化業務。
...
機器學習讓電腦系統能隨著經驗累積不斷調整和提升自身能力，因此輸入的數據越多，結果越準確。基於此，機器學習適用於解決四個常見的商業問題。


##### 摘要

*   **取代或簡化基於規則的系統：**例如Google搜尋，機器學習模型可根據用戶點擊數據預測搜尋結果排名，取代複雜的手動規則設定。

*   **自動化流程：**例如Ananda Development運用機器學習自動化房產檢查流程，透過語音轉文字API和影像辨識API，大幅提升效率並降低人力成本。

*   **理解非結構化數據：**例如Ocado利用機器學習處理自然語言，自動分類客戶郵件並轉發至相關部門，改善客戶體驗。

*   **個人化：**例如YouTube利用機器學習提供個人化影片推薦，提升用戶滿意度，許多電商也運用此技術推薦產品。
...
機器學習模型利用數據來推導預測性見解並做出重複性決策。然而，這些預測的準確性依賴於大量正確且無錯誤的數據。如果數據與問題不符或以某種方式存在偏差，則被認為是低質量的。如果使用低質量數據訓練機器學習模型，就像用錯誤信息教導孩子一樣，模型無法從不正確的數據中做出準確的預測。那麼，如何在訓練機器學習模型時確保數據質量呢？為了評估數據質量，需要根據六個維度進行評估：完整性、唯一性、及時性、有效性、準確性和一致性。讓我們更詳細地探討每個維度的含義。


##### 摘要

*   **完整性 (完整性):**  數據是否包含所有必需信息。不完整數據將導致模型無法學習做出準確預測所需的所有模式。例如，依賴於客戶交易數據集的機器學習模型訓練，如果某些交易缺少關鍵信息（例如交易日期），則模型訓練將受到影響。

*   **唯一性 (唯一性):** 數據集是否避免大量重複數據。重複數據會混淆模型，使其難以準確識別模式。例如，訓練識別狗品種的模型，需要多種不同品種的圖片，而非大量重複的單一品種圖片。

*   **及時性 (及時性):** 數據是否及時反映當前狀態。過時的數據會導致模型基於無關信息做出預測。例如，用於預測股市波動的模型，需要及時的股價數據，而非數月前的數據。

*   **有效性 (有效性):** 數據是否符合預定義的標準和定義（例如類型和格式），以及數據是否在可接受的範圍內。例如，「08-12-2019」的日期格式可能無效，如果標準格式為「年-月-日」。

*   **準確性 (準確性):** 數據是否正確，例如正確的出生日期或銷售數量。例如，圖片數據集中，某些圖片可能被錯誤標記為狗，而實際上是貓。準確性與有效性不同，有效性關注類型、格式和範圍，而準確性關注形式和內容。

*   **一致性 (一致性):** 數據是否統一且不包含任何矛盾信息。不一致的數據（例如同一實體在不同位置使用不同名稱或值）會影響模型的預測準確性。例如，客戶信息數據集中，同一位客戶可能在某些地方顯示為「John Smith」，而在其他地方顯示為「J. Smith」。
...
> 人工智慧具有解決諸多艱鉅問題的巨大潛力，包括推進醫學發展、理解語言和促進科學發現。要實現這一潛力，負責任地使用人工智慧至關重要。為此，Google 制定了指導 Google 人工智慧應用的原則、與 Google 外部社群分享我們工作的最佳實務，以及使我們的努力合理化的計畫。這些原則指出，人工智慧應具有社會效益、避免造成或強化不公平的偏見、以安全為重並進行測試、對人們負責、納入隱私設計原則、堅持高水平的科學卓越，並僅用於符合這些原則的用途。此外，Google 不會在以下應用領域設計或部署人工智慧：可能造成整體傷害的技術；武器或其他其主要目的或實施方式為造成或直接促成人員傷害的技術；收集或使用資訊進行監控、違反國際公認規範的技術；以及其目的違反廣泛接受的國際法和人權原則的技術。儘管這些是 Google 自身的 AI 指導原則，但我們也敦促其他組織制定自身的一套原則，以鼓勵負責任的 AI 開發。讓組織除錯和改進機器學習模型的效能，並幫助他人了解其模型的行為也很重要。建立機器學習模型的組織也需要協助偵測和解決其數據和模型中的偏差、漂移和其他差距。此外，提供人類可理解的機器學習模型說明將有助於提升最終用戶的信任度和透明度。可解釋人工智慧是 Google Cloud 的一套工具和框架，可幫助您理解和解釋機器學習模型做出的預測。這些工具與多種 Google 產品和服務原生整合，以確保人工智慧開發的透明度。


##### 摘要

* 人工智慧具有巨大潛力，可解決醫學、語言理解和科學發現等領域的重大問題。
* 負責任地使用人工智慧至關重要。
* Google 建立了人工智慧應用原則，包括：社會效益、避免偏見、安全測試、問責制、隱私保護、科學卓越，以及用途符合這些原則。
* Google 不會開發可能造成傷害、用於武器、進行違規監控或違反國際法和人權的技術。
* 鼓勵其他組織制定自身負責任的人工智慧開發原則。
* 應改進機器學習模型效能，解決數據和模型中的偏差和漂移等問題。
* 可解釋人工智慧有助於提升透明度和使用者信任。
* Google Cloud 提供工具和框架，協助理解和解釋機器學習模型預測。


#### Quiz

- https://www.cloudskillsboost.google/paths/9/course_templates/946/quizzes/452221
...
> 歷史上，人工智慧和機器學習並非一般人所能及。大多數能夠開發 AI 和 ML 解決方案的人都是專業工程師，他們人數稀少且聘用成本高昂。但事實是，現在 ML 比以往任何時候都更容易上手，即使沒有技術專長的人也能夠進行開發。Google Cloud 提供四種建構機器學習模型的選項。第一種選項是 BigQuery ML，這是一個使用 SQL 查詢在 BigQuery 中創建和執行機器學習模型的工具。如果您已將數據儲存在 BigQuery 中，且您的問題符合預定義的 ML 模型，則此選項可能適合您。第二種選項是使用預先訓練的 API（應用程式程式介面）。此選項讓您可以使用 Google 建立和訓練的機器學習模型，因此如果您沒有足夠的訓練數據或公司內沒有足夠的機器學習專業知識，則無需自行構建 ML 模型。第三種選項是 AutoML，這是一個無需編碼的解決方案，讓您可以透過點擊介面在 Vertex AI 上構建您自己的機器學習模型。最後，您可以透過自訂訓練來編寫您自己的機器學習環境、訓練和部署，這讓您可以靈活掌控 ML 管線。在本課程的第二部分，您將進一步了解這四種構建機器學習模型的選項，還將了解 Google 的其他一些 AI 解決方案。


##### 摘要

* 傳統上，AI 和 ML 開發需仰賴稀少且昂貴的專業工程師。
* 現今 ML 技術門檻降低，更多人得以參與開發。
* Google Cloud 提供四種機器學習模型建構方案：
    * BigQuery ML：利用 SQL 查詢於 BigQuery 建立及執行 ML 模型。
    * 預先訓練 API：使用 Google 預先訓練好的模型，免除自行訓練模型的需要。
    * AutoML：無需編碼的圖形化介面，方便使用者建立模型。
    * 自訂訓練：提供高度彈性及掌控權，讓使用者自行編寫及部署 ML 環境。
* 本課程將深入探討以上四種方案及 Google 其他 AI 解決方案。
...
> 大型數據集的機器學習需要大量的程式設計和機器學習框架的知識。這些要求將解決方案的開發限制在每個公司內非常小的一群人，並且排除了那些了解數據但機器學習知識和程式設計專業知識有限的數據分析師。儘管 BigQuery 最初僅作為數據倉庫，但隨著時間的推移，它已經發展出更多支持數據到 AI 生命週期的功能。BigQuery ML 通過讓數據分析師（主要是數據倉庫用戶）能夠使用現有的商業智能工具和電子表格來構建和運行模型，從而使機器學習的使用民主化。預測分析可以指導整個組織的商業決策。無需使用 Python 或 Java 程式設計 ML 解決方案。模型直接在 BigQuery 中使用 SQL 進行訓練和訪問，SQL 是一種數據分析師熟悉的語言。BigQuery ML 將機器學習帶入數據中。它降低了複雜性，因為需要的工具更少。它還提高了生產速度，因為不需要為 BigQuery 中的模型訓練移動和格式化大量數據以用於基於 Python 的 ML 框架。BigQuery ML 還與 Vertex AI 集成，Vertex AI 是 Google Cloud 端到端 AI 和 ML 平台。當 BigQuery ML 模型註冊到 Vertex AI 模型註冊表時，它們可以部署到端點以進行線上預測。


##### 摘要

*   大型數據集機器學習開發受限於少數具備程式設計及 ML 框架知識的人員。
*   BigQuery ML 讓數據分析師能透過熟悉的商業智能工具及電子表格，建構及執行機器學習模型。
*   使用 SQL 即可在 BigQuery 中訓練及存取模型，無需 Python 或 Java 程式設計。
*   BigQuery ML 降低複雜性及提升速度，無需移動及格式化大量數據。
*   BigQuery ML 整合 Vertex AI，方便模型部署至端點進行線上預測。
...
> Google Cloud 的預訓練 API 是一個絕佳的選擇，尤其當您沒有自己的訓練數據時。這非常適合那些沒有專門數據科學家，但擁有商業分析師和開發人員的組織。這是機器學習方法中最快速、最省力的方式，但可定制性不如其他方法。Google Cloud 的預訓練 API 能透過提供用於分析圖像、影片和文字等常見任務的機器學習模型，幫助開發人員快速構建智能應用程式。無論機器學習經驗水平如何，API 都可以部署在虛擬私有雲、本地或 Google 的公有雲中。讓我們想像一下，一位開發人員正在構建一個行動應用程式，使用者可以提交照片給開發人員，應用程式需要識別圖像內容並過濾掉任何不適合工作的圖片。開發人員可能會選擇 Vision API。它提供強大的預訓練機器學習模型，使用 Google 數據自動檢測圖像中的面部、物體、文字甚至情感。開發人員可以使用 Vision API 為圖像分配標籤，並將其快速分類到數百萬個預定義類別中。自然語言 API 是另一個開箱即用的預訓練 API。如果一家企業在其網站上有一個每天接收大量訊息的聯繫表單，這些數據可能難以且耗時地進行人工處理、分類和執行操作。自然語言 API 能夠發現文字中的語法、實體和情感，並將文字分類到一組預定義的類別中。在本例中，它可以判斷評論是否代表抱怨、讚美，並嘗試進一步了解您的業務。Google 還提供其他幾個預訓練 API。Cloud Translation API 可將文字從一種語言翻譯成另一種語言。語音轉文字 API 可將音訊轉換為文字以進行數據處理。文字轉語音 API 可將文字轉換為高品質的語音音訊。而影片智慧 API 則可以識別影片中的動作和行為。機器學習模型的訓練效果取決於可用於訓練它的數據量。正如您可能預期的那樣，Google 擁有大量的圖像、文字和機器學習研究人員來訓練其預訓練模型。這意味著您可以減少工作量，並更快地獲得投資回報。


##### 摘要

* Google Cloud 預訓練API適用於缺乏自身訓練數據的使用者，尤其適合擁有商業分析師和開發人員，但缺乏數據科學家的組織。
* 此方法快速、省力，但客製化程度較低。
* 可快速建構智慧型應用程式，分析圖像、影片和文字。
* 部署彈性高，支援虛擬私有雲、本地和 Google 公有雲。
* Vision API 可自動檢測圖像中的面部、物體、文字和情感，並將其分類到數百萬個預定義類別。
* Natural Language API 可分析文字語法、實體、情感，並將其分類。
* 其他預訓練API包含：Cloud Translation API (翻譯)、語音轉文字 API、文字轉語音 API 和影片智慧 API。
* Google 龐大的數據和研究資源，確保預訓練模型的高效能，縮短開發時間，提升投資回報。
...
使用機器學習解決問題的另一種更自訂的方法，是利用您自己的數據來訓練模型。這就是 Vertex AI 的用武之地。Vertex AI 整合了 Google Cloud 用於構建機器學習的服務，並提供單一的統一使用者介面。您可以使用您自己的訓練數據與 Vertex AI 來管理和建立機器學習專案。AutoML 和 Vertex AI 讓您可以使用圖形使用者介面 (GUI) 來端到端地建立和訓練機器學習模型，無需撰寫任何程式碼。這意味著，在您的數據導入 Vertex AI 後，AutoML 會透過比較不同的模型和調整參數，為您選擇最佳的機器學習模型。以往需要大量手動操作的工作，現在可以自動且快速地完成，從而產生一個準確且符合您數據的自訂模型。這讓機器學習從業者可以專注於他們嘗試解決的問題，而不是機器學習的細節。對於想要產生自訂 ML 模型，但不願花太多時間編碼和嘗試數千個模型的企業而言，AutoML 是一個絕佳的選擇。讓我們回到我們使用的影像辨識範例，它使用了 Vision API，一個使用 Google 數據訓練的預先存在的模型。想像一下，您在一家汽車製造公司工作。Vision API 可以分辨 Google 資料庫中常見影像之間的差異，例如輪胎和車門之間的差異。但它無法幫助汽車製造商區分良品和不良品。在此情況下，開發人員可以使用 AutoML Vision 實例並使用您的專業數據來訓練它。這自動化了機器學習模型的訓練，這意味著您可以上傳一批影像，並透過 AutoML 易於使用的圖形介面來訓練影像分類模型。模型可以進一步優化並直接從雲端部署。現在讓我們專注於 AutoML 的另一個功能。前面您看到了如何使用自然語言 API 來處理線上聯繫表單的輸入。但是，如果您的文字範例不完全符合自然語言 API 的情感型或垂直主題型分類方案，並且您想要改用您自己的專業數據，則需要使用 AutoML 自然語言。AutoML 自然語言讓您可以建立和部署自訂機器學習模型，分析文件、對其分類、識別其中的實體或評估其中的態度。您可以使用 AutoML 使用者介面來上傳您的訓練數據，並在不寫任何程式碼的情況下測試您的自訂模型。Vertex AI 使這種自訂成為可能。這些範例只是 Google Cloud ML 提供的眾多產品中的一小部分。您還可以找到可以分類影片、將音訊轉換為文字或文字轉換為音訊、理解自然語言、在語言之間翻譯等等的 API。事實上，在許多最具創新性的機器學習應用中，結合了其中幾種應用程式。


##### 摘要

*   利用自有數據訓練模型，解決客製化問題。
*   Vertex AI 整合 Google Cloud 機器學習服務，提供統一介面。
*   AutoML 提供圖形化介面，無需編碼即可建立和訓練模型。
*   AutoML 自動選擇最佳模型，並調整參數，快速產生準確的自訂模型。
*   適用於需客製化模型但無需大量編碼的企業。
*   以汽車製造良品瑕疵檢測為例，說明 AutoML Vision 的應用。
*   AutoML 自然語言可用於處理不符合預設分類方案的文字數據。
*   Vertex AI 支援客製化模型建立與部署，無需編碼。
*   Google Cloud 提供多種機器學習 API，例如影像、音訊、文字處理等。
*   許多創新應用結合多種 Google Cloud 機器學習 API。
...
> Vertex AI 也是建立自訂端到端機器學習模型的重要平台。這意味著不僅可以使用您自己的數據訓練模型，而且模型也是自訂建立的。Vertex AI 提供一套產品，可在機器學習工作流程的每個階段提供幫助，從收集數據到未來的工程、建立模型，最後到部署和監控這些模型。由於這種方法是完全自訂建立的，端到端的，因此它的過程最長，需要一個專業的數據科學家和工程師團隊。但是，這些完全自訂的機器學習模型最能滿足您的需求，並為您的業務帶來最大的差異化和創新成果。Vertex AI 包含可協助程式設計師進行虛擬機器映像、數據標記、訓練和預測的工具。它還提供預建演算法。重要的是要記住，儘管這些工具是每個階段使用您的數據的構建塊，但沒有任何一種方法適合所有情況。每個用例都需要不同的工具和產品組合。


##### 摘要

*   Vertex AI 提供自訂端到端機器學習模型建立平台。
*   涵蓋機器學習工作流程所有階段：數據收集、模型建立、部署及監控。
*   完全客製化，需專業數據科學家及工程師團隊，耗時較長。
*   模型高度專精，帶來最大差異化及創新成果。
*   提供虛擬機器映像、數據標記、訓練及預測工具，以及預建演算法。
*   無單一解決方案適用所有情況，需根據用例選擇不同工具及產品組合。
...
所有機器學習模型均建構於 Google Cloud 的 AI 基礎架構之上。此基礎架構的一部分是 TensorFlow，這是一個端到端的開放原始碼機器學習平台。TensorFlow 擁有靈活的工具、函式庫和社群資源生態系統，讓研究人員能夠在機器學習領域創新，並讓開發人員能夠建置和部署搭載機器學習的應用程式。TensorFlow 最初是為 Google 內部使用而開發，現在已成為開放原始碼，以便讓所有人受益。TensorFlow 利用 Tensor Processing Unit (TPU)，這是 Google 專門開發的應用程式特定積體電路，用於加速機器學習工作負載。TPU 作為特定領域的硬體，而非像 CPU 和 GPU 那樣的通用型硬體。透過 TPU，運算速度提升超過 200 倍。這表示，使用最先進的 GPU 需等待 26 小時才能獲得結果，而使用完整的雲端 TPU 叢集則只需等待 7.9 分鐘即可獲得相同的結果。雲端 TPU 已整合到 Google 的多項產品中，此最先進的硬體和超級運算技術可透過 Google Cloud 產品和服務取得。


##### 摘要

* 所有機器學習模型皆基於 Google Cloud 的 AI 基礎架構。
* TensorFlow 為 Google 開發的端到端開放原始碼機器學習平台，擁有豐富的工具及資源。
* Google 的 TPU (Tensor Processing Unit) 為專用於加速機器學習的 ASIC，速度較 GPU 快 200 倍以上。
* 使用 TPU，原本需 26 小時才能完成的運算，只需 7.9 分鐘即可完成。
* Google Cloud 產品和服務皆整合 TPU 技術。
...
> 除了可自訂選項外，Google Cloud 也創造了一系列完整的 AI 解決方案，旨在解決特定的業務需求。聯繫中心 AI 提供與客戶交談和協助人工座席的模型，提高營運效率，並個性化客戶服務，從而轉型您的聯繫中心。文件 AI 通過提取和分類來自非結構化文件（例如發票、收據、表格、信函和報告）的信息來解鎖見解。然後可以將提取的數據保存到數據庫中或導出到另一個應用程序以進行進一步分析。零售發現 AI 使用機器學習來選擇零售商電子商務網站上產品的最佳排序，當購物者選擇冬季夾克或廚房用品等類別時。隨著時間的推移，AI 通過使用歷史數據來學習每個頁面的理想產品排序，優化產品的展示方式和內容，以提高準確性、相關性和銷售可能性。而 Cloud Talent Solution 利用 AI 進行求職和人才招聘，更快地將候選人與理想工作匹配，並讓雇主吸引和轉化更高質量的候選人。這些只是 Google Cloud 提供的一些完整的 AI 解決方案。


##### 摘要

* **聯繫中心 AI:** 提供模型，提升客戶互動效率，個性化客戶服務。
* **文件 AI:** 提取和分類非結構化文件 (發票、收據等) 中的信息，方便數據分析。
* **零售發現 AI:** 利用機器學習優化電商產品排序，提高銷售可能性。
* **Cloud Talent Solution:**  運用 AI 進行人才招募，加速匹配候選人和理想工作。
...
> Google Cloud 提供一系列 AI 和 ML 解決方案及產品，但在選擇使用哪一種方案時，需要考慮幾項決策和權衡。首先是速度：您需要多快才能將模型投入生產？AI 專案的規劃和實施通常需要 3 到 36 個月，具體取決於用例的範圍和複雜性。但業務決策者往往低估了所需的時間。預訓練 API 無需模型訓練，因為這項耗時的任務已經完成。自訂訓練通常所需時間最長，因為它從頭開始構建 ML 模型，這與 AutoML 和 BigQuery ML 不同。接下來是差異化：您的模型有多獨特，或者它需要多麼獨特？Google Cloud 為希望快速在其日常業務運營中使用 ML 模型的組織提供一系列現成解決方案。這些包括圖像識別解決方案和聊天機器人，它們部署迅速，並可應用於各種用例。或者，Vertex AI 作為 Google Cloud 的統一平台，可用於構建、部署和管理 AI 解決方案，可以讓 ML 工程師和數據科學家完全控制 ML 工作流程。Vertex AI 自訂訓練讓您可以使用 Vertex Workbench 上的代碼訓練和服務自訂模型，從而產生高度定制的 ML 模型。另一個考慮因素是在開始 AI 或 ML 專案時所需的專業知識。將 AI 整合到業務流程中需要數據工程師、數據科學家和機器學習工程師等角色。組織應考慮其目前的團隊，然後確定人員策略，這可能包括重複使用或調整現有資源、提升和培訓現有員工，或聘用或與外部顧問或承包商合作。Google Cloud 的 AI 和 ML 產品種類繁多，從數據分析師和商業情報團隊可以使用產品，到更適合 ML 工程師和數據科學家的產品，應有盡有。最後一個考慮因素是構建 AI 解決方案所需的工作量。這取決於幾個因素，包括問題的複雜性、可用數據量和團隊的經驗。Google Cloud 可以幫助提供適用於規模兩端的專案的解決方案。但是，任何 AI 工作通常都需要大量時間、精力和專業知識才能對業務運營產生有價值的影響。


##### 摘要

*   **速度:** 預訓練API最快，自訂訓練最慢，AutoML和BigQuery ML居中。
*   **差異化:**  從現成的解決方案（例如圖像識別、聊天機器人）到Vertex AI自訂訓練，提供不同程度的模型獨特性。
*   **專業知識:**  需要數據工程師、數據科學家、機器學習工程師等角色，需考量團隊現狀及人員策略。
*   **工作量:**  取決於問題複雜性、數據量及團隊經驗，Google Cloud提供不同規模的解決方案。

#### Quiz

- https://www.cloudskillsboost.google/paths/9/course_templates/946/quizzes/452230
...
> 本課程帶領您完成 Google Cloud 人工智能創新課程，讓我們快速回顧一下。課程第一部分「AI 和機器學習基礎」探討了人工智能和機器學習的差異，機器學習與數據分析和商業智能的區別，AI 解決方案適用於解決的不同類型問題，使用高質量數據進行機器學習的重要性，以及負責任且可解釋的 AI 的重要性。課程第二部分「Google Cloud 的 AI 和機器學習解決方案」學習了 BigQuery ML、預訓練 API、AutoML 和自定義模型（均為 Vertex AI 的一部分）、TensorFlow、現有 AI 解決方案以及選擇 Google Cloud AI 或機器學習解決方案時應考慮的因素。現在您已全面了解 Google Cloud 上的人工智能和機器學習，您可以繼續學習系列中的下一門課程：「使用 Google Cloud 現代化基礎設施和應用程式」，您將學習現代化和遷移到雲端在組織轉型之旅中的重要性，在雲端運行計算工作負載的選項和優勢，在應用程式現代化中使用容器和無伺服器計算，應用程式程式介面 (API) 的商業價值，以及選擇混合雲或多雲策略的商業原因。下次見。
...
* **第一部分：AI 和機器學習基礎**
    ...
    * 高質量數據的重要性
    * 負責任且可解釋的 AI 的重要性
* **第二部分：Google Cloud 的 AI 和機器學習解決方案**
    * BigQuery ML, 預訓練 API, AutoML 和自定義模型 (Vertex AI)
    * TensorFlow 及現有 AI 解決方案
    * 選擇 Google Cloud AI/ML 解決方案的考量因素
* **下一階段課程：使用 Google Cloud 現代化基礎設施和應用程式**
    * 雲端現代化和遷移的重要性
    * 雲端計算工作負載的選項和優勢
    * 容器和無伺服器計算在應用程式現代化中的應用
    * API 的商業價值
    * 混合雲或多雲策略的商業原因
...
> 雲端孕育的新型組織正挑戰著舊有的商業模式。規模不再是競爭優勢，而是常態。但這對雲端時代之前成立的組織意味著什麼？他們想知道如何不僅生存，還能蓬勃發展。答案在於組織如何架構和使用其 IT 資源，例如擺脫自行投資資源來運行和維護現有 IT 基礎設施。透過雲端，組織可以將重點轉移到創造新的、更高價值的產品和服務。而這不僅僅是關於基礎設施。透過雲端，組織可以開發和構建新的應用程式，以更快、更安全且更大規模地促進與客戶和員工之間的互動。企業也從採用雲端中獲得了顯著的財務效益。隨著他們的 IT 方法從購買固定容量轉變為僅支付使用的費用，他們正在改變技術投資的經濟效益。對於許多組織而言，基礎設施和應用程式現代化是數位轉型的基礎。因此，考慮到這一點，讓我們來探討本課程的目標。以 Google Cloud 為基礎的現代化基礎設施和應用程式旨在幫助您了解與基礎設施和應用程式現代化相關的常見術語。探索在雲端運行計算工作負載的選項，包括虛擬機器、容器和無伺服器架構。並檢視透過重新託管和 API 來現代化應用程式開發的選項。在整個課程中，您將會遇到分級的知識評估。您必須通過這些評估才能獲得課程學分。好的，讓我們開始吧。
...
* 雲端組織挑戰傳統商業模式，規模已成常態。
* 企業需轉型以在雲端環境中生存和發展。
* 雲端促進資源效率，讓企業專注於高價值產品和服務開發。
* 雲端提升應用程式開發速度、安全性及規模。
* 雲端帶來顯著財務效益，改變技術投資模式。
* 基礎設施和應用程式現代化是數位轉型的基石。
* 本課程目標：學習雲端基礎設施及應用程式現代化相關術語；探索虛擬機器、容器及無伺服器架構等計算工作負載選項；探討應用程式現代化開發方法（重新託管和API）；完成課程評估以獲得學分。
...
> 雲端現代化基礎建設和應用程式學習過程中，您會聽到一些常見術語。讓我們介紹或提醒您一些這些術語。首先是工作負載。在雲端運算中，工作負載是指可在雲端或內部部署執行的特定應用程式、服務或功能。工作負載包括容器、資料庫和虛擬機器。有時工作負載會被淘汰。淘汰工作負載意味著將其從平台中移除。淘汰工作負載的原因可能是因為它不必要、不具成本效益、不安全或與特定平台不相容。或者，工作負載通常會被保留。保留工作負載意味著它被有意保留。當工作負載被保留時，它通常會保留在內部部署或混合雲環境中。這表示工作負載將繼續由企業管理，並且不會受到相同程度的雲端供應商控制。許多工作負載都在雲端運算中重新託管。重新託管是指將工作負載遷移到雲端，而無需更改工作負載的程式碼或架構。這通常作為雲端遷移的第一步，因為它是將工作負載運行在雲端的簡單快捷方法。此過程通常稱為「直接搬遷」。但是，重新託管也有一些缺點，包括它沒有充分利用雲端運算的所有優點。管理未經任何更改而重新託管的工作負載可能很困難。擴展未經任何更改而重新託管的工作負載也可能很困難。然後是重新平台化。在雲端運算中，重新平台化是指在遷移工作負載到雲端的同時對工作負載的程式碼或架構進行一些更改的過程。此過程通常稱為「遷移和改進」。重新平台化讓組織可以受益於雲端的可擴展性、可靠性和成本效益，提高工作負載的效能，並降低工作負載的成本。但是，重新平台化也有一些缺點，包括它可能是一個複雜且耗時的過程。對工作負載的程式碼或架構進行必要的更改可能很困難，測試對工作負載的程式碼或架構的更改也可能很困難。有時會重構工作負載，這指的是更改工作負載程式碼的過程。例如，組織可能會重構工作負載以使用基於雲端的微服務架構或基於雲端的無伺服器架構。我們將在本課程稍後探討這些概念的含義。重構有一些好處。這意味著工作負載可以變得更有效率、更具可擴展性或更安全，並且對於希望使用所有雲端功能的組織來說是一項有價值的投資。話雖如此，組織的一個可能的缺點是重構工作負載可能是一個複雜且耗時的過程。最後，雲端現代化可以激勵和鼓勵組織重新構想。在雲端運算中，重新構想是指重新思考組織如何使用技術來實現其業務目標的過程。這可能涉及重新考慮組織目前的雲端策略及其使用其他技術（例如人工智慧和機器學習）的方式。重新構想雲端運算可以幫助組織提高效率、降低成本和提高敏捷性。它還可以幫助組織更好地滿足客戶和合作夥伴的需求。


##### 摘要

* **工作負載 (Workload):**  雲端或內部部署執行的應用程式、服務或功能。包含容器、資料庫及虛擬機器。可被淘汰或保留。
* **淘汰 (Retiring):** 從平台移除工作負載。
* **保留 (Retaining):**  有意保留工作負載，通常於內部部署或混合雲環境。
* **重新託管 (Rehost)/直接搬遷 (Lift and Shift):**  將工作負載遷移至雲端，無需程式碼或架構變更。快速但限制雲端效益。
* **重新平台化 (Replatform)/遷移和改進 (Move and Improve):**  遷移工作負載至雲端，並調整程式碼或架構。提升效能及成本效益，但過程複雜。
* **重構 (Refactor):**  更改工作負載程式碼，例如改用微服務或無伺服器架構。提升效率、可擴展性及安全性，但過程複雜。
* **重新構想 (Reimagine):**  重新思考組織如何運用技術達成業務目標，包含雲端策略及AI/ML等技術應用。提升效率、降低成本及提高敏捷性。
...
> 雲端運算中的運算指的是機器處理資訊的能力，相關任務包括儲存、擷取、比較和分析資訊。與依靠本地伺服器和儲存裝置不同，雲端運算使用遠端伺服器網路按需提供各種運算資源，包括應用程式、儲存和處理能力。由於其靈活性、可擴展性和成本效益，這項技術近年來越來越普及。在本課程章節中，您將學習雲端運算帶給組織的益處，並探討三種雲端運算選項：虛擬機器、容器和無伺服器。


##### 摘要

* 雲端運算：機器處理資訊的能力 (儲存、擷取、比較、分析)。
* 利用遠端伺服器網路提供按需運算資源 (應用程式、儲存、處理能力)。
* 優點：靈活性、可擴展性、成本效益。
* 本章節內容：雲端運算益處，及虛擬機器、容器、無伺服器三種選項。
...
> 為何組織應考慮在雲端運行計算工作負載？讓我們探討在雲端運行計算工作負載可為組織帶來的一些好處。我們將從總體擁有成本 (TCO) 開始，這是衡量系統或解決方案在其整個生命週期中的總成本。它包括初始採購、維護和運營成本以及任何其他相關成本。雲計算可以幫助企業節省 IT 成本，無需購買和維護物理基礎設施。雲供應商提供按需付費模式，這意味著組織只需支付使用的資源費用。他們還為長期承諾提供折扣，這可以進一步降低計劃長期使用雲服務的企業的 TCO。接下來是可擴展性，它指的是增加或減少可用於基於雲的應用程序的資源（例如服務器、存儲和帶寬）數量以滿足不斷變化的需求的能力。可擴展性很重要，因為它提供了一種滿足不斷變化的需求的方法，而無需對基礎設施進行大量前期投資。如果企業經歷需求的突然激增，它可以輕鬆擴展其雲資源以滿足需求。相反，如果他們經歷需求減少，基礎設施可以快速縮減其雲資源以節省資金。雲計算的另一個好處是可靠性。雲供應商提供高度的可靠性和正常運行時間，讓企業相信他們的數據和應用程序在需要時可用。雲供應商有很多方法可以確保其服務的可靠性。例如，Google Cloud 在世界各地設有多個數據中心。這有助於確保如果一個數據中心宕機，其他數據中心可以繼續運行。雲供應商還使用各種技術來監控其服務並自動檢測和解決問題。接下來是安全性。雲計算提供商為數據和應用程序提供高度的安全性。組織需要確保其數據安全。除了物理數據中心安全之外，雲安全功能還包括數據加密、身份和訪問管理、網絡安全、虛擬私有雲和可以實時檢測和響應安全威脅的監控服務。這些安全功能還可以幫助確保符合政府或行業法規。在雲端運行計算工作負載為組織提供了高度的靈活性。組織可以隨時選擇最符合其需求的雲服務，然後在需要時更改或適應這些服務。例如，需要增加其使用的存儲空間的企業可以輕鬆地向其雲存儲服務添加更多存儲空間。最後，在雲端運行計算工作負載的另一個好處是抽象。抽象是指雲供應商如何通過管理硬件、軟件以及安全和網絡的某些方面來消除客戶理解基礎設施實現細節的需要。例如，雲存儲提供商可能會提供一種讓客戶存儲文件的方法，這樣他們就不必擔心文件如何在雲提供商的基礎設施上存儲的細節。抽象還允許雲提供商提供許多服務。例如，Google Workspace 允許客戶運行生產力應用程序，這樣他們就不必擔心這些應用程序如何在 Google 的基礎設施上實際運行或維護的細節。在雲端運行計算工作負載可以幫助組織更快地將其產品和服務推向市場，無需開發和維護自己的基礎設施。同時，它通過及時訪問最新的技術和工具，為創新提供了一個平台。


##### 摘要

* **降低總體擁有成本 (TCO):**  按需付費模式及長期承諾折扣，有效降低IT基礎設施成本。
* **高度可擴展性:**  靈活調整資源以應對需求變化，避免前期大量投資。
* **高可靠性:**  多數據中心及自動化監控，確保服務持續可用。
* **增強安全性:**  數據加密、身份驗證及威脅監控等措施，保障數據安全合規。
* **靈活性高:**  按需選擇及調整雲服務，滿足不同業務需求。
* **抽象化:**  簡化基礎設施管理，無需關注底層技術細節。
* **加快產品上市速度:**  利用雲端資源，縮短開發週期，提升創新能力。
...
> 傳統上，各種技術壓力迫使許多組織將特定的計算硬體資源與特定的應用程式緊密綁定。虛擬化技術減輕了這些壓力。虛擬化是一種資源優化形式，允許多個系統在同一硬體上運行。這些系統稱為虛擬機器或VM。這意味著它們共享相同的處理、存儲和網路資源池。VM 讓組織能夠在伺服器上同時運行多個應用程式，且效率高且易於管理。Compute Engine 是 Google Cloud 的基礎架構即服務產品，允許用戶在 Google 基礎架構上創建和運行虛擬機器。沒有前期投資，並且數千個虛擬 CPU 可以運行在設計快速且提供一致性能的系統上。每個虛擬機器都包含完整操作系統的功能。這意味著可以像配置物理伺服器一樣配置虛擬機器，指定所需的 CPU 功率和內存量、所需的存儲量和類型以及操作系統。虛擬機器實例可以通过 Google Cloud 主控台（一個基於 Web 的工具，用於管理 Google Cloud 項目和資源）和 Google Cloud CLI 命令列介面通過使用基礎架構自動化工具（如 Terraform 或 Compute Engine API）創建。API 或應用程式編程介面是一組指令，允許不同的軟體程式相互通信。我們稍後在本課程中將更詳細地了解 API。使用虛擬機器時，Compute Engine 按秒計費，最少一分鐘，並且持續使用折扣會自動應用於運行時間越長的虛擬機器。因此，對於每個運行時間超過一個月 25% 的 VM，Compute Engine 會自動為每個額外的使用小時應用折扣。Compute Engine 還提供預留使用折扣。這意味著當承諾使用資源一年或三年時，會提供超過按需價格的折扣。然後是搶佔式和搶佔型 VM。假設工作負載不需要人工等待其完成，例如分析大型數據集的批處理作業。通過選擇搶佔式或搶佔型 VM 來運行作業，成本可以降低，在某些情況下最多可降低 90%。搶佔式或搶佔型 VM 與普通 Compute Engine VM 只有一個不同之處：Compute Engine 可能會搶佔式中斷搶佔型 VM 以隨時回收容量。儘管搶佔式或搶佔型 VM 可以節省成本，但需要確保作業可以停止並重新啟動而不會產生影響。搶佔型 VM 與搶佔式 VM 的區別在於提供了更多功能。例如，搶佔式 VM 每次最多只能運行 24 小時，但搶佔型 VM 沒有最大運行時間。但是，目前的價格對兩者都是相同的。最後，Compute Engine 允許用戶通過使用一組預定義的機器類型或創建自定義機器類型來選擇實例的機器屬性，例如虛擬 CPU 數量、操作系統和內存量。
...
*   傳統上，硬體資源與應用程式緊密綁定。
*   虛擬化技術允許多個系統共享同一硬體資源。
*   Google Compute Engine 提供虛擬機器服務，按秒計費，並提供持續使用和預留使用折扣。
*   搶佔式和搶佔型 VM 提供更低成本，但可能被中斷。
*   用戶可自定義虛擬機器的 CPU、記憶體、作業系統等配置。
...
> 服務基礎設施 (Infrastructure as a Service, IaaS) 允許使用者透過虛擬機器虛擬化硬體來與其他開發者共享計算資源。這讓每個開發者都能在其自包含的環境中部署自己的作業系統、存取硬體並構建應用程式，同時擁有必要的系統資源。容器遵循與虛擬機器相同的原則，它們提供隔離的環境來執行軟體服務並優化單個硬體的資源，但效率更高。虛擬機器與容器的主要區別在於，虛擬機器將整個機器虛擬化到硬體層，而容器只虛擬化作業系統層以上的軟體層。容器啟動速度更快，與啟動整個作業系統相比，使用的記憶體也少得多。容器與您的應用程式及其所有依賴項一起打包，因此它擁有運行所需的一切。容器可以獨立開發、測試和部署，非常適合基於微服務的架構。這種架構由運行容器化應用程式的較小的個別服務組成，這些服務通過 API 或其他輕量級通訊方法（例如 REST 或 gRPC）相互通訊。容器讓開發者可以建立與其他系統資源隔離的可預測環境。因此，如果客戶要求新的功能或應用程式的更改，開發者可以輕鬆地更新應用程式的特定部分，而不會影響其餘部分。容器幾乎可以在任何地方運行，這使得開發和部署變得容易。


##### 摘要

*   IaaS透過虛擬機器共享計算資源。
*   容器與虛擬機器類似，但更有效率，僅虛擬化作業系統層以上的軟體層。
*   容器啟動速度快、記憶體使用率低，包含應用程式及其所有依賴項。
*   容器適用於微服務架構，可獨立開發、測試和部署。
*   容器提供隔離的、可預測的環境，方便更新和部署。
...
> 容器提升敏捷性、增強安全性、優化資源並簡化雲端應用程式的管理。許多組織同時使用虛擬機器和容器。然而，隨著 IT 基礎架構變得越來越複雜，他們常常需要一種方法來管理其服務和機器。例如，一個組織可能有數百萬甚至數千萬個容器，這需要大量的監督和管理才能確保其安全有效地運作。Kubernetes 是一個由 Google 開發的開源平台，用於管理容器化工作負載和服務。它可以輕鬆地在許多主機上編排許多容器，擴展它們，並輕鬆部署和回滾。這提高了應用程式的可靠性，並減少了管理和運營所需的時間和資源。Google Kubernetes Engine (GKE) 是 Google 在雲端託管的受管理 Kubernetes 服務。GKE 環境包含多台機器，具體來說是組成叢集的計算引擎實例。GKE 叢集可以自定義，並且支援不同的機器類型、節點數量和網路設定。GKE 通過提供 API 和基於 Web 的主控台，簡化了應用程式的部署。應用程式可以在幾分鐘內部署，並可以根據需要擴展或縮減。GKE 還提供許多功能，可以幫助監控應用程式、管理資源和排除問題。讓我們探討一下日本醫療科技新創公司 Ubie 如何利用 Google Kubernetes Engine 降低其基礎架構成本和維護需求。Ubie 成立於 2017 年，其目標是在人們需要時為他們提供正確的醫療護理，它通過為醫院和個人設計的產品實現這一目標。Ubie for Hospital 是他們的旗艦產品，是一款基於 AI 的問卷軟體，讓患者可以在預約前提供醫療詳情。Ubie 最初依賴於另一個雲平台在日本提供 Ubie for Hospital。隨著業務增加新的客戶，他們需要一個能夠支援每日部署並提供安全網關以將 Ubie 連接到各種客戶網路和設定的基礎架構。Ubie 評估了可用的選項，並決定使用 Google Kubernetes Engine 中的 Kubernetes。Google Kubernetes Engine Autopilot 是一種模式，它可以全面管理整個叢集的基礎架構並提供按 Pod 計費，為業務更有效率且經濟地運行 Ubie for Hospital 提供了一個引人注目的選項。使用 GKE Autopilot，Ubie 可以消除配置和監控叢集的需要，而只需為運行的 Pod 付費。這一轉變使 Ubie 的基礎架構成本降低了 20%，而 GKE Autopilot 幫助該公司消除了 Ubie for Hospital 基礎架構維護和升級任務，這些任務可能需要數小時甚至數天才能完成。在 Google Cloud 上運行容器化應用程式的另一個熱門選項是 Cloud Run。Cloud Run 是一個完全託管的無伺服器平台，用於部署和運行容器化應用程式，而無需擔心底層基礎架構。在您的應用程式程式碼容器化並部署到 Cloud Run 後，Google Cloud 會自動負責擴展和管理基礎架構。Cloud Run 非常適合運行需要快速根據流量擴展和縮減的無狀態應用程式。這使得 Cloud Run 最適合簡單輕量級的應用程式，例如 Web 應用程式。總而言之，當需要對 Kubernetes 環境進行大量控制並且需要運行複雜的應用程式時，GKE 是理想的選擇。或者，當需要一個簡單、完全託管的無伺服器平台並且可以快速擴展和縮減時，Cloud Run 是理想的選擇。


##### 摘要

* 容器優化雲端應用程式管理，提升敏捷性、安全性及資源利用率。
* Kubernetes (k8s) 可輕鬆管理大量容器，提升應用可靠性，減少管理負擔。
* Google Kubernetes Engine (GKE) 提供託管式 Kubernetes 服務，支援客製化叢集設定。
* Ubie 使用 GKE Autopilot 降低 20% 基礎架構成本，並消除維護升級需求。
* Cloud Run 提供完全託管的無伺服器平台，適用於簡單輕量級應用程式。
* GKE 適合複雜應用程式及需要高度控制的環境；Cloud Run 適合簡單應用程式及需快速擴展縮減的環境。
...
> 雲端應用的現代化方法之一是無伺服器運算。無伺服器運算並不意味著沒有伺服器，而是指像計算能力這樣的資源會根據需要在背景中自動配置。優點是組織只有在運行查詢或應用程式時才需要支付計算能力費用。簡單來說，無伺服器意味著企業提供他們想要的任何函數的程式碼，而公有雲提供商則負責其他所有工作。想像一下，您為企業提供軟體來幫助員工管理他們的公司開支。您想添加一個允許使用者上傳其支出收據圖片的功能。在此情況下，上傳圖片的能力稱為函數。您作為軟體開發公司將該函數的程式碼直接編寫到您的公有雲平台中。從那裡，公有雲提供商管理其他所有工作。一種無伺服器運算解決方案稱為函數即服務。某些函數是對特定事件的響應，例如檔案上傳到雲端儲存或資料庫記錄的更改。您編寫定義對這些事件響應的程式碼，而雲端提供商則負責其他所有工作。Google Cloud 提供許多無伺服器運算產品。首先是 Cloud Run，它是一個完全託管的環境，用於運行容器化應用程式。使用此產品，您無需擔心底層基礎架構。然後是 Cloud Functions，它是用於託管簡單的單用途函數的平台，這些函數附加到從您的雲端基礎架構和服務發出的事件。例如，在網站上下訂單時向行動裝置發送通知。還有 App Engine，這是一項用於構建和部署 Web 應用的服務。無伺服器運算有很多好處，例如降低營運成本、可擴展性、更快的上市時間、降低開發成本、改進的彈性，以及按使用付費的定價模式。Mashme.io 使用 Google Kubernetes Engine 來滿足其低延遲、持續整合和部署以及成本效益的需求。


##### 摘要

*   無伺服器運算：按需自動配置資源，僅在使用時付費。
*   函數即服務 (FaaS)：開發者提供函數程式碼，雲端提供商負責其餘工作。
*   Google Cloud 無伺服器產品：Cloud Run (容器化應用程式)、Cloud Functions (事件驅動函數)、App Engine (Web 應用程式)。
*   優點：降低營運成本、可擴展性、加快上市時間、降低開發成本、增強彈性、按使用付費。
*   Mashme.io 案例：使用 Google Kubernetes Engine 實現低延遲、全球覆蓋和持續部署的教育科技視頻協作平台。



#### Quiz

- https://www.cloudskillsboost.google/paths/9/course_templates/265/quizzes/510823
...
> 在課程的上一節中，您探討了使用雲端現代化 IT 基礎架構的優點和選項。現在讓我們專注於應用程式現代化。但首先，什麼是應用程式？基本上，應用程式是一個電腦程式或軟體，幫助使用者完成某件事。在這個數位時代，應用程式無處不在。想想您每天與多少應用程式互動，從檢查電子郵件到使用可穿戴技術追蹤您的健康狀況，這些技術都與您手機上的應用程式連結。客戶期望直覺且功能完善的應用程式，能幫助他們更快地完成任務。應用程式多年來一直在本地開發，而且往往仍然如此。然而，本地的應用程式開發往往會減慢組織的運作速度。在本地的部署應用程式可能非常耗時，也可能需要專業的 IT 團隊。變更的實施通常需要六個月或更長時間，這可能會在組織的不同部門之間造成摩擦。透過雲端技術，企業可以以新的方式現代化、開發和管理應用程式，使其更敏捷，並更能響應使用者的需求。在本課程的這一節中，您將比較傳統和現代的雲端應用程式開發方法。探討在雲端中重新託管遺留應用程式的考量因素和工具。定義應用程式介面 (API)。檢查使用 Apigee API 管理來維護和管理 API 的優點，並考慮混合或多雲策略可能帶來好處的情況。


##### 摘要

* 定義應用程式：幫助使用者完成任務的電腦程式或軟體。
* 本地應用程式開發的缺點：耗時、需要專業團隊、變更實施緩慢（需時六個月以上）。
* 雲端應用程式開發的優勢：敏捷、響應迅速、滿足使用者需求。
* 課程內容：比較傳統與現代雲端應用程式開發方法；探討雲端重新託管遺留應用程式的考量因素和工具；定義 API 及 Apigee API 管理的優點；探討混合或多雲策略的優勢。
...
> 雲端科技的進步徹底改變了軟體應用的開發方式。現代雲端應用程式開發具有彈性、可擴展性，並利用最新的雲端運算技術來建構和部署應用程式。過去，傳統的軟體開發方法，通常稱為單體應用程式，需要將應用程式的所有組件作為單個、緊密耦合的單元進行開發和部署，通常使用單一程式語言。現代雲端應用程式開發方法有很多優點。讓我們探討其中幾點。我們將從架構開始。現代雲端應用程式通常建構為微服務的集合。微服務是可以獨立部署、擴展和維護的組件，可用於建構各種應用程式。這可以幫助組織更快地將商業價值推向市場，因為功能可以在完成後立即發布，而無需等待應用程式的其餘部分完成。關於部署，現代應用程式通常部署到雲端，並且可以使用託管或部分託管的服務。託管服務負責雲端基礎架構的日常管理，例如修補程式、升級和監控。這可以讓員工騰出時間專注於其他任務，例如開發新應用程式。部分託管服務提供混合方法，企業自行管理其基於雲端的應用程式的某些方面，而雲端提供商則管理其他方面。在成本方面，現代雲端應用程式使用按需付費的定價模式，在有效配置的情況下，這可以使其極具成本效益。這意味著組織並不總是需要為他們沒有充分利用的資源付費。開發人員還可以利用預建 API（我們稍後將在本課程的這一部分中探討）和雲端提供商提供的其他工具來更快地建構和部署其應用程式。然後是可擴展性。現代基於雲端的應用程式可以輕鬆地向上或向下擴展以滿足用戶需求。現代雲端應用程式旨在具有高可用性和彈性，並具有負載平衡（將網路流量均勻分佈到支援應用程式的多個伺服器上的過程）和自動故障轉移（允許基於雲端的應用程式在發生故障時自動切換到備份伺服器上的過程）等內建功能。此外，雲端服務提供商通常提供強大的監控和管理工具，允許開發人員快速識別和響應問題，這可以進一步提高雲端應用的可靠性。


##### 摘要

*   **架構:**  採用微服務架構，獨立部署、擴展及維護，加快產品上市速度。
*   **部署:**  雲端部署，提供託管及部分託管服務，降低管理負擔。
*   **成本:**  按需付費模式，提高成本效益。
*   **開發:**  利用預建API及雲端工具，加快開發速度。
*   **可擴展性:**  彈性擴展，滿足用戶需求。
*   **可靠性:**  高可用性及彈性，內建負載平衡及自動故障轉移機制。
*   **監控:**  提供強大監控及管理工具，快速響應問題。
...
> 企業決定將營運現代化並遷移至雲端時，可能正在運行數個與雲原生應用程式不相容的專用舊版應用程式。在這些情況下，企業可能會採用重新託管遷移路徑（通常稱為「直接遷移」），將應用程式從本地環境遷移到雲端環境，而無需對應用程式本身進行任何更改。重新託管應用程式帶來了我們之前探討過的許多雲計算優勢，例如成本節省、可擴展性、可靠性和安全性。但是，為舊版應用程式選擇重新託管遷移路徑也有一些潛在缺點，包括：複雜性：重新託管可能是一個複雜的過程。企業需要仔細規劃遷移過程，並確保他們擁有適當的資源。風險：將應用程式遷移到雲端總是存在一些風險。企業需要仔細評估和識別潛在風險，並確保他們有應對任何問題的計劃。供應商鎖定：通過將應用程式遷移到雲端，企業可能會被鎖定到特定的雲供應商。這可能會使以後切換供應商變得困難。Google Cloud 提供許多用於重新託管專用舊版應用程式的解決方案。首先是 Google Cloud VMware Engine，它有助於將現有的 VMware 工作負載遷移到雲端，而無需重新架構應用程式或重新調整運作。借助 Google Cloud VMware Engine，組織可以維持其現有的 VMware 環境和運作流程，同時受益於 Google Cloud 的可擴展性、安全性、可靠性。通過這樣做，組織還可以訪問一系列 Google Cloud 服務，例如 BigQuery、AI/ML 和 Google Kubernetes Engine，這讓他們可以使應用程式環境現代化，並根據需要使用新的功能和技術。對於擁有 Oracle 舊版應用程式的組織，Google Cloud 提供裸機解決方案。這是一個完全託管的雲端基礎架構解決方案，讓組織可以在雲端的專用裸機伺服器上運行其 Oracle 工作負載。


##### 摘要

*   將舊版應用程式遷移至雲端(重新託管/直接遷移)的優點：成本節省、可擴展性、可靠性和安全性。
*   重新託管的潛在缺點：
    *   過程複雜，需仔細規劃及資源配置。
    *   存在遷移風險，需有應對計劃。
    *   可能造成供應商鎖定。
*   Google Cloud 提供的重新託管解決方案：
    *   Google Cloud VMware Engine：無需重新架構應用程式即可遷移 VMware 工作負載，並可使用 Google Cloud 服務。
    *   裸機解決方案：在雲端專用裸機伺服器上運行 Oracle 工作負載。
...
> 軟體服務的實作複雜且多變，如果每個軟體服務都需要針對每個實作編寫程式碼，則結果可能脆弱且容易出錯。使用 API 或應用程式介面程式設計介面可以簡化流程。雲端供應商提供各種資源和服務，用於在雲端中執行應用程式和執行計算任務。然而，為了充分利用這些資源和服務，應用程式需要能夠以標準化且有效的方式與它們互動。這就是 API 的用途。API 是一組指令，讓不同的軟體程式可以互相通訊。它就像兩個不同程式之間的媒介，提供標準化且可預測的方式讓它們交換數據和互動。API 就像餐廳裡的服務生，服務生從顧客那裡接單，與廚房溝通，然後將食物送回給顧客。同樣地，API 從一個軟體程式（顧客）接收請求，與另一個程式（廚房）溝通，然後將回應（食物）送回給請求程式（顧客）。API 可用於許多不同的應用程式，從社群媒體平台到行動應用程式和網路服務。它們讓開發人員可以存取其他程式的功能和數據，而無需自行編寫所有程式碼，從而節省時間和精力。Google 本身提供了許多 API，讓開發人員可以存取其產品和服務。這些包括使用 Google 的功能在網站或網站集合中搜尋的 API、讓開發人員存取 Google 地圖數據（例如地圖、路線和交通資訊）的 API，以及讓開發人員將文字從一種語言翻譯成另一種語言的 API。事實上，許多 Google Cloud 產品和服務都有文件記錄的 API。使用 API 可以為組織創造新的商機，並改善使用者的線上體驗。例如，組織可以公開一個 API，讓客戶可以在第三方應用程式中追蹤他們的貨件或檢查他們的帳戶餘額。組織也有機會創造新產品，讓其他公司可以透過 API 存取其數據或服務。讓我們來探討組織為何會考慮這個商機。API 可用於創建新的產品和服務。組織可以創建一個 API，允許開發人員存取其數據庫中的數據。然後可以使用這些數據來創建新的產品和服務。API 可用於產生新的收入來源。組織可以向開發人員收取存取其 API 的費用。這可以為組織產生新的收入來源，並有助於抵消開發和維護 API 的成本。API 可以建立合作夥伴關係。透過公開 API，組織可以與其他公司或開發人員建立合作夥伴關係，這可以帶來新的商機和合作。透過仔細考慮客戶和合作夥伴的需求，組織可以開發提供價值並有助於業務增長的 API。


##### 摘要

*   軟體服務實作複雜且易變，API 提供標準化且有效率的程式間溝通方式。
*   API 作為程式間媒介，標準化數據交換與互動流程，如同餐廳服務生。
*   API 應用廣泛，涵蓋社群媒體、行動應用程式與網路服務等。
*   API 讓開發者能存取其他程式功能與數據，節省開發時間與成本。
*   Google 提供許多 API 供開發者存取其產品與服務，例如地圖、翻譯等。
*   API 能創造新的商機，例如客戶追蹤貨件、帳戶餘額查詢等功能。
*   API 可建立新產品和服務，產生新的營收來源。
*   API 可促進組織間合作夥伴關係，拓展業務機會。
...
> 企業導入API後，有效維護和管理至關重要。可以使用Apigee API管理平台（Google Cloud的API管理服務）來操作API，以增強規模、安全性及自動化。Apigee是許多組織管理API的熱門選擇，因为它具有許多優點，例如：提供身份驗證、授權和數據加密等功能來保護API；透過即時分析和歷史報告追蹤和分析API使用情況；透過視覺化API編輯器和測試沙盒來協助開發和部署API；提供API版本控制、API文檔，甚至API節流（限制用戶在特定時間段內可以發送的API請求數）。AccuWeather透過API與全球合作夥伴共享其世界級的天氣數據，這些合作夥伴開發了適用於互聯汽車、智慧家居、穿戴式設備、智慧電視、行動裝置等的應用程式，獲得了巨大的成功。但公司希望將數據提供給新的客戶：個別開發人員。它需要一種方法來吸引這些用戶，並根據開發人員的不同需求調整其產品，並據此將不同的產品級別貨幣化。為實現讓開發人員以簡單快速的方式開始構建，並根據其需求提供適當級別的API呼叫和功能，AccuWeather意識到需要一個精密的API管理平台。該平台能夠通過將API捆綁到不同的產品中來提供不同層次的產品，每個產品都有自己的速率限制和定價。借助Apigee管理API，AccuWeather的用戶可以根據自身需求自定義API使用情況，而Apigee則有助於吸引和建立流量。借助可自定義的Apigee開發人員入口網站，開發人員可以快速註冊、了解AccuWeather API並測試它們。借助內建分析功能，AccuWeather可以密切關注註冊用戶、他們產生的流量及其來源，並觀察流量活動中的意外模式。


##### 摘要

*   有效管理API對組織至關重要。
*   Apigee平台提供增強規模、安全性及自動化API管理。
*   Apigee優點包括：API安全防護、使用情況追蹤分析、開發部署支援、版本控制及節流功能。
*   AccuWeather使用Apigee管理API，以服務個別開發者，並根據不同需求調整產品及定價。
*   Apigee協助AccuWeather吸引開發者，並透過自定義開發者入口網站簡化註冊和測試流程。
*   內建分析功能讓AccuWeather監控用戶註冊、流量及使用模式。
...
> 本課程中，我們已多次看到，組織機構可以藉助雲端蓬勃發展。但事實是，世界上大部分的企業運算仍然發生在本地。邁向雲端的道路可能複雜且充滿艱難的決策，有時由於合規或營運方面的考量，工作負載仍保留在本地。組織機構如何在不完全遷移到雲端的狀況下，現代化其 IT 基礎架構？他們如何保持彈性並避免被鎖定？混合雲和多雲解決方案是兩種選擇。混合雲環境包含本地或私有雲基礎架構與公有雲服務的某些組合。許多組織目前都處於這種情況，他們的一些數據和應用程式已遷移到雲端，而其他數據和應用程式則保留在本地。私有雲和公有雲之間的互連允許互操作性。多雲環境是指組織在其架構中使用多個公有雲提供商。這對於需要在不同網路之間實現彈性和安全連接的組織來說非常理想。如果組織想要整合公有雲的特定元素以從該提供商的主要優勢中受益，則可能會選擇使用混合雲、多雲或兩者的組合。這讓組織可以將系統基礎架構的部分保留在本地，同時將其他部分遷移到雲端。通過這種方式，他們可以創建一個獨特地滿足組織需求的環境。僅將特定的工作負載遷移到雲端，因為不需要全面遷移即可發揮作用，從雲端服務提供的靈活性、可擴展性和較低的運算成本中受益，以運行特定的工作負載。向組織的運算資源工具包添加專門服務，例如機器學習、內容快取、數據分析、長期儲存和物聯網 (IoT)。Google Cloud 如何在此背景下提供幫助？Google 對現代混合和多雲分散式系統和服務管理的答案稱為 GKE Enterprise。GKE Enterprise 是一個受管理的、生產就緒的平台，用於跨多個雲環境運行 Kubernetes 應用程式。它提供了一種一致的方式來管理 Kubernetes、叢集、應用程式和服務，無論它們運行在哪裡。GKE Enterprise 的一些優點包括多雲和混合雲支援。GKE Enterprise 可以運行 Google Cloud、AWS、Azure 和其他公有雲上的 Kubernetes 叢集。集中式管理 GKE Enterprise 提供單一集中式主控台來管理 Kubernetes 叢集和應用程式、安全性和合規性。GKE Enterprise 包含許多有助於保護 Kubernetes 叢集和應用程式並符合行業規範的功能，網路和負載平衡。GKE Enterprise 包含許多有助於網路和負載平衡 Kubernetes 應用程式的功能，監控和日誌記錄 GKE Enterprise 提供一套豐富的工具，用於監控和維護整個網路（無論是在本地、雲端還是在多個雲端）上的應用程式一致性。


##### 摘要

*   企業運算多位於本地，遷移至雲端過程複雜。
*   混合雲整合本地與公有雲，多雲則使用多個公有雲供應商。
*   彈性調整，僅遷移特定工作負載至雲端。
*   善用雲端服務的靈活性、可擴展性及較低成本。
*   GKE Enterprise 提供跨多雲環境的 Kubernetes 應用程式管理平台。
*   GKE Enterprise 支援多雲與混合雲、集中管理、安全合規、網路負載平衡及監控日誌記錄。


#### Quiz

- https://www.cloudskillsboost.google/paths/9/course_templates/265/quizzes/510830
...
> 本課程帶領您完成了 Google Cloud 的現代化基礎架構和應用程式課程。讓我們快速回顧一下。課程的第一部分，即課程介紹，您探討了一些重要的雲端遷移術語。第二部分，即雲端現代化基礎架構，您瞭解了在雲端運行計算工作負載的好處、虛擬機器、容器及其管理方式，以及無伺服器運算。在課程的最後一部分，即雲端現代化應用程式中，您學習了現代雲端應用程式開發的好處、在雲端重新託管舊版應用程式、使用 Apigee 進行 API 和 API 管理，以及使用混合雲和多雲解決方案。現在，您已經全面了解如何在 Google Cloud 上現代化基礎架構和應用程式，您可以繼續學習本系列課程的下一個課程：Google Cloud 的信任和安全，您將學習基本的雲端安全概念、Google 多層次基礎架構安全方法，以及 Google Cloud 如何努力贏得並維護客戶對雲端的信任。我們下次見。


##### 摘要

* **課程介紹:** 學習重要的雲端遷移術語。
* **雲端現代化基礎架構:** 瞭解雲端運算工作負載的好處、虛擬機器、容器管理和無伺服器運算。
* **雲端現代化應用程式:** 學習現代雲端應用程式開發的好處、舊版應用程式雲端重新託管、Apigee 的 API 與 API 管理，以及混合雲和多雲解決方案。
* **後續課程:**  將學習 Google Cloud 的信任和安全，包含雲端安全概念、Google 的多層次安全方法和客戶信任維護。
...
> 在 Google Cloud，我們了解託管、服務和保護客戶寶貴數據的責任。隨著組織越來越多地將其數據和應用程式遷移到雲端，解決新興的安全挑戰至關重要。信任和安全是我們產品設計和開發理念的核心。我們堅信我們的客戶擁有其數據，並完全控制其使用方式。儘管我們已實施強大的安全措施以防範潛在的漏洞，但我們也承認安全是一個動態且持續的過程，需要持續關注和投資。為支援您完成此旅程，我們提供一系列安全產品和服務，使您能夠檢測、調查和減輕網絡威脅，同時符合您的政策、法規和業務目標。本課程「與 Google Cloud 建立信任和安全」的目標是讓您掌握必要的知識和技能，以討論基本的雲端安全概念，解釋 Google 多層次基礎架構安全方法的業務價值，以及說明 Google Cloud 如何贏得並維持客戶對雲端的信任。在整個課程中，您將參加分級的知識評估。您必須通過這些評估才能獲得課程學分。好的，讓我們開始吧！


##### 摘要

* 了解 Google Cloud 託管客戶數據的責任。
* 強調客戶數據所有權和控制權。
* 著重於持續的安全投資和動態安全流程。
* 提供一系列安全產品和服務，以檢測、調查和減輕威脅。
* 本課程目標：學習雲端安全概念、Google 多層次安全方法的價值，以及 Google Cloud 如何建立客戶信任。
* 課程包含分級知識評估，需通過才能獲得學分。
...
> 近年來，雲端運算的興起改變了組織儲存、處理和管理數據的方式。然而，隨著對雲端依賴性的增加，強大的安全措施也變得至關重要。保護雲端中的數據、應用程式和基礎架構是一項複雜且不斷發展的挑戰。隨著新的威脅和漏洞出現，組織必須保持領先地位，並調整其安全策略以有效降低風險。在本課程章節中，您將定義關鍵的安全術語和概念，描述機密性、完整性、可用性、控制和合規性在雲端安全模型中的重要性，區分雲端安全和傳統本地安全，並描述當今主要的網路安全威脅及其業務影響。


##### 摘要

* 定義雲端安全關鍵術語及概念。
* 闡述機密性、完整性、可用性、控制和合規性在雲端安全模型中的重要性。
* 區分雲端安全與傳統本地安全之差異。
* 說明當今主要的網路安全威脅及其對企業的影響。
...
> 雲端安全領域中，了解相關術語對於有效掌握整體環境至關重要。本課將介紹討論雲端安全時常見的基本安全術語和概念。讓我們來探討這些術語及其重要性。前三個概念與降低未經授權存取敏感資料的風險有關。特權存取安全模型允許特定使用者存取比一般使用者更廣泛的資源集。例如，系統管理員可能擁有特權存取權限以執行疑難排解和資料還原等任務。然而，濫用特權存取權限可能會造成風險，因此務必仔細管理和監控此類存取權限。最小權限安全原則提倡僅授予使用者執行其工作職責所需的存取權限。透過提供最低限度的必要存取權限，組織可以降低未經授權存取敏感資料的風險。例如，銷售代表可能只需要存取客戶關係管理 (CRM) 系統，而無需存取薪資或財務等其他系統。零信任架構安全模型假設預設情況下不信任任何使用者或裝置。每個使用者和裝置都必須經過驗證和授權才能存取資源。零信任架構透過實施嚴格的存取控制和持續驗證使用者身分，有助於確保穩健的安全性。接下來三個概念與組織如何防範網路威脅有關。預設安全性是一項原則，強調從開發的初始階段就在系統和應用程式中整合安全措施。透過在整個過程中優先考慮安全性，組織可以在其雲端環境中建立穩固的安全基礎。安全態勢是指雲端環境的整體安全狀態。它透過評估其安全控制、政策和實務，來指示組織防禦網路攻擊的準備程度。網路韌性是指組織承受並快速從網路攻擊中復原的能力。這包括識別、評估和減輕風險，有效回應事件以及快速從中斷中復原。最後，讓我們來探討保護雲端資源免於未經授權存取的基本安全措施。防火牆是一種根據預定義安全規則來調節網路流量的網路裝置。您可以將防火牆想像成網路的安全警衛。它遵循某些規則來決定允許哪些流量進入或離開網路。這些規則有助於防止未經授權的人員或有害的事物遠離重要的雲端資源，例如伺服器、資料庫和應用程式。延續之前的比喻，安全警衛會檢查所有想要進入的人，只允許有權限的人進入。同樣地，防火牆會檢查網路中的進出流量，只允許安全且經授權的流量通過。加密是使用加密演算法將資料轉換為不可讀格式的過程。然而，解密是使用加密金鑰將加密資料還原為其原始格式的反向過程。保護加密金鑰至關重要，因為它持有解密資料所需的秘密演算法。另一種思考加密和解密的方法是撰寫只有您和您想要傳送的人才能理解的秘密語言訊息。這樣，即使有人攔截訊息，他們也無法閱讀，因為他們不知道秘密語言。


##### 摘要

*   **降低未經授權存取風險：**
    *   特權存取安全模型 (Privileged Access Security Model)
    *   最小權限安全原則 (Principle of Least Privilege)
    *   零信任架構 (Zero Trust Architecture)
*   **防範網路威脅：**
    *   預設安全性 (Security by Default)
    *   安全態勢 (Security Posture)
    *   網路韌性 (Cyber Resilience)
*   **保護雲端資源：**
    *   防火牆 (Firewall)
    *   加密 (Encryption) 和 解密 (Decryption)
...
> 本課將學習構成雲端安全模型的組成部分，並了解它們如何在當今數位環境中促進穩健的安全態勢。我們首先探討安全的三个基本面向：機密性、完整性和可用性。這三個原則構成了「CIA 三元組」的基礎，這是一個廣泛使用的有效安全系統開發模型。「CIA 三元組」強調保護敏感資訊、確保數據準確性和可信賴性以及維護對資源和服務的不間斷訪問的重要性。透過了解和實施措施以應對這些面向，組織可以建立強大的安全框架來保護其數位資產。機密性是指保護重要資訊的安全和機密性。它確保只有授權人員才能訪問敏感數據，無論數據儲存或傳輸位置為何。在雲端中，機密性至關重要，因為儲存在雲端環境中並透過其傳輸的敏感資訊必須受到保護，防止未經授權的訪問或洩露。加密在確保雲端機密性方面發揮著至關重要的作用。透過使用加密技術和保護加密金鑰，組織可以確保只有授權人員才能訪問和解密敏感數據，有效降低雲端數據洩露的風險。完整性意味著保持數據的準確性和可信賴性。它確保資訊不會被更改或損壞，無論其儲存位置或移動方式為何。您可以將其視為確保訊息在傳輸過程中不會被更改。雲端中的完整性涉及確保數據在其整個生命週期中的準確性和可信賴性。實施數據完整性控制（例如校驗和或數位簽章）使組織能夠驗證其雲端數據的真實性和可靠性。這有助於防止未經授權的修改或篡改，確保儲存在雲端環境中並在其處理的關鍵資訊的完整性。可用性是指確保雲端系統和服務始終可供合適的人員在需要時使用。這就像擁有一個永不間斷的可靠電力供應。雲端環境必須設計具有冗餘、故障轉移機制和災難恢復計劃，以最大限度地提高可用性並最大限度地減少停機時間。透過實施這些措施，組織可以確保其雲端中的系統和應用程式在需要時始終可用，即使面臨潛在中斷也能促進業務連續性。控制是指為管理和降低安全風險而實施的措施和流程。它涉及建立策略、程序和技術保護措施，以防止未經授權的訪問、誤用和潛在威脅。雲端中的控制措施包括實施強大的身份驗證機制、訪問限制和安全意識培訓。這些措施幫助組織管理和降低與基於雲端的系統相關的安全風險。透過確保只有授權人員才能訪問雲端中的敏感數據和系統，組織可以降低數據洩露和未經授權活動的風險。最後，合規性是指遵守行業法規、法律要求和組織政策。它涉及確保安全實務和措施符合既定標準和指南。滿足雲端中的合規性標準證明了組織對數據隱私和安全的承諾，增強與利益相關者的信任，並最大限度地降低法律和財務風險。雲端供應商通常提供合規框架和認證，組織可以利用這些框架和認證來滿足其法規義務。透過將這些原則整合到全面的雲端安全模型中，組織可以建立一個堅實的基礎，以保護其數據、維護數據完整性並確保持續訪問關鍵資源。


##### 摘要

*   **機密性 (Confidentiality):** 保護敏感資訊，防止未經授權存取。
*   **完整性 (Integrity):** 確保數據準確性及可信賴性，防止數據被竄改。
*   **可用性 (Availability):** 保證系統及服務隨時可用。
*   **控制 (Control):**  實施措施管理及降低安全風險，包含身份驗證、存取控制及安全培訓。
*   **合規性 (Compliance):** 遵守相關法規、政策及標準。
...
> 過去，企業嚴重依賴自身的基礎架構和本地數據中心來管理和保護其數位資產。他們完全控制自己的硬體、軟體和網路組件，在其場地內培養信任感。然而，隨著組織現在與全球各地的客戶、合作夥伴和員工進行數位連接，新的風險已經出現，需要增強的安全措施。這就是雲安全發揮作用的地方，它提供與傳統本地安全不同的方法。讓我們探討這些重要的差異。首先是位置。雲安全涉及在由雲服務提供商運營的異地數據中心託管和管理數據和應用程式。保護基礎架構和底層硬體的責任在於雲提供商。相反，傳統的本地安全涉及在組織自己的伺服器和基礎架構上本地託管和管理數據和應用程式，授予直接控制和保護實體和虛擬環境的責任。接下來是責任。在雲模型中，雲服務提供商負責保護基礎架構、網路和物理設施。客戶通常負責保護其數據、應用程式、使用者存取和配置。另一方面，在本地設置中，組織負責保護整個基礎架構，包括硬體、網路、作業系統、應用程式和數據。接下來的區別是可擴展性。雲安全提供可擴展性和彈性，允許組織根據需求輕鬆擴展或縮減其資源。這種靈活性適用於動態工作負載和快速增長。相反，本地安全需要組織配置和維護自己的基礎架構，當他們擴展或縮減時，這可能更費時費力。接下來是維護和更新。雲服務提供商處理基礎架構維護，包括安全更新、修補程式和軟體升級。客戶可以專注於管理他們的應用程式和數據，而無需擔心底層基礎架構。本地環境需要組織維護和更新他們自己的基礎架構，包括定期執行修補程式、軟體更新和硬體升級等任務。最後的區別是資本支出。雲安全遵循營運支出 (OpEx) 模型，組織按訂閱方式支付他們使用的服務費用。這消除了對實體安全基礎架構進行大量前期資本投資的需求。傳統的本地安全模型涉及大量的資本支出 (CapEx)，因為組織必須購買和維護自己的安全基礎架構。了解雲安全和傳統本地安全之間的這些差異，可以幫助組織根據自身特定需求做出明智的決定。雲安全提供諸如卸載基礎架構管理、可擴展性和成本靈活性等優點。但是，傳統的本地安全提供對整個基礎架構的直接控制。組織必須仔細評估其需求，並考慮數據敏感性、合規性法規和可擴展性等因素，以確定最有效的業務安全策略。


##### 摘要

* **位置：** 雲安全：異地數據中心；本地安全：組織本地伺服器。
* **責任：** 雲安全：雲端供應商負責基礎架構，客戶負責數據及應用程式；本地安全：組織負責所有層面安全。
* **可擴展性：** 雲安全：彈性擴展；本地安全：擴展受限，需自行配置維護。
* **維護更新：** 雲安全：雲端供應商負責；本地安全：組織自行負責。
* **資本支出：** 雲安全：營運支出 (OpEx)；本地安全：資本支出 (CapEx)。
...
> 今日瞬息萬變的數位世界，充斥著吸睛的標題。「CEO  beware：事業毀滅性網路攻擊的危險」、「零售商因數據洩露後果支付高達 1.79 億美元」、「信用評級機構解決美國數據洩露事件，面臨高達 7 億美元的罰款」。網路攻擊領域日新月異，這些威脅可能來自意想不到的來源，甚至偽裝成政府機構。那麼，組織面臨哪些常見的網路安全威脅呢？首先是欺騙性的社會工程學。想像一下，一個熟練的操縱者試圖從毫無戒心的個人手中竊取機密系統信息。這些網路罪犯使用「釣魚攻擊」，收集您、您的員工或您的學生的個人資料。他們巧妙地製作量身定制的電子郵件並模仿真實性以欺騙目標。因此，貴組織中的任何人都可能被誘騙無意中下載惡意附件、洩露密碼或洩露敏感數據。其次是物理損壞。無論是硬體組件損壞、電源中斷，還是洪水、火災和地震等自然災害，組織都負有保護數據的責任，即使面臨物理逆境。您可以將其視為在自然界無情的力量中保護寶貴資產。另一種威脅是惡意軟體、病毒和勒索軟體。這些數位對手在網路領域製造混亂。他們使用惡意軟體，旨在破壞運作、造成損害或未經授權訪問電腦系統。其中最陰險的是勒索軟體，關鍵檔案被扣押，直到支付大量贖金。這就像目睹了精心策劃的敲詐勒索計劃的數位等價物。接下來的網路安全威脅是易受攻擊的第三方系統。想像一下，將一個值得信賴的盟友邀請到您的領域，卻發現他們無意中危害了您的安全。許多組織依靠第三方系統來執行基本功能，例如財務、庫存管理或帳戶操作。但是，如果沒有足夠的安全措施和定期評估，這些系統可能會變成潛在威脅，使數據安全變得脆弱。這就像使用一種無意中給您自己的珍貴財物帶來風險的工具。最後一種威脅是配置錯誤。即使是最經驗豐富的專家也會犯錯。配置錯誤是指在資源設置或配置過程中出現錯誤，無意中使敏感數據和系統暴露於未經授權的訪問。調查 consistently 發現配置錯誤是雲安全最主要的威脅。因此，採用最小權限和特權訪問原則至關重要，因為它們僅在明確需要和授權時才允許資源訪問。這就像只授予那些贏得您信任的人訪問權限。隨著科技日新月異，組織必須投資於正確的專業知識，以評估、開發、實施和維護穩健的數據安全計劃。


##### 摘要

* 欺騙性社會工程學：釣魚郵件等，騙取個人信息。
* 物理損壞：硬體損壞、電源中斷及自然災害。
* 惡意軟體、病毒和勒索軟體：破壞系統，竊取數據，勒索贖金。
* 易受攻擊的第三方系統：缺乏安全措施的第三方系統構成威脅。
* 配置錯誤：資源設置或配置錯誤導致數據洩露。


#### Quiz

- https://www.cloudskillsboost.google/paths/9/course_templates/945/quizzes/487306
...
> 在 Google Cloud，我們相信不應單純依靠單一技術來確保安全。我們的多層次策略建立漸進式安全層，結合全球資料中心、專用伺服器、客製化安全硬體和軟體，以及雙步驟驗證。此方法提供真正的縱深防禦。在本課程單元中，您將學習 Google 如何利用專用伺服器、網路和客製化安全硬體和軟體設計和建構其自身的資料中心，加密在保護組織資料中扮演的角色及其保護處於不同狀態的風險暴露資料的方式，驗證、授權和稽核之間的差異，使用雙步驟驗證和身分與存取管理 (IAM) 的好處，組織如何利用 Google 產品防範網路攻擊，以及雲端安全作業及其相關的商業利益。


##### 摘要

* Google Cloud 採用多層次安全策略，結合全球資料中心、專用伺服器、客製化安全硬體及軟體與雙步驟驗證，實現縱深防禦。
* 學習 Google 資料中心的設計與建構，包含專用伺服器、網路及客製化安全硬體和軟體。
* 了解資料加密在保護資料安全，以及應對不同風險狀態資料暴露的機制。
* 釐清驗證、授權和稽核的差異。
* 說明雙步驟驗證和身分與存取管理 (IAM) 的優勢。
* 探討如何利用 Google 產品防範網路攻擊。
* 了解雲端安全作業及其商業效益。
...
> 數據中心不只是堆滿電腦的設施，更是 Google 服務（包括搜尋、Gmail 和 YouTube 等）全天候運作的基石，也是 Google Cloud 提供所有服務的數據儲存和處理中心。目前 Google 在全球營運超過 30 個最先進的數據中心，部分仍在建設中。這些先進設施經過精心設計，以提供卓越的可靠性、頂級安全性及出色的效率，確保 Google 的服務隨時可用。此外，Google 致力於將數據中心的環境影響降至最低，透過使用尖端技術和可再生能源，努力減少我們的生態足跡。讓我們探討 Google 設計和建造自身數據中心、使用專用伺服器、先進網絡解決方案以及自訂安全硬件和軟件的好處。其中一個最大優勢是實施零信任架構，確保各個層次的安全性得到提升。我們的自訂硬件和軟件均配備防篡改硬件、安全啟動和基於硬件的加密等功能，從而在數據中心環境中建立強大的安全態勢。實體安全性同樣至關重要，已實施強大的存取控制措施和生物識別身份驗證。透過採用最小權限原則，只有授權人員才能進入數據中心，從而最大限度地降低實體入侵的風險，並維護特權存取框架。此外，我們的數據中心體現了預設安全的概念。從您踏入 Google 數據中心的那一刻起，您可以相信每個方面都是以您的安全為設計和實施理念。以網絡彈性為核心原則，我們的數據中心能夠承受和恢復潛在的安全事件，並確保數據的連續性和完整性。效率是數據中心設計的另一個重要方面。專用伺服器針對特定任務進行優化，使其能夠以極高的速度和效率運行。這減少了能源消耗，降低了營運成本，並節省了資源和環境。事實上，我們透過能源使用效率 (PUE) 分數來衡量我們的成功。透過不斷努力追求最低的 PUE 分數，我們確保數據中心的效率最大化，從而大幅節省成本並減少碳足跡。例如，我們位於芬蘭哈米納的數據中心是我們數據中心群中最高級和最有效的設施之一。其創新的冷卻系統利用芬蘭灣的海水，為全球能源效率樹立了新的標準。可擴展性是另一個好處。我們的數據中心可以快速無縫地容納新的硬件和伺服器，從而使我們能夠按需擴展計算資源。這種靈活性對於 Google 處理海量數據和流量至關重要，而且不會中斷服務。此外，管理我們自己的伺服器和網絡為我們提供了無與倫比的定制能力。這種靈活性使我們能夠提供其他提供商無法提供的獨特服務和功能，讓您可以使用獨家功能和創新。儘管設計和建造數據中心需要大量的預期投資，但長遠的好處是巨大的。透過優化資源以提高效率和可擴展性，Google 可以大幅降低能源消耗和營運成本，從而隨著時間推移帶來可觀的節省。


##### 摘要

*   Google數據中心支撐Google搜尋、Gmail、YouTube及Google Cloud服務之運作。
*   全球超過30個數據中心，注重可靠性、安全性及效率。
*   致力於使用再生能源，降低環境影響。
*   採用零信任架構及自訂硬體軟體，提升安全性，包含防篡改硬體、安全啟動及硬體加密等。
*   實施最小權限原則及生物識別驗證，加強實體安全。
*   數據中心設計以預設安全為核心，並具備網絡彈性，能承受及復原安全事件。
*   使用專用伺服器，提升效率，降低能源消耗及營運成本，並以PUE分數衡量效率。
*   芬蘭哈米納數據中心採用海水冷卻系統，節省能源。
*   數據中心具備可擴展性，能按需擴展計算資源。
*   自行管理伺服器和網絡，提供獨特服務和功能。
*   前期投資高，但長期效益顯著，可降低能源消耗及營運成本。
...
> 以前，我們了解加密就像一種密碼，使用特殊的演算法將數據轉換成無法讀取的格式。此過程確保只有擁有正確密鑰或密碼的人才能理解數據。這就像使用秘密語言來保護您的資訊。透過加密您的數據，您可以保護它免受各種風險，例如未經授權的存取、遺失或損壞。想像您的數據被鎖在保險箱裡。沒有正確的鑰匙，就沒有人可以竊取、篡改，甚至理解裡面的資訊。讓我們更仔細看看加密如何在不同狀態下保護您的數據。當數據靜止時，它儲存在物理設備上，例如電腦或伺服器。透過加密靜止數據，即使有人獲得設備的物理存取權，也無法在沒有加密金鑰的情況下解密數據。在 Google Cloud，我們會自動加密所有客戶的靜止數據，無需您任何操作。這是一項免費且內建的功能，可為您的寶貴數據增加額外的保護層。如果您更偏好自行管理加密金鑰，您可以使用我們的 Cloud Key Management Service (Cloud KMS) 以獲得額外的控制權。當數據傳輸中時，它正在網路或網際網路上移動。加密在此扮演著至關重要的角色，它可以保護您的數據免受網路罪犯或未經授權的方的攔截。這就像將您的資訊放在一個只有預期接收者才能打開的鎖定箱中。在 Google Cloud，我們採用強大的安全措施來確保您的數據在傳輸過程中的真實性、完整性和隱私性。我們在多個網路層加密和驗證數據，尤其是在數據傳輸到我們控制範圍以外的物理邊界時。這樣，您的資訊在穿梭於數位世界時就能保持安全。使用中的數據是指正在由電腦主動處理的數據。加密使用中的數據會增加另一層保護，尤其針對可能實際存取電腦的未經授權的使用者。我們使用一種稱為記憶體加密的技術，將您的數據鎖在電腦的記憶體中，使未經授權的使用者幾乎不可能存取它。談到加密演算法，進階加密標準 (AES) 成為了中心。AES 是一種強大的加密演算法，受到全球政府和企業的信賴。這就像擁有一種最高機密的加密方法，可以保護您的數據免受窺探。因此，無論您的數據是靜止、傳輸中還是正在使用中，加密都會充當您忠誠的守護者，因為它確保了數據的機密性和保護。在 Google Cloud，我們非常重視加密，為您提供您可以信賴的安全儲存解決方案。


##### 摘要

*   加密將數據轉換為無法讀取的格式，保護數據安全。
*   靜止數據 (儲存於設備)：Google Cloud 自動加密所有客戶靜止數據，亦可使用 Cloud KMS 自行管理金鑰。
*   傳輸中數據 (網路傳輸)：Google Cloud 使用多層網路加密保護數據。
*   使用中數據 (電腦處理)：使用記憶體加密技術保護數據。
*   Google Cloud 使用 AES 加密演算法，確保數據安全。
...
> 雲端身分識別管理中，驗證、授權和稽核這三個重要的面向，常被稱為三個 A，用於確保安全存取、管理使用者權限和監控資源使用情況。首先是驗證，它如同門衛，驗證尋求存取的使用者或系統的身分。驗證涉及提供獨特的憑證，例如密碼、實體代幣或生物特徵數據（例如指紋或聲紋識別）。這就像在進入限制區域之前出示您的身分證一樣。伺服器通過驗證提供的憑證，確認您就是您聲稱的那個人。您可能也聽說過的雙步驟驗證（或稱雙因素驗證或多因素驗證），是一種安全功能，為基於雲的系統增加了額外的保護層。啟用雙步驟驗證後，使用者需要提供兩條不同的資訊才能登入。例如，它可以是密碼和通過簡訊、語音呼叫或 Google Authenticator 等應用程式發送到其手機的代碼的組合。即使有人設法獲得您的密碼，此強大功能也能使未經授權的存取更加困難。第二個 A 是授權。在驗證使用者的身分後，授權會介入以確定該使用者或系統允許在系統內執行哪些操作。把它想像成存取控制機制。根據個人的角色、職責和組織層級，不同的權限會分配給個人或群組。例如，系統管理員可能有權限建立和刪除使用者帳戶，而標準使用者可能只能檢視其他使用者的清單。這種細緻的控制確保每個使用者都有適當的存取級別來執行其任務，同時防止未經授權的操作。第三個 A 是稽核（有時稱為會計），它在監控和追蹤系統內的使用者活動方面發揮著關鍵作用。通過收集和分析使用者活動、系統事件和其他數據的日誌，稽核幫助組織檢測異常、安全漏洞和政策違規。它提供了在系統或資源上採取的操作的綜合記錄，這在安全事件調查、合規性追蹤和系統效能評估中非常寶貴。就像購物中心的監控攝影機一樣，稽核密切關注系統內發生的活動。為了提供對誰有權存取 Google Cloud 資源以及他們可以使用這些資源做什麼的細緻控制，組織可以使用身分和存取管理 (IAM)。使用 IAM，您可以建立和管理使用者帳戶、將角色分配給使用者、授予和撤銷資源的權限、稽核使用者活動和監控您的安全狀況。它提供了一種集中且有效的方法來管理 Google Cloud 環境中的存取控制。您可以將 IAM 想像成貴組織的安全總部，配備強大的工具來管理和保護您的數位資產。通過將 IAM 整合到您的 Google Cloud 安全策略中，您可以確保細緻的存取控制、增強的可見性和集中的資源管理。這使您可以有效地保護組織的敏感數據和資源。


##### 摘要

*   **驗證 (Authentication):** 驗證使用者或系統身分，如同門衛，需提供獨特憑證（密碼、實體代幣、生物特徵數據等）。  雙步驟驗證提升安全性。
*   **授權 (Authorization):**  根據角色和職責，決定使用者或系統的許可權，如同存取控制機制，確保使用者僅有必要權限。
*   **稽核 (Auditing):** 監控追蹤使用者活動，偵測異常、安全漏洞和政策違規，如同系統監控攝影機，提供活動記錄。
...
將您的網路擴展到雲端環境時，安全性考量將具有全新的層面。與具有明確周邊界限的傳統本地設定不同，雲端帶來了新的可能性和挑戰。讓我們探討一些策略，以保護您組織的網路，並確保您寶貴的數據和工作負載在 Google Cloud 中的安全。

##### 摘要

* **採用零信任網路：**  透過 Google Cloud 的 BeyondCorp Enterprise 實現零信任安全模型，徹底驗證每個存取請求，考量使用者身份和上下文，嚴格控管內外組織成員對網路和資源的存取。

* **保護與本地和多雲環境的連線：** 使用 Cloud VPN 和 Cloud Interconnect 等服務建立本地網路與 Google Cloud 資源之間的私密安全連線，確保跨環境的安全連線性。

* **利用 Google Cloud 強大的邊界防護工具：** 使用防火牆和虛擬私有雲 (VPC) 服務控制將雲端劃分為不同區段，並利用共用 VPC (Shared VPC) 隔離 Google Cloud 專案，確保安全。

* **使用 Web 應用程式防火牆：**  利用 Google Cloud Armor 提供強大的 DDoS 防護，抵禦針對外部 Web 應用程式和服務的網路攻擊，例如分散式阻斷服務 (DDoS) 攻擊。

* **自動化基礎架構佈建以增強安全性：** 使用 Terraform、Jenkins 和 Cloud Build 等自動化工具建立不可變基礎架構，確保雲端環境的安全性和可靠性，並及時發現和修復問題。
...
> SecOps，簡稱安全運營，旨在保護組織在雲端的數據和系統。它結合了多種流程和技術，有助於降低數據洩露、系統中斷和其他安全事件的風險。可以把它想像成保護寶貴數據的秘密武器。讓我們來探討 SecOps 中一些重要的活動。漏洞管理是識別和修復雲基礎架構和應用程式中安全漏洞的過程，如同定期檢查城堡城牆是否有薄弱之處。Google Cloud 的安全指揮中心 (SCC) 提供了安全態勢的集中視圖，有助於識別和修復漏洞，確保基礎架構穩固且受到保護。另一個關鍵活動是日誌管理，如同在城堡 grounds 上密切關注，尋找任何可疑活動。Google Cloud 提供 Cloud Logging 服務，用於收集和分析來自整個 Google Cloud 環境的安全日誌，幫助檢測和響應任何問題跡象，並預料潛在威脅。當然，為安全事件做好準備同樣重要，這就是事件響應發揮作用的地方。想像一下，有一支隨時準備保衛城堡的騎士隊伍。Google Cloud 擁有跨不同領域的專業事件響應人員，他們配備了應對任何安全事件所需的知識和工具，可以迅速有效地解決問題。SecOps 的另一個重要方面是教育員工了解安全最佳實務。就像教導城堡裡的每個人都要保持警惕並鎖好大門一樣，安全意識培訓通過提高意識和賦能員工來保護自己和組織，從而幫助預防事故。現在，您可能想知道，為什麼您的組織應該實施 SecOps？以下是優點：降低數據洩露風險：SecOps 有助於識別和修復漏洞，從而顯著降低數據洩露的風險。提高正常運行時間：迅速有效的事件響應最大限度地減少了中斷對業務運營的影響，確保服務更順暢、不間斷。增強合規性：SecOps 有助於滿足安全法規，例如通用數據保護條例 (GDPR)，並保持組織的良好聲譽。提高員工生產力：通過教育員工了解安全最佳實務，SecOps 最大限度地減少了人為錯誤的風險，並促進了更安全、更高效的工作環境。SecOps 是組織安全策略中不可或缺的一部分。通過實施 SecOps 實務，您可以加強防禦、降低安全風險並在不斷變化的雲安全環境中保護您的數據。


##### 摘要

*   **漏洞管理:** 識別並修復雲端基礎架構及應用程式的安全漏洞。
*   **日誌管理:** 收集及分析安全日誌，偵測及應對可疑活動。
*   **事件響應:**  迅速有效處理安全事件。
*   **安全意識培訓:** 教育員工安全最佳實務。
*   **優點:** 降低數據洩露風險、提升正常運作時間、增強合規性、提高員工生產力。


#### Quiz

- https://www.cloudskillsboost.google/paths/9/course_templates/945/quizzes/487313
...
> 在 Google，我們深知隱私在贏得和維持信任方面至關重要。客戶需要確信其數據和應用程式安全可靠，因此 Google Cloud 擁有強大的信任原則和合規計劃，旨在保護客戶數據並滿足從小型企業到大型企業等廣泛客戶的需求。在本課程的最後一部分，您將了解 Google 的七大信任原則、Google Cloud 的數據駐留和數據主權選項，以及 Google Cloud 合規資源中心和合規報告管理器如何支持行業和區域合規需求。


##### 摘要

* Google重視隱私，以贏得並維持客戶信任。
* Google Cloud 設有完善的信任原則和合規計劃，保護客戶數據。
*  涵蓋小型企業到大型企業等不同規模客戶的需求。
* 本課程介紹 Google 的七大信任原則。
*  說明 Google Cloud 的數據駐留和數據主權選項。
*  闡述 Google Cloud 合規資源中心和合規報告管理器如何支援各行業和地區的合規要求。
...
在 Google，我們相信透明度，並希望您能完全信任我們的服務。Google Cloud 的信任原則旨在賦予您權力，並確保您的業務數據安全和控制不會受到損害。讓我們回顧這些原則。1. 您的數據屬於您，而不是 Google。我們優先考慮您的控制權，讓您可以訪問、匯出、刪除和管理 Google Cloud 中的數據權限。2. Google 不会將客戶數據出售給第三方。我們會保護您的數據，防止其被用於 Google 的營銷或廣告用途。3. Google Cloud 不會將客戶數據用於廣告。您的數據仍然保密，因為 Google Cloud 確保它永遠不會被用於定向廣告。4. 所有客戶數據預設都會加密。您的數據受到強大的加密保護，因為即使在不太可能發生的未經授權訪問的情況下，Google Cloud 也會保護它。5. 我們防止內部人員訪問您的數據。我們實施嚴格的安全措施，以防止員工未經授權訪問客戶數據。6. 我們絕不會向任何政府機構提供「後門」訪問權限。您的數據保持安全，任何政府機構都無法在沒有適當授權的情況下訪問它。以及 7. 我們的隱私措施已根據國際標準進行審計。我們定期進行審計，以確保符合嚴格的隱私標準。透明度報告和獨立審計透明度是我們對信任承諾的核心要素。我們通過透明度報告提供寶貴的見解和問責制，這些報告揭示了影響隱私、安全和信息訪問的政府和公司行為。這些報告讓您可以隨時了解情況，並保持對我們服務的信任。此外，Google Cloud 接受獨立的第三方審計和認證。此驗證過程確保我們的數據保護措施符合我們的承諾和行業標準。我們參與歐盟雲代碼行為準則等倡議，進一步加強了我們對問責制、合規支持和強大的數據保護原則的承諾。


##### 摘要

* 您擁有您的數據，Google 不擁有。
* Google 不會將客戶數據出售給第三方。
* Google Cloud 不會將客戶數據用於廣告。
* 所有客戶數據預設加密。
* 防止內部人員訪問數據。
* 不會向任何政府機構提供後門訪問。
* 隱私措施符合國際標準並定期審計。
...
> 資料主權和資料駐留是儲存和保護資料時必須理解的兩個重要概念。資料主權指的是資料受其所在地國家法律法規約束的法律概念。例如，歐盟的通用資料保護規範 (GDPR) 要求公司在處理或儲存歐盟公民的個人資料時，無論其所在地點為何，都必須遵守資料保護法規，以確保個人可以控制其個人資料及其用途。相比之下，資料駐留指的是資料儲存或處理的實際位置。有些國家或地區的法律法規要求資料必須儲存在其境內。例如，有些國家規定必須將其公民的個人資料儲存在境內的伺服器上，以確保資料仍受當地法律管轄。現在，讓我們探討 Google Cloud 如何滿足資料駐留要求。我們提供一系列選項，透過區域來控制資料的實際位置。每個區域包含一個或多個資料中心，讓您可以選擇資料的儲存位置。例如，在歐盟內，您可以選擇位於英國、比利時、德國、芬蘭、瑞士和荷蘭等不同國家的區域。透過在特定區域配置您的資源，Google 可確保您的資料僅儲存在所選區域內，如同我們的服務特定條款所述。此外，Google Cloud 提供組織策略約束，加上 IAM 組態，以防止意外將資料儲存在錯誤的區域。這些控制措施可提供安心保障，並加強您的資料駐留要求。此外，Google Cloud 提供 VPC 服務控制等功能，讓您可以根據定義的範圍限制對資料的網路存取。即使使用者已獲得授權，您也可以透過 IP 位址過濾來限制使用者存取。Google Cloud Armor 讓您可以透過新增額外的保護層來限制外部負載平衡器的流量位置。透過使用這些功能，組織可以遵守資料駐留和資料主權要求，確保合規性，並在 Google Cloud 生態系統中控制其寶貴的資料。


##### 摘要

* 資料主權：資料受其所在地國家法律法規約束。
* 資料駐留：資料實際儲存或處理的位置。
* Google Cloud 提供區域選項，控制資料的實際儲存位置。
* Google Cloud 提供組織策略約束和 IAM 組態，防止資料儲存在錯誤區域。
* Google Cloud 提供 VPC 服務控制和 Google Cloud Armor 等功能，限制對資料的網路存取，提升安全性。
*  透過 Google Cloud 的功能，組織可滿足資料主權和資料駐留要求，確保合規並維護資料控制。
...
> 企業遷移至雲端後，保護敏感工作負載並確保符合多元的法規要求和準則至關重要。合規性是雲端旅程中的一個重要面向，因為未滿足法規義務可能造成深遠的後果。為協助您達成合規性，Google Cloud 提供強大的資源和工具，以滿足您的特定需求。首先，讓我們探索 Google Cloud 合規性資源中心。這個全面的中心提供關於我們滿足的認證和合規性標準的詳細資訊。您可以找到我們的安全、隱私和合規性控制項與全球標準的對應關係。此透明度讓您可以驗證我們是否遵守業界領先的作法。資源中心還提供有關區域和特定部門法規的寶貴文件，並讓您能夠瀏覽複雜的合規性環境。想像一下，您是一家受 HIPAA 法規規範的醫療保健機構，該法規保護敏感的病患健康資訊，防止未經病患同意或不知情的情況下被洩露。資源中心為您提供必要的見解和文件，以使您的合規性工作與 HIPAA 要求保持一致。同樣地，如果您在金融部門運作，您將找到有關滿足 PCI DSS（支付卡產業資料安全標準）等法規的指導。Google Cloud 的合規性資源中心是您獲得可行資訊和支援的首選來源。除了資源中心之外，我們還提供合規性報告管理員，這是一個您可以使用的強大工具。這個直覺的平台提供輕鬆、隨需應變地存取重要的合規性資源，且無需額外費用。在合規性報告管理員中，您將發現我們最新的 ISO/IEC 證書、SOC 報告和自我評估。這些資源證明我們遵守嚴格的合規性標準，並有助於簡化您自己的報告和合規性工作。想像一下，您是一家尋求 ISO/IEC 27001 認證的企業。合規性報告管理員讓您可以有效率地存取必要的文檔，並為您在認證過程中節省時間和精力。透過此工具，我們的目標是簡化您的合規性流程，並讓您能夠有效地滿足您的法規義務。透過使用 Google Cloud 合規性資源中心和合規性報告管理員，您可以自信地瀏覽複雜的產業和區域合規性領域。我們專注的工程師和合規性專家團隊將與您攜手合作，以解決您的特定法規需求。我們共同建立一個整合的控制和治理架構，同時確保強大的合規性態勢。您可以造訪 cloud.google.com/security/compliance 上的合規性資源中心，並在 cloud.google.com/security/compliance/compliance-reports-manager 上瀏覽合規性報告管理員。


##### 摘要

*   提供 Google Cloud 合規性資源中心，詳述其認證和標準資訊，並支援全球及區域法規導覽。
*   提供合規性報告管理員，方便存取 ISO/IEC 證書、SOC 報告和自我評估等資源。
*   協助企業滿足 HIPAA、PCI DSS 等各行業法規要求。
*   提供工程師和合規專家團隊支援，建立整合的控制和治理架構。
*   提供資源中心和報告管理員的網址。


#### Quiz

- https://www.cloudskillsboost.google/paths/9/course_templates/945/quizzes/487318
...
> 本課程「Google Cloud 的信任與安全」到此結束。讓我們快速回顧一下。課程的第一部分「雲端中的信任與安全」探討了重要的安全術語和概念、雲端安全與傳統本地安全之間的差異、當今主要的網路安全威脅及其業務影響，以及在雲端安全模型中控制、合規性、機密性、完整性和可用性的重要性。課程的第二部分「Google 的可信基礎架構」學習了 Google 如何設計和構建數據中心、加密在保護組織數據中的作用、身份驗證、授權和審計之間的區別、使用兩步驗證和 IAM 的好處、使用 Google 產品防範網絡攻擊的方法，以及雲端安全運營及其相關的業務效益。最後，課程的第三部分「Google Cloud 的信任原則和合規性」檢視了 Google 的七項信任原則、Google Cloud 的數據駐留和數據主權選項，以及 Google Cloud 合規資源中心和合規報告管理器如何支持行業和區域合規需求。現在您已經全面了解了 Google Cloud 上的信任和安全，您可以繼續學習 Cloud Digital Leader 系列的最後一個課程「使用 Google Cloud 運營進行擴展」，您將學習 Google Cloud 如何支持組織的財務治理和控制其雲端成本的能力、現代運營、可靠性和雲端彈性的基本概念，以及 Google Cloud 如何幫助組織實現可持續發展目標並減少環境影響。我們下次見！


##### 摘要

* **雲端安全基礎：**探討雲端安全與傳統安全差異、重要安全概念、主要網路威脅及商業影響、CIA 模型於雲端安全之應用。
* **Google 可信基礎架構：**涵蓋 Google 數據中心設計、加密技術、身份驗證/授權/審計機制、雙步驟驗證/IAM 的優勢、雲端安全作業及相關商業利益、網路安全防禦策略。
* **Google Cloud 合規與信任原則：**闡述 Google 七大信任原則、數據駐留與主權、Google Cloud 合規資源中心與合規報告管理器的功能與應用。
* **後續課程預告：**介紹「使用 Google Cloud 運營進行擴展」課程內容，包含雲端成本管理、現代運營概念、可靠性、彈性及永續發展目標。
...
> 今日數位環境下，無論規模大小的組織都擁抱雲端的力量與彈性以轉型營運模式。然而，有效管理和擴展雲端資源可能是一項複雜的任務。這就是雲端運維發揮作用的地方。雲端運維是指為確保雲端系統順利運作、優化和擴展而採用的一套實務和策略。它包含管理和監控在雲端運行的基礎架構、應用程式和服務，同時遵守可靠性、效能、安全性和成本優化的最佳實務。雲端運維在協助組織達成數位轉型目標方面扮演著關鍵角色，因為它確保了關鍵系統的可用性、效率和彈性。因此，基於此，讓我們來探討本課程的目標。「與 Google Cloud 運維一起擴展」旨在幫助您學習 Google Cloud 如何支援組織透過財務治理控制其雲端成本，了解雲端中現代運維、可靠性和彈性的基本概念，並探討 Google Cloud 如何減少我們的環境影響並幫助組織達成永續發展目標。在整個課程中，您將參加分級的知識評估。您必須通過這些評估才能獲得課程學分。好的，讓我們開始吧！


##### 摘要

* 雲端運維確保雲端系統順利運作、優化和擴展。
* 包含管理和監控雲端基礎架構、應用程式和服務。
* 遵守可靠性、效能、安全性及成本優化的最佳實務。
* 協助組織達成數位轉型目標，確保關鍵系統的可用性、效率和彈性。
* 本課程目標：學習 Google Cloud 如何控制雲端成本、了解現代運維、可靠性和彈性基本概念，以及 Google Cloud 如何減少環境影響並達成永續發展目標。
* 需通過課程評估才能獲得學分。
...
> 利用雲端技術，無論是為了改善業務還是進行大規模轉型，都可能充滿挑戰。事實上，許多組織面臨的常見痛點之一，無論他們使用哪家雲端供應商，都是管理雲端成本。尤其對於大型組織而言，從可預測的資本支出（用於構建和維護其 IT 基礎設施）轉向使用雲端資源的敏捷運營支出，需要流程和組織變革。管理雲端成本需要持續警惕和並行的即時監控。事實上，由於幾乎任何人都可以按需訪問雲端資源，因此管理 IT 基礎設施成本不再主要由財務團隊負責。相反，它涉及更多跨多個團隊的人員。因此，您甚至可能是負責 IT 預算的人。無論您的職位是什麼，瞭解使用雲端技術如何從成本角度影響業務，將有助於您最大限度地提高組織從使用雲端中獲得的價值。在本課程的第一部分，您將探討雲端成本管理的基本知識、雲端財務治理最佳實務、使用資源層次結構控制訪問的方法以及控制雲端消耗的方法。


##### 摘要

* 雲端成本管理挑戰：無論規模大小，組織都面臨雲端成本管理難題。
* 成本模式轉變：從資本支出轉向營運支出，需組織流程調整。
* 即時監控必要：需持續監控，並行管理。
* 跨團隊合作：成本管理不再僅限財務團隊，需跨部門合作。
* 課程目標：學習雲端成本管理基礎、財務治理最佳實務、資源存取控制及雲端資源消耗控制方法。
...
> 雲端資源易於取得，需要對資源消耗進行精準及時的控制。雲端財務治理（部分是組織用於管理雲端支出的流程和控制措施）能決定組織是安心無虞，還是成本失控導致預算超支。隨著組織調整，需要一個核心團隊，成員來自技術、財務和業務部門，共同掌控雲端成本並即時決策。雲端成本的變動性會影響人員、流程和技術。讓我們從人員開始探討這三個方面。人員指的是參與管理雲端成本的不同角色。小型組織可能由一人身兼多職，負責管理雲端基礎設施及相關財務的所有方面，從預算編列到採購、追蹤優化等等。然而，大型組織可能會指派財務團隊擔任財務規劃和顧問的角色。財務團隊應根據業務優先順序，就雲端支出做出數據驅動的決策，但他們可能難以每日、每週或每月追蹤雲端支出。然後是技術團隊和業務部門成員，他們可以就如何利用雲端資源來達成組織的整體業務策略，以及未來一年可能需要的額其資源提供建議，但他們不一定會將成本納入決策考量。要有效管理雲端成本，需要財務、技術和業務部門之間的合作夥伴關係。這種合作夥伴關係可能已經存在，也可能採用集中式中心的形式，例如雲端卓越中心。核心團隊將由幾位專家組成，確保組織內部實施最佳做法，並掌握持續的雲端支出狀況。這個集中式團隊也能夠即時做出決策，並在支出超過預算時討論權衡方案。現在讓我們從人員轉向流程。組織應每日或每週監控和分析其雲端使用量和成本。然後，財務團隊應每週或每月分析結果，透過相關團隊進行成本分攤，並確定是否需要任何變更，以確保組織的雲端支出得到優化。在各團隊建立問責文化，有助於組織識別浪費，迅速採取行動予以消除，並確保他們能最大限度地發揮雲端投資的效益。這也有助於推動技術、財務和業務團隊之間的跨部門合作，確保其雲端支出與更廣泛的業務目標相符。最後是技術。Google Cloud 提供內建工具，協助組織監控和管理成本。這些工具有助於組織提高能見度，在整個組織內推動雲端支出問責文化，控制成本以降低超支風險，並提供智慧型建議以優化成本和使用量。您將在本節稍後探討其中一些工具。


##### 摘要

*   雲端成本管理需精準及時控制。
*   需跨技術、財務、業務部門合作，組成核心團隊。
*   小型組織一人可能身兼多職，大型組織則由財務團隊負責財務規劃。
*   技術及業務團隊提供資源使用建議，但未必考量成本。
*   需建立財務、技術及業務部門合作夥伴關係，或設立雲端卓越中心。
*   每日或每週監控分析雲端使用量及成本，每週或每月分析結果，並進行成本分攤及優化。
*   建立問責文化，促使跨部門合作，確保雲端支出符合業務目標。
*   Google Cloud 提供內建工具監控及管理成本，提升能見度，控制成本，並提供優化建議。
...
> 讓我們探索一些雲端金融治理最佳實務，組織可以採納這些實務來提高其雲端資源的可預測性和控制性。第一個最佳實務是識別誰負責管理雲端成本。如果是一個團隊，理想情況下應該是由 IT 經理和財務主管混合組成。由於雲端支出分散且變動性大，因此在整個組織中建立成本責任文化非常重要。為專案定義明確的所有權，並與使用雲端資源的部門和團隊共享成本視圖，有助於建立這種責任文化和更負責任的支出。除了讓團隊對其支出負責外，Google Cloud 財務治理政策和權限也讓您輕鬆控制誰可以支出和查看整個組織的成本。此外，Google Cloud 提供靈活的選項來組織資源並將成本分配給個別部門和團隊。例如，預算會根據您實際或預測的雲端成本通知主要利益相關者。建立具有意義警示的多個預算，是掌握雲端成本的重要實務。第二個最佳實務是了解發票中可以找到哪些資訊，以及成本管理工具。它們不是相同的概念。發票是雲端服務供應商發送給客戶的文件，要求支付已使用服務的費用。但是，成本管理工具是幫助追蹤、分析和優化雲端支出的軟體。組織很少只關心他們花了多少錢。他們還想知道為什麼他們花了這麼多錢。成本管理工具（例如 Google Cloud 主控台中內建的工具）可以有效地回答「為什麼」。它們可以提供詳細的數據、發現趨勢並找出可以控制或優化成本的措施。這就帶我們到第三個最佳實務，用於提高雲端資源的可預測性和控制性：使用 Google Cloud 的成本管理工具。Google Cloud 相信透過提供強大的財務治理工具來支援組織，讓客戶更容易將其策略重點與雲端使用情況保持一致。在組織優化其雲端成本之前，他們首先需要了解他們正在花費多少錢、是否存在任何趨勢以及他們的預測成本是多少。那麼，這該如何做到呢？首先，掌握正在使用哪些雲端資源、由誰使用、用於什麼目的以及成本是多少。從那裡，確定誰將負責監控該資訊，誰將參與成本管理，以及如何持續報告支出資訊。設定與主要雲端利益相關者的持續溝通節奏和格式也很重要。事先制定此計畫有助於確保成本管理不是事後才考慮的問題。那麼，如何監控目前的成本趨勢並找出可以改進的浪費領域呢？Google Cloud 提供內建的報告功能，可以幫助您的團隊深入了解成本。理想情況下，至少應每週檢閱報告一次。一個強大的工具是 Google Cloud 定價計算器。定價計算器讓您可以估計雲端使用情況的變化將如何影響成本。計算器可在 cloud.google.com/products/calculator 找到。現在您已經有機會探索一些雲端財務治理最佳實務，下一步就是實施它們。如果這不屬於您的職責範圍，請務必將這些最佳實務傳達給組織中的相關利益相關者。


##### 摘要

*   釐清雲端成本管理責任單位，理想上由IT經理和財務主管組成團隊，建立組織內部的成本責任文化。
*   區分發票與成本管理工具：發票為付款請求，成本管理工具則用於追蹤、分析和優化雲端支出，並找出支出原因。
*   善用Google Cloud成本管理工具：掌握雲端資源使用狀況、成本及趨勢，定期檢視報告(至少每週)，並利用定價計算器預估成本變化。
...
> 雲端運算的一項重要考量是控制對資源的存取。在本地基礎架構中，使用實體存取控制。然而，這種方法對於儲存在雲端的資源並不有效。Google Cloud 資源階層是一個強大的工具，可用於控制對雲端資源的存取。這與您用於組織和控制自身檔案存取的資料夾結構非常相似，此資源階層是一個樹狀結構，將資源組織成邏輯群組。這使得資源管理和控制更加容易。Google Cloud 的資源階層包含四個層級，由下往上分別是：資源、專案、資料夾和組織節點。第一層級，資源，代表虛擬機器、Cloud Storage 儲存區、BigQuery 中的表格，或 Google Cloud 中的任何其他項目。資源組織到專案中，專案位於第二層級。專案可以組織到資料夾中，甚至子資料夾中。這些位於第三層級。然後在頂層是組織節點，它包含組織中的所有專案、資料夾和資源。了解此資源階層非常重要，因為它直接關係到在使用 Google Cloud 時如何管理和應用策略。策略是一組規則，定義誰可以存取資源以及他們可以使用資源做什麼。可以在專案、資料夾和組織節點層級定義策略。某些 Google Cloud 服務也可以將策略應用於個別資源。Google Cloud 資源階層的第三層級是資料夾。資料夾允許您根據您選擇的粒度層級將策略指派給資源。資料夾中的資源繼承指派給該資料夾的策略和權限。資料夾可以包含專案、其他資料夾或兩者的組合。現在您了解了 Google Cloud 資源階層的結構，讓我們來探討一些使用它來控制對雲端資源存取的其他好處。首先，資源階層提供粒度存取控制，這意味著您可以在階層的不同層級（例如，資料夾、專案或個別資源層級）指派角色和權限。其次，由於資源階層遵循繼承和傳播規則，因此在資源階層較高層級設定的權限會自動由較低層級的資源繼承。例如，如果您在資料夾層級授予使用者存取權，則該資料夾中的所有專案和資源都會預設繼承這些權限。這種繼承簡化了存取管理，並減少了在每個個別資源層級進行手動配置的需求。第三，資源階層通過最小權限原則增強安全性與合規性。通過在階層的適當層級指派存取權限，您可以確保使用者只有執行其任務所需的權限。這降低了未經授權存取的風險，並有助於保持法規遵從性。最後，資源階層提供強大的可見性和稽核功能。您可以追蹤跨不同階層級的存取權限和更改，這使得監控和審查存取控制更加容易。這提高了問責制，並有助於識別和解決潛在的安全問題。


##### 摘要

*   雲端資源存取控制仰賴 Google Cloud 資源階層。
*   階層結構：資源 > 專案 > 資料夾 > 組織節點。
*   策略設定於專案、資料夾及組織節點層級，個別資源亦可設定。
*   資料夾可包含專案及子資料夾，資源繼承其父層級的權限。
*   優點：粒度存取控制、權限繼承、最小權限原則、增強可見性和稽核能力。
...
> 企業希望控制雲端資源消耗的原因有很多，例如：透過確保沒有在不必要的資源上超支來節省成本；提升能見度，以便更好地了解資源的使用方式並找出節省成本的途徑；以及改善合規性，以確保雲端環境符合行業法規。Google Cloud 提供多種工具來幫助控制雲端資源消耗，包括資源配額政策、預算閾值規則和 Cloud Billing 報表。讓我們來定義這些術語。資源配額政策允許您設定專案或使用者可以使用的資源數量限制。這可以幫助防止在雲端資源上超支，從而確保您的雲端使用量在預算範圍內。然後是預算閾值規則，它允許您設定警報，以便在雲端成本超過特定閾值時獲得通知。它們可以作為潛在成本超支的預警，讓您可以在成本失控之前採取糾正措施。資源配額政策和預算閾值規則都設定在 Google Cloud Console 中。然後是 Cloud Billing 報表。雖然資源配額政策和預算閾值規則提供主動控制雲端資源消耗的方法，但 Cloud Billing 報表提供被動的方法來幫助您追蹤和了解您已在 Google Cloud 資源上花費的費用，並提供優化成本的方法。您可以使用 Cloud Billing 報表透過將計費數據匯出到 BigQuery 來監控成本。這意味著將使用情況和成本數據匯出到 BigQuery 資料集，然後使用該資料集進行詳細分析。您也可以使用 Looker Studio 等工具來視覺化數據。在分析您在雲端資源上的支出後，您可能會意識到您的組織可以透過預先承諾使用折扣 (CUD) 來優化成本。如果您的工作負載具有可預測的資源需求，您可以購買 Google Cloud 承諾，這將以折扣價提供給您，以換取您承諾在特定期限內使用最低限度的資源。
...
* **Google Cloud 提供的工具：**
    * 資源配額政策 (設定資源使用上限)
    * 預算閾值規則 (設定成本超支警報)
    * Cloud Billing 報表 (追蹤和分析支出)

* **Cloud Billing 報表功能：**
    * 數據匯出至 BigQuery 作詳細分析
    * 使用 Looker Studio 視覺化數據

* **成本優化策略：**
    * 預先承諾使用折扣 (CUD)  (針對可預測資源需求的工作負載)


#### Quiz

- https://www.cloudskillsboost.google/paths/9/course_templates/271/quizzes/487057
...
> 今日數位環境瞬息萬變，組織越來越多地利用雲端技術來推動創新、敏捷性和效率。然而，要真正發揮雲端的力量，需要全面了解大規模運作卓越和可靠性。運作卓越和可靠性是指組織優化其運作並確保不間斷服務交付的能力，即使它們處理日益增長的雲端工作負載和複雜性也是如此。這包括設計穩健的基礎架構、建立彈性的流程以及採用主動監控和響應機制。想像一下，一個全球電子商務平台在大型促銷活動期間經歷了突然的流量激增。為滿足增加的需求，該平台需要快速擴展其資源，同時確保不間斷的服務可用性。此處的運作卓越涉及有效擴展底層基礎架構、自動化資源配置和實施負載平衡機制。可靠性側重於最大限度地減少停機時間、採用容錯系統和實施災難恢復策略。通過在這些領域取得卓越成就，電子商務平台可以無縫處理增加的負載，提供始終如一的積極用戶體驗，並避免收入損失或聲譽損害。在本課程的這一部分，您將探討使用 Google Cloud 現代化運作、設計彈性基礎架構和流程、雲端可靠性的基本原理、Google Cloud 客戶服務以及支援案例的生命週期。


##### 摘要

* 雲端技術日益重要，提升效率及創新。
* 運作卓越與可靠性確保服務不間斷，即使負載增加。
* 包含設計穩健基礎架構、彈性流程及主動監控。
* 電子商務平台案例：流量激增時，需快速擴展資源，維持服務可用性。
*  可靠性著重於最小化停機時間、容錯系統和災難恢復。
* 本課程涵蓋Google Cloud現代化運作、彈性架構設計、雲端可靠性基礎、Google Cloud客戶服務及支援案例流程。
...
> 開發人員負責編寫系統和應用程式的程式碼，而操作人員則負責確保這些系統和應用程式可靠地運作。開發人員需要敏捷，常常被要求快速編寫和部署程式碼，目標是頻繁發佈新功能、通過新功能提升核心業務價值，並快速發佈修復程式以提升整體用戶體驗。相比之下，操作人員需要保持系統穩定，因此他們通常更偏好較慢的工作節奏以確保可靠性和一致性。傳統上，開發人員將其程式碼交付給操作人員，而操作人員通常對程式碼如何在生產或線上環境中執行知之甚少。當出現問題時，兩個團隊都很難快速找出問題的根源並解決它。更糟糕的是，團隊之間的責任歸屬並不總是清晰的。DevOps 是一種軟體開發方法，它強調開發和運營團隊之間的協作和溝通，以提高軟體交付的效率、速度和可靠性。它旨在打破這些團隊之間的隔閡，並培養共享責任、自動化和持續改進的文化。DevOps 架構中的一個特定概念是網站可靠性工程 (SRE)，它確保在雲端部署的軟體系統和服務的可靠性、可用性和效率。SRE 結合軟體工程和運營的方面來設計、構建和維護可擴展且可靠的基礎設施。監控是產品可靠性的基礎。它揭示了需要緊急關注的事項，並顯示應用程式使用模式的趨勢，這可以產生更好的容量規劃，並通常有助於改善應用程式客戶的體驗並減輕他們的痛苦。「四大黃金指標」用於衡量系統的性能和可靠性，分別是延遲、流量、飽和度和錯誤。延遲衡量系統的特定部分返回結果所需的時間。延遲很重要，因為它直接影響用戶體驗，變化可能表明出現問題，其值可能與容量需求相關，並且可用於衡量系統改進。流量衡量到達系統的請求數量。流量很重要，因為它是當前系統需求的指標，其歷史趨勢用於容量規劃，並且它是計算基礎設施支出時的核心指標。飽和度衡量系統距離容量還有多遠。但是，需要注意的是，容量通常是一個主觀的度量，取決於底層服務或應用程式。飽和度很重要，因為它是服務滿負荷程度的指標，它側重於約束最嚴格的資源，並且它經常與達到容量時的性能下降相關。錯誤是衡量系統故障或其他問題的事件。當電腦程式或系統中的缺陷、故障或錯誤導致其產生不正確或意外的結果或以意外的方式運行時，通常會引發錯誤。錯誤很重要，因為它們可能表明某些東西正在發生故障、配置或容量問題、服務級別目標違規或該發出警報了。網站可靠性工程中的三個主要概念是服務級別指標 (SLI)、服務級別目標 (SLO) 和服務級別協議 (SLA)。它們都是為系統的「四大黃金指標」設定的目標類型。服務級別指標是顯示系統或服務運行狀況的度量。它們是具體的指標，例如響應時間、錯誤率或正常運行時間百分比（即系統可用的時間量），這些指標有助於我們了解系統的行為和性能。服務級別目標是我們根據 SLI 為系統性能設定的目標。它們定義了我們想要達到的可靠性或性能水平。例如，SLO 可能規定系統在一個月內應有 99.9% 的時間可用。服務級別協議是雲服務提供商及其客戶之間的協議。它們概述了關於服務質量的承諾和保證。SLA 包括商定的 SLO、性能指標、正常運行時間保證以及如果提供商未能履行這些承諾的任何處罰或補救措施。這可能包括當服務的中斷時間長於此協議允許的時間時退款或信用額度。


##### 摘要

* 開發人員負責程式碼編寫，操作人員負責系統運作。
* DevOps 強調開發與運營團隊的協作，提升軟體交付效率。
* SRE 確保雲端部署軟體系統的可靠性、可用性和效率。
* 監控是產品可靠性的基礎，四大黃金指標：延遲、流量、飽和度和錯誤。
* 服務級別指標 (SLI)、服務級別目標 (SLO) 和服務級別協議 (SLA) 是 SRE 的三個主要概念。
...
雲端環境的基礎架構和流程設計需具備彈性、容錯和可擴展性，以確保高可用性和災難復原能力。高可用性是指系統即使發生硬體或軟體故障，也能持續運作並讓使用者存取；而災難復原則指在重大中斷或災難後，將系統恢復到功能性狀態的過程。以下探討一些關鍵設計考量及其重要性：


##### 摘要

* **冗餘 (Redundancy):**  複製關鍵組件或資源，提供備援選項。例如：備援電源、網路交換器或負載平衡器，確保單點故障時能無縫切換。

* **複製 (Replication):**  建立資料或服務的複本，分散於不同伺服器或位置，即使某些組件或伺服器故障，系統仍能運作。

* **區域分散 (Regional Distribution):**  將資源分散於不同地理區域的雲端服務商資料中心，降低單一區域災難影響。

* **可擴展性 (Scalability):**  根據工作負載動態配置和釋放資源，例如自動擴展機制，應付不同需求。

* **備份 (Backup):**  定期備份關鍵資料和組態，並將備份儲存在地理位置分散的場所，以防資料遺失、硬體故障或網路攻擊。

* **測試與監控 (Testing and Monitoring):**  定期測試並驗證流程，以及實施監控、警示和事件回應機制，及時解決問題。
...
> 本文探討在雲端環境中監控伺服器、資料庫或應用程式的運作情況。與本地環境不同，雲端伺服器無法直接物理接觸，因此需要借助 Google Cloud 的整合式可觀察性工具來了解系統的效能、健康狀況和行為。Google Cloud Observability 提供一套完整的監控、日誌記錄和診斷工具，包括 Cloud Monitoring、Cloud Logging、Cloud Trace、Cloud Profiler 和 Error Reporting 等服務，以實現對應用程式和基礎架構的全面監控和洞察。


##### 摘要

* **Cloud Monitoring (雲端監控):** 提供雲端基礎架構和應用程式的全面檢視，收集指標、日誌和追蹤資料，並提供效能、健康狀況和可用性的洞察，支援建立警示政策。

* **Cloud Logging (雲端日誌記錄):** 收集和儲存所有應用程式和基礎架構日誌，提供即時洞察，協助除錯、識別趨勢並符合法規。

* **Cloud Trace (雲端追蹤):** 識別應用程式中的效能瓶頸，收集應用程式的延遲數據，提供效能洞察。

* **Cloud Profiler (雲端剖析器):** 識別應用程式使用的 CPU 效能、記憶體和其他資源，持續收集生產應用程式的 CPU 使用率和記憶體配置資訊，提供資源使用情況的洞察。

* **Error Reporting (錯誤回報):** 即時計數、分析和彙總執行中雲端服務的錯誤，提供集中式錯誤管理介面，支援排序、篩選和詳細錯誤資訊檢視，並支援電子郵件和行動裝置警示通知。
...
Google Cloud 客戶支援計畫能協助企業克服雲端導入的挑戰，提供具擴展性和彈性的服務，以滿足不同企業的需求。其支援服務分為四個等級：


##### 摘要

* **基本支援 (免費):**  包含文件、社群支援、雲端計費支援和主動協助 (Active Assist) 建議。
* **標準支援 (建議用於開發中工作負載):** 提供無限次數的英文技術支援 (工作時間，週五天)，以及 Cloud Support API 整合功能。
* **增強支援 (建議用於生產環境工作負載):**  提供 24/7 多語言支援、快速回應時間、技術支援升級和第三方技術支援。
* **頂級支援 (適用於具有關鍵工作負載的企業):** 提供最快回應時間、客戶感知支援、專屬技術帳戶經理、Google Cloud Skills Boost 訓練平台的額外學分、活動管理服務、營運健康檢查和客戶感知支援 (Customer Aware Support)。

增強支援和頂級支援皆提供額外付費的增值服務。更多詳情請參考 cloud.google.com/support。
...
> 使用標準、增強或高級支援方案的任何 Google Cloud 客戶都可以使用 Google Cloud 主控台建立和管理支援案例。除了透過 Google Cloud 主控台提交支援案例外，客戶支援服務還提供其他聯繫選項，例如電話和視訊通話支援，以便與支援人員進行即時互動。在 Google Cloud 客戶支援流程中，支援案例的生命週期通常涉及客戶和支援團隊之間的幾個階段和互動。以下是支援案例典型歷程的概述。首先，客戶透過在 Google Cloud 主控台中建立案例來啟動支援請求。只有被指派組織內技術支援編輯角色的使用者才能執行此操作。客戶會提供有關其遇到的問題的相關詳細資訊，包括任何錯誤訊息、日誌或重現問題的步驟。使用者必須從 P4（表示影響低）到 P1（表示影響嚴重）中選擇優先順序，因為這會影響客戶支援團隊的回應時間。建立案例後，它會經過分類流程。團隊會審閱客戶提供的資訊，以了解問題並確定其嚴重性和對客戶業務營運的影響。團隊可能在此階段要求客戶提供其他資訊或說明。在許多情況下，客戶支援代表會解決案例，但對於較複雜的問題，案例會指派給具有適當專業知識的支援工程師。指派案例後，團隊會開始進行故障排除和調查流程。他們會分析提供的資訊、審閱系統日誌並執行各種診斷測試，以找出問題的根本原因。根據問題的複雜程度，此階段可能涉及與其他內部團隊或專家的合作。在整個調查過程中，客戶支援團隊會與客戶保持定期聯繫。他們會提供進度更新、分享發現結果，並在需要時向客戶索取其他資訊或行動。升級是用於標記流程中斷，或在罕見情況下，案例因客戶和客戶支援團隊未完全同步而停滯不前，儘管已積極溝通問題以確定下一步行動。但是，重要的是要注意，升級並非總是最佳解決方案，而且對於高衝擊問題，升級可能不會加快案例處理速度。這是因為升級可能會打斷客戶支援團隊的工作流程，並導致其他案例延誤。高衝擊問題的最佳解決方案是確保案例設定為適當的優先順序，確保案例盡快指派給正確的資源。升級是一種可以重新獲得停滯案例動力的工具。但是，務必謹慎使用升級，且僅在絕對必要時才使用。找出根本原因後，團隊會著手解決問題或提供緩解方案。他們可能會向客戶提供分步說明、組態變更或解決方法建議，以解決問題。在某些情況下，他們可能會與更高級別的支援或工程團隊協商問題，以獲得更多協助。客戶支援團隊也可能需要向 Google Cloud 工程團隊提交功能要求。實施解決方案或緩解方案後，客戶支援團隊會與客戶合作，驗證解決方案的有效性。他們可能會要求客戶執行特定測試或提供結果回饋。此步驟確保問題完全解決並符合客戶的期望。當客戶確認問題已解決時，支援案例就會關閉。團隊會提供解決方案摘要，記錄採取的步驟，並確保客戶對結果感到滿意。如有需要，他們也可能會提供預防措施或未來的最佳實務建議，以避免類似問題。客戶也會收到意見回饋調查，以便支援團隊了解他們做得好的地方以及需要改進的地方。在整個支援案例生命週期中，Google Cloud 的客戶支援團隊旨在為客戶提供及時有效的協助。他們優先考慮客戶滿意度和回應速度，並努力解決客戶使用 Google Cloud 服務時可能遇到的技術挑戰。


##### 摘要

*   任何使用標準、增強或高級支援方案的 Google Cloud 客戶皆可透過 Google Cloud 主控台建立及管理支援案例。
*   除 Google Cloud 主控台外，亦提供電話及視訊支援等其他聯繫方式。
*   支援案例流程包含多個階段：建立案例、分類、指派工程師、調查、解決問題、驗證解決方案及結案。
*   客戶需指定案例優先順序 (P1-P4)，影響回應時間。
*   複雜問題可能需要與其他團隊協作。
*   定期更新進度，並與客戶保持聯繫。
*   升級僅在案例停滯且溝通不良時使用，非高衝擊問題的最佳解決方案。
*   解決問題後，會提供解決方案摘要及後續建議。
*   客戶會收到意見回饋調查。


#### Quiz

- https://www.cloudskillsboost.google/paths/9/course_templates/271/quizzes/487064
...
> 本課程即將結束，在您探索雲端運算如何協助轉型業務模式後，務必強調 Google 在技術方面的努力與我們對環境和永續發展的承諾。虛擬世界，包括 Google Cloud 的網絡，是建立在物理基礎架構上的，所有這些嗡嗡作響的伺服器機架都消耗大量能源。現有資料中心總共消耗了全球近 2% 的電力。有鑑於此，Google 致力於使我們的資料中心儘可能有效率地運作。與我們的客戶一樣，Google 也試圖保護地球。我們了解 Google Cloud 客戶也有自己的環保目標，在 Google Cloud 上運行其工作負載可以成為達成這些目標的一部分。因此，值得注意的是，Google 的資料中心是首批獲得 ISO 14001 認證的資料中心，這是一項標準，概述了組織如何透過改進資源效率和減少浪費來提升其環境績效的框架。例如，Google 位於芬蘭哈米納的資料中心。該設施是 Google 機群中最先進、最高效的資料中心之一。其冷卻系統使用芬蘭灣的海水，減少能源使用，並且是全球首創。在 Google 成立的十年間，Google 成為第一家實現碳中和的主要公司。在我們的第二個十年裡，我們是第一家實現 100% 使用再生能源的公司。到 2030 年，我們的目標是成為第一家完全實現碳中和運作的主要公司。我們透過努力賦能每個人——企業、政府、非營利組織、社區和個人——利用 Google 技術創造更永續的世界，來應對氣候變化和資源效率的需求。那麼，在實踐中這看起來是什麼樣子呢？讓我們探討一個客戶 Kaluza 如何使用 Google Cloud 技術啟動智慧電動汽車充電計劃的示例，該計劃可幫助客戶省錢，同時減少他們的碳足跡。電動汽車已佔全球汽車銷量的七分之一，隨著全球逐步淘汰新的汽油和柴油汽車，預計到 2040 年全球銷量將達到 7300 萬輛。但隨著電網越來越依賴風能和太陽能等可變能源，電動汽車需求的增加有可能在高峰時間過度消耗電網，從而可能導致停電。Kaluza 於 2019 年由 OVO Energy 推出，它利用其對能源市場的深入了解，與全球一些主要的能源供應商和汽車製造商合作。透過名為「隨時充電」的計劃，客戶使用 Kaluza 智慧充電他們的電動汽車，他們只需支付約三分之一的家庭用電費。這意味著，如果客戶在放工回家後（例如下午 6:00）插入汽車充電——此時電網的需求和碳強度最高——他們的汽車將在夜間以最低成本和最環保的時間段智慧充電，這樣就可以在他們早上需要時準備好。Kaluza 智慧充電解決方案的背後是一些先進的技術，所有這些技術都是建立在 Google Cloud 之上的。他們的核心優化引擎從各種來源收集實時數據，包括電動汽車的電池和充電數據，以及能源供應商和電網運營商的數據，例如碳強度和價格預測。這些數據儲存在 BigQuery 中，用於訓練和驗證智慧充電優化模型。然後，這些模型將與 Google Kubernetes Engine 一起部署，以便每當客戶插入電動汽車時，來自該汽車的數據都會通過其優化引擎實時傳遞，以計算該汽車的理想充電時間表，從而確保它使用最便宜、碳排放量最低的可用能源。至於電網運營商和能源公司，Kaluza 平台讓他們可以隨時查看有多少參與的電動汽車已插入網絡。BigQuery 和 Looker Studio 儀表板提供了詳細的見解，例如有多少汽車閒置、有多少汽車正在充電以及我們的優化引擎的工作情況。在 Google，我們始終致力於永續發展，並繼續領導和鼓勵像 Kaluza 這樣的其他人加入我們，共同改善我們地球的健康狀況。


##### 摘要

*   Google致力於環境永續，資料中心已獲得ISO 14001認證，並積極提升能源效率。
*   Google目標在2030年前成為第一家完全碳中和運作的主要公司。
*   Kaluza使用Google Cloud技術，開發智慧電動車充電方案，降低充電成本並減少碳排放。
*   此方案利用BigQuery和Kubernetes Engine分析數據，優化充電時間，選擇低碳排放時段充電。
*   Google透過技術協助企業和個人達成永續目標。


#### Quiz

- https://www.cloudskillsboost.google/paths/9/course_templates/271/quizzes/487066
...
> 本課程「利用 Google Cloud 運營擴展規模」到此結束。讓我們快速回顧一下。課程的第一部分「財務治理和管理雲端成本」探討了雲端成本管理的基礎知識、雲端財務治理最佳實務、使用資源層次結構控制存取的方法以及控制雲端消耗量的方法。課程的第二部分「大規模運營卓越和可靠性」學習了如何使用 Google Cloud 現代化運營、設計彈性基礎架構和流程、雲端可靠性的基礎知識、Google Cloud 客戶支援以及支援案例的生命週期。最後，課程的第三部分「Google Cloud 的永續性」探討了 Google Cloud 如何努力減少我們的環境影響並幫助組織達成永續發展目標。完成本課程也完成了雲端數位領袖學習路徑。如果您想展示您對這六門課程主題的知識，建議您參加雲端數位領袖認證考試。有關考試的更多資訊，包括有助於您繼續準備的額外資源，請瀏覽 https://cloud.google.com/learn/certification/cloud-digital-leader。如果您想進一步擴展您對 Google Cloud 產品和服務的了解，請瀏覽 cloud.google.com/training 上的完整目錄。下次見！


##### 摘要

* **財務治理與成本管理:**  涵蓋雲端成本管理基礎、財務治理最佳實務、資源層次結構存取控制及雲端資源消耗控制。
* **運營卓越與可靠性:**  包含 Google Cloud 運營現代化、彈性基礎架構與流程設計、雲端可靠性基礎、Google Cloud 客戶支援及支援案例流程。
* **永續發展:**  探討 Google Cloud 如何降低環境影響及協助組織達成永續目標。
* **課程結語:** 完成本課程即完成雲端數位領袖學習路徑，並鼓勵參加雲端數位領袖認證考試 (詳情請見 https://cloud.google.com/learn/certification/cloud-digital-leader)。
* **進階學習:**  建議瀏覽 cloud.google.com/training 了解更多 Google Cloud 產品與服務。
