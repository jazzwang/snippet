...
## Write CSV headers
print("issue_id,user_id,reaction_type,timestamp",file=reactions)
...
for issue in repo.get_issues():
    ...
    for reaction in issue.get_reactions():
        ...
        print(str(issue.number) + "," + reaction.user.login + "," + reaction.content + "," + str(reaction.created_at), file=reactions)
        print(str(issue.number) + "," + reaction.user.login + "," + reaction.content + "," + str(reaction.created_at))
