...
## read LOGIN_MAIL from environment variable
KINDLE_MAIL = os.environ.get("KINDLE_MAIL")
KINDLE_PASSWD = os.environ.get("KINDLE_PASSWD")
...
def run(playwright: Playwright) -> None:
    ...
    page.get_by_role("textbox", name="Email or mobile phone number").fill(KINDLE_MAIL)
    page.get_by_role("button", name="Continue").click()
    page.get_by_role("textbox", name="Password").fill(KINDLE_PASSWD)
