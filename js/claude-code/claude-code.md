...
- 論文：研究 Claude Code 外洩原始碼並與其他 AI Code Agent 比較
  Dive into Claude Code: The Design Space of Today's and Future AI Agent Systems
  - https://arxiv.org/abs/2604.14228
  - https://huggingface.co/papers/2604.14228 （從 HuggingFace Papers 看有個好處，就是已經分析了相關的 Paper, Code, Agent, Code Agent ）
  - 2026-04-14
  - https://github.com/VILA-Lab/Dive-into-Claude-Code
  - https://github.com/chauncygu/collection-claude-code-source-code
  - https://huggingface.co/pirola/local-ai-coding-stack-research#22--ccr-claude-code-router
  - https://huggingface.co/spaces/O96a/agent-architecture-visualizer
- 免費課程
